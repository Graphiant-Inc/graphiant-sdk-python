...
T = TypeVar("T", bound="PostV1DevicesInventoryClearReturnBody")


@_attrs_define
class PostV1DevicesInventoryClearReturnBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_inventory_clear_return_body = cls(
            device_serials=device_serials,
        )

        post_v1_devices_inventory_clear_return_body.additional_properties = d
        return post_v1_devices_inventory_clear_return_body
