...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_ipfix_exporters_item = cls(
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_ipfix_exporters_item.additional_properties = d
        return put_v1_extranets_id_response_200_policy_shared_segment_ipfix_exporters_item
