...
T = TypeVar("T", bound="PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem")


@_attrs_define
class PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_snmps_response_200_snmps_item_usm_local_users_item = cls(
        ...
        post_v1_global_snmps_response_200_snmps_item_usm_local_users_item.additional_properties = d
        return post_v1_global_snmps_response_200_snmps_item_usm_local_users_item
