...
T = TypeVar("T", bound="PostV1DevicesSessionStatusBody")


@_attrs_define
class PostV1DevicesSessionStatusBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_session_status_body = cls(
            device_ids=device_ids,
        )

        post_v1_devices_session_status_body.additional_properties = d
        return post_v1_devices_session_status_body
