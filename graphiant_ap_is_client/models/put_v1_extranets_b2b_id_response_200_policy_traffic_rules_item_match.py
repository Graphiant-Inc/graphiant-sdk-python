...
T = TypeVar("T", bound="PutV1ExtranetsB2BIdResponse200PolicyTrafficRulesItemMatch")


@_attrs_define
class PutV1ExtranetsB2BIdResponse200PolicyTrafficRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_b2b_id_response_200_policy_traffic_rules_item_match = cls(
        ...
        put_v1_extranets_b2b_id_response_200_policy_traffic_rules_item_match.additional_properties = d
        return put_v1_extranets_b2b_id_response_200_policy_traffic_rules_item_match
