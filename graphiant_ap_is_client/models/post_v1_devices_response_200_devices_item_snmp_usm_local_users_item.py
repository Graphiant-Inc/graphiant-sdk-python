...
T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemSnmpUsmLocalUsersItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemSnmpUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_response_200_devices_item_snmp_usm_local_users_item = cls(
        ...
        post_v1_devices_response_200_devices_item_snmp_usm_local_users_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_snmp_usm_local_users_item
