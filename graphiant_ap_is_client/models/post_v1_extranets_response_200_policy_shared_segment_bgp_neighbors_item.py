...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item_address_families_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item_bfd import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfd,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item_bfd_neighbor import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem")


@_attrs_define
class PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item = cls(
        ...
        post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item.additional_properties = d
        return post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item
