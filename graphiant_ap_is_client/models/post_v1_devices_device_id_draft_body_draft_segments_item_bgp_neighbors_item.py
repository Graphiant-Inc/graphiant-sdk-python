...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item_address_families_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item_bfd import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item_bfd_neighbor import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_segments_item_bgp_neighbors_item
