...
if TYPE_CHECKING:
    from ..models.get_v1_event_enterprise_response_200_events_item_event_time import (
        GetV1EventEnterpriseResponse200EventsItemEventTime,
    )


T = TypeVar("T", bound="GetV1EventEnterpriseResponse200EventsItem")


@_attrs_define
class GetV1EventEnterpriseResponse200EventsItem:
    """
    Attributes:
        ...
        event_time (Union[Unset, GetV1EventEnterpriseResponse200EventsItemEventTime]):
    ...
    event_time: Union[Unset, "GetV1EventEnterpriseResponse200EventsItemEventTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_event_time, Unset):
            ...
            event_time = GetV1EventEnterpriseResponse200EventsItemEventTime.from_dict(_event_time)
        ...
        get_v1_event_enterprise_response_200_events_item = cls(
            actions=actions,
            device_id=device_id,
        ...
        get_v1_event_enterprise_response_200_events_item.additional_properties = d
        return get_v1_event_enterprise_response_200_events_item
