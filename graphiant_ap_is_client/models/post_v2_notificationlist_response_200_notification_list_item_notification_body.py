...
T = TypeVar("T", bound="PostV2NotificationlistResponse200NotificationListItemNotificationBody")


@_attrs_define
class PostV2NotificationlistResponse200NotificationListItemNotificationBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_notificationlist_response_200_notification_list_item_notification_body = cls(
        ...
        post_v2_notificationlist_response_200_notification_list_item_notification_body.additional_properties = d
        return post_v2_notificationlist_response_200_notification_list_item_notification_body
