...
if TYPE_CHECKING:
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item_address_families_item import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item_bfd import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfd,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item_bfd_neighbor import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item_time_since_last_oper_change import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                PutV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item = cls(
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item.additional_properties = d
        return put_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item
