...
T = TypeVar("T", bound="PostV1PolicyPrefixSetsBodyEntriesItemValue")


@_attrs_define
class PostV1PolicyPrefixSetsBodyEntriesItemValue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_policy_prefix_sets_body_entries_item_value = cls(
            ip_prefix=ip_prefix,
            mask_lower=mask_lower,
            mask_upper=mask_upper,
        )

        post_v1_policy_prefix_sets_body_entries_item_value.additional_properties = d
        return post_v1_policy_prefix_sets_body_entries_item_value
