...
if TYPE_CHECKING:
    from ..models.get_v1_groups_response_200_groups_item_permissions import GetV1GroupsResponse200GroupsItemPermissions


T = TypeVar("T", bound="GetV1GroupsResponse200GroupsItem")


@_attrs_define
class GetV1GroupsResponse200GroupsItem:
    """
    Attributes:
        ...
        permissions (Union[Unset, GetV1GroupsResponse200GroupsItemPermissions]):
    ...
    permissions: Union[Unset, "GetV1GroupsResponse200GroupsItemPermissions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.get_v1_groups_response_200_groups_item_permissions import (
        ...
        if isinstance(_permissions, Unset):
            ...
            permissions = GetV1GroupsResponse200GroupsItemPermissions.from_dict(_permissions)

        time_window_end = d.pop("timeWindowEnd", UNSET)

        time_window_start = d.pop("timeWindowStart", UNSET)

        get_v1_groups_response_200_groups_item = cls(
        ...
        get_v1_groups_response_200_groups_item.additional_properties = d
        return get_v1_groups_response_200_groups_item
