...
T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemSnmpTargetsItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemSnmpTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_response_200_devices_item_snmp_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        post_v1_devices_response_200_devices_item_snmp_targets_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_snmp_targets_item
