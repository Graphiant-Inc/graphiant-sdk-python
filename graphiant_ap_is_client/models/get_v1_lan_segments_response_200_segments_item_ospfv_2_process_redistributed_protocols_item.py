...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_ospfv_2_process_redistributed_protocols_item = cls(
            metric=metric,
            metric_type=metric_type,
            redist_type=redist_type,
        )

        get_v1_lan_segments_response_200_segments_item_ospfv_2_process_redistributed_protocols_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_ospfv_2_process_redistributed_protocols_item
