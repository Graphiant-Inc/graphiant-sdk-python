...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_bgp_multipath import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_bgp_redistributions import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_core_logical_interfaces_v2_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_profile import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemProfile,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_static_routes_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item_wan_interface_v2 import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItem")


@_attrs_define
class GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset,
            GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpNeighborsItem']]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemProfile]):
        ...
        static_routes (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset,
            GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpMultipath"
    ] = UNSET
    bgp_neighbors: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpRedistributions"
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemStaticRoutesItem"]
    ] = UNSET
    wan_interface_v2: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemWanInterfaceV2"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpMultipath.from_dict(
                    _bgp_multipath
                )
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemProfile.from_dict(
                _profile
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceCircuitsItemWanInterfaceV2.from_dict(
                    _wan_interface_v2
                )
            )

        get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item = cls(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item.additional_properties = d
        return get_v1_devices_device_id_versions_version_response_200_config_mana_device_circuits_item
