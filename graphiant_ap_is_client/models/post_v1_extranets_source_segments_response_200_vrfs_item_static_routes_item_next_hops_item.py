...
T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItemNextHopsItem")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItemNextHopsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_static_routes_item_next_hops_item = cls(
            circuit=circuit,
            id=id,
            metric=metric,
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_static_routes_item_next_hops_item.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_static_routes_item_next_hops_item
