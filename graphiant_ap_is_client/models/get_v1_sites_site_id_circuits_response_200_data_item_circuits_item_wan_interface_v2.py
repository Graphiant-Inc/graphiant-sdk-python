...
T = TypeVar("T", bound="GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2")


@_attrs_define
class GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_wan_interface_v2 = cls(
        ...
        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_wan_interface_v2.additional_properties = d
        return get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_wan_interface_v2
