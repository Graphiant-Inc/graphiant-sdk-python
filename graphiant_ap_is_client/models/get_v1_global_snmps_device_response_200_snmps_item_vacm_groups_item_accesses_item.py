...
T = TypeVar("T", bound="GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItemAccessesItem")


@_attrs_define
class GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItemAccessesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_device_response_200_snmps_item_vacm_groups_item_accesses_item = cls(
            context=context,
        ...
        get_v1_global_snmps_device_response_200_snmps_item_vacm_groups_item_accesses_item.additional_properties = d
        return get_v1_global_snmps_device_response_200_snmps_item_vacm_groups_item_accesses_item
