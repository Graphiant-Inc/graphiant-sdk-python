...
T = TypeVar("T", bound="PostV1AuditCompleteBodyEntryEnd")


@_attrs_define
class PostV1AuditCompleteBodyEntryEnd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_complete_body_entry_end = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_complete_body_entry_end.additional_properties = d
        return post_v1_audit_complete_body_entry_end
