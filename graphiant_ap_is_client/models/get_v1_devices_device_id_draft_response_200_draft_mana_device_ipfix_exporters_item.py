...
T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpfixExportersItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpfixExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_ipfix_exporters_item = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_ipfix_exporters_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_ipfix_exporters_item
