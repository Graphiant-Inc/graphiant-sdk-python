...
T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceLocalRouteTag")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceLocalRouteTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_local_route_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        get_v1_devices_device_id_draft_response_200_draft_mana_device_local_route_tag.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_local_route_tag
