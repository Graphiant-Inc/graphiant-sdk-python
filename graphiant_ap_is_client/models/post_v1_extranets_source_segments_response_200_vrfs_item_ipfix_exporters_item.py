...
T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_ipfix_exporters_item = cls(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_ipfix_exporters_item.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_ipfix_exporters_item
