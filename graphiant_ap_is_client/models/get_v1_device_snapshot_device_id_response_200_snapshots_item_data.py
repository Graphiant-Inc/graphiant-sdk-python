...
T = TypeVar("T", bound="GetV1DeviceSnapshotDeviceIdResponse200SnapshotsItemData")


@_attrs_define
class GetV1DeviceSnapshotDeviceIdResponse200SnapshotsItemData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_snapshot_device_id_response_200_snapshots_item_data = cls(
        ...
        get_v1_device_snapshot_device_id_response_200_snapshots_item_data.additional_properties = d
        return get_v1_device_snapshot_device_id_response_200_snapshots_item_data
