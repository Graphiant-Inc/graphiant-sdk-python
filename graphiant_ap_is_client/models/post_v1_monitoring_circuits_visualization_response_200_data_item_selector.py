...
T = TypeVar("T", bound="PostV1MonitoringCircuitsVisualizationResponse200DataItemSelector")


@_attrs_define
class PostV1MonitoringCircuitsVisualizationResponse200DataItemSelector:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_monitoring_circuits_visualization_response_200_data_item_selector = cls(
            circuit_name=circuit_name,
            core_location=core_location,
            type_=type_,
        )

        post_v1_monitoring_circuits_visualization_response_200_data_item_selector.additional_properties = d
        return post_v1_monitoring_circuits_visualization_response_200_data_item_selector
