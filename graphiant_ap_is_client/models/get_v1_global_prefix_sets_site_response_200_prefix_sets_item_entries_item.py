...
T = TypeVar("T", bound="GetV1GlobalPrefixSetsSiteResponse200PrefixSetsItemEntriesItem")


@_attrs_define
class GetV1GlobalPrefixSetsSiteResponse200PrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_prefix_sets_site_response_200_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        get_v1_global_prefix_sets_site_response_200_prefix_sets_item_entries_item.additional_properties = d
        return get_v1_global_prefix_sets_site_response_200_prefix_sets_item_entries_item
