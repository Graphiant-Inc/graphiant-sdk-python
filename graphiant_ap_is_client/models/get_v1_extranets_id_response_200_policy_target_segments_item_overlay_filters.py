...
T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        get_v1_extranets_id_response_200_policy_target_segments_item_overlay_filters.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item_overlay_filters
