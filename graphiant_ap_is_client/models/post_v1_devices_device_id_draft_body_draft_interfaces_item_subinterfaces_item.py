...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item_config_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item_ipv_4 import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item_ipv_6 import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item_oper_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv4 (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv4]):
        ipv6 (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemOperUpdatedAt]):
    ...
    config_updated_at: Union[
        Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    duplex: Union[Unset, str] = UNSET
    enabled: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipv4: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = (
                PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item
