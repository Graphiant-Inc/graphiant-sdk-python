...
T = TypeVar("T", bound="GetV1GatewaysIdDetailsResponse200DetailsAzure")


@_attrs_define
class GetV1GatewaysIdDetailsResponse200DetailsAzure:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_gateways_id_details_response_200_details_azure = cls(
            ms_peering_vlan_id=ms_peering_vlan_id,
            routing_policy=routing_policy,
            service_key=service_key,
        )

        get_v1_gateways_id_details_response_200_details_azure.additional_properties = d
        return get_v1_gateways_id_details_response_200_details_azure
