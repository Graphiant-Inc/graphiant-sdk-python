...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item_leases_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item_nameservers import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item_ranges_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item_static_leases_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem']]):
        ...
        nameservers (Union[Unset,
            PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem"]
    ] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers"
    ] = UNSET
    ranges: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem"]
    ] = UNSET
    static_leases: Union[
        Unset,
        list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem"],
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                    leases_item_data
                )
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                    ranges_item_data
                )
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_dhcp_subnets_item
