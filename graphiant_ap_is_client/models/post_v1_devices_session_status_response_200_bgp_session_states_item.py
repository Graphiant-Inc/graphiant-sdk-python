...
T = TypeVar("T", bound="PostV1DevicesSessionStatusResponse200BgpSessionStatesItem")


@_attrs_define
class PostV1DevicesSessionStatusResponse200BgpSessionStatesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_session_status_response_200_bgp_session_states_item = cls(
        ...
        post_v1_devices_session_status_response_200_bgp_session_states_item.additional_properties = d
        return post_v1_devices_session_status_response_200_bgp_session_states_item
