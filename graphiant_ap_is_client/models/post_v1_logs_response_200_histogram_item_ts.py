...
T = TypeVar("T", bound="PostV1LogsResponse200HistogramItemTs")


@_attrs_define
class PostV1LogsResponse200HistogramItemTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_logs_response_200_histogram_item_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_logs_response_200_histogram_item_ts.additional_properties = d
        return post_v1_logs_response_200_histogram_item_ts
