...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_bgp_multipath import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_bgp_redistributions import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_dhcp_subnets_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_ipfix_exporters_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_ospfv_2_process import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv2Process,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_ospfv_3_process import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv3Process,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_overlay_filters import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOverlayFilters,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_static_routes_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item_syslog_targets_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItem")


@_attrs_define
class GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset,
            GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset,
            GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemDhcpSubnetsItem']]):
        ...
        ipfix_exporters (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemIpfixExportersItem']]):
        ...
        static_routes (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpMultipath"
    ] = UNSET
    bgp_neighbors: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpRedistributions"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemDhcpSubnetsItem"]
    ] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemIpfixExportersItem"]
    ] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv2Process"
    ] = UNSET
    ospfv_3_process: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv3Process"
    ] = UNSET
    overlay_filters: Union[
        Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOverlayFilters"
    ] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemStaticRoutesItem"]
    ] = UNSET
    syslog_targets: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemSyslogTargetsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpMultipath.from_dict(
                    _bgp_multipath
                )
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv2Process.from_dict(
                    _ospfv_2_process
                )
            )
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOspfv3Process.from_dict(
                    _ospfv_3_process
                )
            )
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemOverlayFilters.from_dict(
                    _overlay_filters
                )
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item = cls(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item.additional_properties = d
        return get_v1_devices_device_id_versions_version_response_200_config_mana_device_segments_item
