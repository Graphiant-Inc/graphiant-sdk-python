...
T = TypeVar("T", bound="PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem")


@_attrs_define
class PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item_app_id_records_item = cls(
        ...
        post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item_app_id_records_item.additional_properties = d
        return post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item_app_id_records_item
