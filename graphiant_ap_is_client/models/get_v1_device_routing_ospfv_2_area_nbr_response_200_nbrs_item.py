...
if TYPE_CHECKING:
    from ..models.get_v1_device_routing_ospfv_2_area_nbr_response_200_nbrs_item_last_state_change import (
        GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItemLastStateChange,
    )


T = TypeVar("T", bound="GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItem")


@_attrs_define
class GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItem:
    """
    Attributes:
        address (Union[Unset, str]):  Example: 1.1.1.1.
        cost (Union[Unset, str]):  Example: 230.
        dead_timer (Union[Unset, str]):  Example: 40.
        last_state_change (Union[Unset, GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItemLastStateChange]):
    ...
    last_state_change: Union[Unset, "GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItemLastStateChange"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_last_state_change, Unset):
            ...
            last_state_change = GetV1DeviceRoutingOspfv2AreaNbrResponse200NbrsItemLastStateChange.from_dict(
                _last_state_change
            )
        ...
        get_v1_device_routing_ospfv_2_area_nbr_response_200_nbrs_item = cls(
            address=address,
            cost=cost,
        ...
        get_v1_device_routing_ospfv_2_area_nbr_response_200_nbrs_item.additional_properties = d
        return get_v1_device_routing_ospfv_2_area_nbr_response_200_nbrs_item
