...
T = TypeVar("T", bound="PostV2MonitoringQueueInstantResponse200DataItemSelector")


@_attrs_define
class PostV2MonitoringQueueInstantResponse200DataItemSelector:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_queue_instant_response_200_data_item_selector = cls(
            interface_name=interface_name,
            sla_class=sla_class,
            type_=type_,
        )

        post_v2_monitoring_queue_instant_response_200_data_item_selector.additional_properties = d
        return post_v2_monitoring_queue_instant_response_200_data_item_selector
