...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_address_families_item import (
        GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd import (
        GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1DevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item = cls(
        ...
        get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_circuits_item_bgp_neighbors_item
