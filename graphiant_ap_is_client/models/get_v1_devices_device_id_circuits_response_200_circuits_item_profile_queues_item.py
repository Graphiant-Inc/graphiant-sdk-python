...
T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfileQueuesItem")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfileQueuesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_profile_queues_item = cls(
            bandwidth_percent=bandwidth_percent,
            default_queue=default_queue,
            sla_class=sla_class,
        )

        get_v1_devices_device_id_circuits_response_200_circuits_item_profile_queues_item.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_profile_queues_item
