...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_applicationdetailsbyid_response_200_app_name_record_app_id_records_item import (
        PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem,
    )


T = TypeVar("T", bound="PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecord")


@_attrs_define
class PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecord:
    """
    Attributes:
        ...
        app_id_records (Union[Unset,
            list['PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem']]):
    ...
    app_id_records: Union[
        Unset, list["PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for app_id_records_item_data in _app_id_records or []:
            app_id_records_item = (
                PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem.from_dict(
        ...
        post_v2_assurance_applicationdetailsbyid_response_200_app_name_record = cls(
        ...
        post_v2_assurance_applicationdetailsbyid_response_200_app_name_record.additional_properties = d
        return post_v2_assurance_applicationdetailsbyid_response_200_app_name_record
