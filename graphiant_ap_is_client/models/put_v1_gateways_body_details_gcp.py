...
T = TypeVar("T", bound="PutV1GatewaysBodyDetailsGcp")


@_attrs_define
class PutV1GatewaysBodyDetailsGcp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_gateways_body_details_gcp = cls(
            description=description,
            pairing_key=pairing_key,
            routing_policy=routing_policy,
        )

        put_v1_gateways_body_details_gcp.additional_properties = d
        return put_v1_gateways_body_details_gcp
