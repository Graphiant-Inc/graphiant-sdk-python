...
T = TypeVar("T", bound="PutV1ExtranetsB2BIdBodyPolicySitesItem")


@_attrs_define
class PutV1ExtranetsB2BIdBodyPolicySitesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_b2b_id_body_policy_sites_item = cls(
        ...
        put_v1_extranets_b2b_id_body_policy_sites_item.additional_properties = d
        return put_v1_extranets_b2b_id_body_policy_sites_item
