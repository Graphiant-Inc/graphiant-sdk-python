...
T = TypeVar("T", bound="PostV1PolicyRouteTagSetsBodyTag")


@_attrs_define
class PostV1PolicyRouteTagSetsBodyTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_policy_route_tag_sets_body_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        post_v1_policy_route_tag_sets_body_tag.additional_properties = d
        return post_v1_policy_route_tag_sets_body_tag
