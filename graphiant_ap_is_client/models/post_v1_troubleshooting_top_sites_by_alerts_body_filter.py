...
T = TypeVar("T", bound="PostV1TroubleshootingTopSitesByAlertsBodyFilter")


@_attrs_define
class PostV1TroubleshootingTopSitesByAlertsBodyFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_troubleshooting_top_sites_by_alerts_body_filter = cls(
        ...
        post_v1_troubleshooting_top_sites_by_alerts_body_filter.additional_properties = d
        return post_v1_troubleshooting_top_sites_by_alerts_body_filter
