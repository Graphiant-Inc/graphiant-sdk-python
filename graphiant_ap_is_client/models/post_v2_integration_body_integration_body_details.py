...
T = TypeVar("T", bound="PostV2IntegrationBodyIntegrationBodyDetails")


@_attrs_define
class PostV2IntegrationBodyIntegrationBodyDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_integration_body_integration_body_details = cls(
            opsgenie_key=opsgenie_key,
            opsramp_details=opsramp_details,
            webhook_url=webhook_url,
        )

        post_v2_integration_body_integration_body_details.additional_properties = d
        return post_v2_integration_body_integration_body_details
