...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_aggregations_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpAggregationsItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_multipath import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpMultipath,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_redistributions import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpRedistributions,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_core_logical_interfaces_v2_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_profile import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemProfile,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_static_routes_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemStaticRoutesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_wan_interface_v2 import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem']]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemProfile]):
        ...
        static_routes (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset,
            PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpMultipath"] = (
        UNSET
    )
    bgp_neighbors: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpRedistributions"
    ] = UNSET
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemStaticRoutesItem"]
    ] = UNSET
    wan_interface_v2: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemWanInterfaceV2"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpMultipath.from_dict(
                _bgp_multipath
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemWanInterfaceV2.from_dict(
                    _wan_interface_v2
                )
            )

        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item
