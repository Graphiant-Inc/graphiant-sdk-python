...
T = TypeVar("T", bound="GetV1DevicesDeviceIdArpResponse200ArpEntryItem")


@_attrs_define
class GetV1DevicesDeviceIdArpResponse200ArpEntryItem:
    """
    Attributes:
        interface_name (Union[Unset, str]):  Example: TYPE_STRING.
        ipv_4_address (Union[Unset, str]):  Example: TYPE_STRING.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_arp_response_200_arp_entry_item = cls(
        ...
        get_v1_devices_device_id_arp_response_200_arp_entry_item.additional_properties = d
        return get_v1_devices_device_id_arp_response_200_arp_entry_item
