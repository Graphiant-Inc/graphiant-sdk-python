...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_routing_policies_item_statements_item import (
        PostV1DevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemRoutingPoliciesItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemRoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset, list['PostV1DevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[Unset, list["PostV1DevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = PostV1DevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem.from_dict(
        ...
        post_v1_devices_response_200_devices_item_routing_policies_item = cls(
        ...
        post_v1_devices_response_200_devices_item_routing_policies_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_routing_policies_item
