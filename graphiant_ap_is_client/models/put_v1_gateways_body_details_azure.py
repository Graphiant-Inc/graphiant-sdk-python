...
T = TypeVar("T", bound="PutV1GatewaysBodyDetailsAzure")


@_attrs_define
class PutV1GatewaysBodyDetailsAzure:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_gateways_body_details_azure = cls(
            ms_peering_vlan_id=ms_peering_vlan_id,
            routing_policy=routing_policy,
            service_key=service_key,
        )

        put_v1_gateways_body_details_azure.additional_properties = d
        return put_v1_gateways_body_details_azure
