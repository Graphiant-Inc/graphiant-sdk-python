...
if TYPE_CHECKING:
    from ..models.post_v2_site_site_id_topology_response_200_nodes_item_node_info_uptime import (
        PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfoUptime,
    )


T = TypeVar("T", bound="PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfo")


@_attrs_define
class PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfo:
    """
    Attributes:
        ...
        uptime (Union[Unset, PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfoUptime]):
    """
    ...
    uptime: Union[Unset, "PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfoUptime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_uptime, Unset):
            ...
            uptime = PostV2SiteSiteIdTopologyResponse200NodesItemNodeInfoUptime.from_dict(_uptime)

        post_v2_site_site_id_topology_response_200_nodes_item_node_info = cls(
        ...
        post_v2_site_site_id_topology_response_200_nodes_item_node_info.additional_properties = d
        return post_v2_site_site_id_topology_response_200_nodes_item_node_info
