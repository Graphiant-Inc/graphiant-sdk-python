...
if TYPE_CHECKING:
    from ..models.post_v1_devices_inventory_body_hardware_inventory_list_item_assigned_on import (
        PostV1DevicesInventoryBodyHardwareInventoryListItemAssignedOn,
    )
    from ..models.post_v1_devices_inventory_body_hardware_inventory_list_item_created_on import (
        PostV1DevicesInventoryBodyHardwareInventoryListItemCreatedOn,
    )


T = TypeVar("T", bound="PostV1DevicesInventoryBodyHardwareInventoryListItem")


@_attrs_define
class PostV1DevicesInventoryBodyHardwareInventoryListItem:
    """
    Attributes:
        assigned_on (Union[Unset, PostV1DevicesInventoryBodyHardwareInventoryListItemAssignedOn]):
        created_on (Union[Unset, PostV1DevicesInventoryBodyHardwareInventoryListItemCreatedOn]):
    ...
    assigned_on: Union[Unset, "PostV1DevicesInventoryBodyHardwareInventoryListItemAssignedOn"] = UNSET
    created_on: Union[Unset, "PostV1DevicesInventoryBodyHardwareInventoryListItemCreatedOn"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_assigned_on, Unset):
            ...
            assigned_on = PostV1DevicesInventoryBodyHardwareInventoryListItemAssignedOn.from_dict(_assigned_on)
        ...
        if isinstance(_created_on, Unset):
            ...
            created_on = PostV1DevicesInventoryBodyHardwareInventoryListItemCreatedOn.from_dict(_created_on)
        ...
        post_v1_devices_inventory_body_hardware_inventory_list_item = cls(
        ...
        post_v1_devices_inventory_body_hardware_inventory_list_item.additional_properties = d
        return post_v1_devices_inventory_body_hardware_inventory_list_item
