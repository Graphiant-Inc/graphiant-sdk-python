...
T = TypeVar("T", bound="GetV1GlobalSyslogsDeviceResponse200CollectorsItem")


@_attrs_define
class GetV1GlobalSyslogsDeviceResponse200CollectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_syslogs_device_response_200_collectors_item = cls(
        ...
        get_v1_global_syslogs_device_response_200_collectors_item.additional_properties = d
        return get_v1_global_syslogs_device_response_200_collectors_item
