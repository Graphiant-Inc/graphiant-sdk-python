...
T = TypeVar("T", bound="PostV2NotificationmutelistCreateBody")


@_attrs_define
class PostV2NotificationmutelistCreateBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_notificationmutelist_create_body = cls(
            alert_id=alert_id,
            note_text=note_text,
        )

        post_v2_notificationmutelist_create_body.additional_properties = d
        return post_v2_notificationmutelist_create_body
