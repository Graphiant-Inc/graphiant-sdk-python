...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item = cls(
        ...
        put_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item.additional_properties = d
        return put_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item
