...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_vrrp_group_group_members_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupGroupMembersItem,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_vrrp_group_tracked_interfaces_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupTrackedInterfacesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroup")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroup:
    """
    Attributes:
        ...
        group_members (Union[Unset,
            list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupGroupMembersItem']]):
        ...
        tracked_interfaces (Union[Unset, list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemV
            rrpGroupTrackedInterfacesItem']]):
    ...
    group_members: Union[
        Unset, list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupGroupMembersItem"]
    ] = UNSET
    ...
    tracked_interfaces: Union[
        Unset,
        list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupTrackedInterfacesItem"],
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for group_members_item_data in _group_members or []:
            group_members_item = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupGroupMembersItem.from_dict(
        ...
        for tracked_interfaces_item_data in _tracked_interfaces or []:
            tracked_interfaces_item = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemVrrpGroupTrackedInterfacesItem.from_dict(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_vrrp_group = cls(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_vrrp_group.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_vrrp_group
