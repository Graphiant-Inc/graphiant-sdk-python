...
T = TypeVar("T", bound="PostV1DeviceStatusHistoryBody")


@_attrs_define
class PostV1DeviceStatusHistoryBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_device_status_history_body = cls(
            device_ids=device_ids,
            role=role,
        )

        post_v1_device_status_history_body.additional_properties = d
        return post_v1_device_status_history_body
