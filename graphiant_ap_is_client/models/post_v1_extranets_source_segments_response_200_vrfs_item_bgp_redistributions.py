...
T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_redistributions.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_bgp_redistributions
