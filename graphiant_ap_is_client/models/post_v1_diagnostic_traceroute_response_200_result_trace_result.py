...
if TYPE_CHECKING:
    from ..models.post_v1_diagnostic_traceroute_response_200_result_trace_result_hops_item import (
        PostV1DiagnosticTracerouteResponse200ResultTraceResultHopsItem,
    )
    from ..models.post_v1_diagnostic_traceroute_response_200_result_trace_result_stopped_time import (
        PostV1DiagnosticTracerouteResponse200ResultTraceResultStoppedTime,
    )


T = TypeVar("T", bound="PostV1DiagnosticTracerouteResponse200ResultTraceResult")


@_attrs_define
class PostV1DiagnosticTracerouteResponse200ResultTraceResult:
    """
    Attributes:
        hops (Union[Unset, list['PostV1DiagnosticTracerouteResponse200ResultTraceResultHopsItem']]):
        ...
        stopped_time (Union[Unset, PostV1DiagnosticTracerouteResponse200ResultTraceResultStoppedTime]):
    """

    hops: Union[Unset, list["PostV1DiagnosticTracerouteResponse200ResultTraceResultHopsItem"]] = UNSET
    ...
    stopped_time: Union[Unset, "PostV1DiagnosticTracerouteResponse200ResultTraceResultStoppedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for hops_item_data in _hops or []:
            hops_item = PostV1DiagnosticTracerouteResponse200ResultTraceResultHopsItem.from_dict(hops_item_data)
        ...
        if isinstance(_stopped_time, Unset):
            ...
            stopped_time = PostV1DiagnosticTracerouteResponse200ResultTraceResultStoppedTime.from_dict(_stopped_time)

        post_v1_diagnostic_traceroute_response_200_result_trace_result = cls(
            hops=hops,
        ...
        post_v1_diagnostic_traceroute_response_200_result_trace_result.additional_properties = d
        return post_v1_diagnostic_traceroute_response_200_result_trace_result
