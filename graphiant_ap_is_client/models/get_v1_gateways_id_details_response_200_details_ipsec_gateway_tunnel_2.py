...
T = TypeVar("T", bound="GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2")


@_attrs_define
class GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_gateways_id_details_response_200_details_ipsec_gateway_tunnel_2 = cls(
        ...
        get_v1_gateways_id_details_response_200_details_ipsec_gateway_tunnel_2.additional_properties = d
        return get_v1_gateways_id_details_response_200_details_ipsec_gateway_tunnel_2
