...
T = TypeVar("T", bound="GetV1GatewaysIdDetailsResponse200DetailsGcp")


@_attrs_define
class GetV1GatewaysIdDetailsResponse200DetailsGcp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_gateways_id_details_response_200_details_gcp = cls(
            description=description,
            pairing_key=pairing_key,
            routing_policy=routing_policy,
        )

        get_v1_gateways_id_details_response_200_details_gcp.additional_properties = d
        return get_v1_gateways_id_details_response_200_details_gcp
