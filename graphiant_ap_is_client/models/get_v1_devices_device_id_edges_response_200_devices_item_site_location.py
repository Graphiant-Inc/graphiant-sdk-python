...
T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSiteLocation")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSiteLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_site_location = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_site_location.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_site_location
