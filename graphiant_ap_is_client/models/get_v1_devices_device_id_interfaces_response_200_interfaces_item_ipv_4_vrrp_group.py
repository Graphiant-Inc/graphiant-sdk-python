...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4_vrrp_group_group_members_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupGroupMembersItem,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4_vrrp_group_tracked_interfaces_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupTrackedInterfacesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroup")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroup:
    """
    Attributes:
        ...
        group_members (Union[Unset,
            list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupGroupMembersItem']]):
        ...
        tracked_interfaces (Union[Unset,
            list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupTrackedInterfacesItem']]):
    ...
    group_members: Union[
        Unset, list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupGroupMembersItem"]
    ] = UNSET
    ...
    tracked_interfaces: Union[
        Unset, list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupTrackedInterfacesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for group_members_item_data in _group_members or []:
            group_members_item = (
                GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupGroupMembersItem.from_dict(
        ...
        for tracked_interfaces_item_data in _tracked_interfaces or []:
            tracked_interfaces_item = (
                GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4VrrpGroupTrackedInterfacesItem.from_dict(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4_vrrp_group = cls(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4_vrrp_group.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4_vrrp_group
