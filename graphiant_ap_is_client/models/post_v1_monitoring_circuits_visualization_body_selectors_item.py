...
T = TypeVar("T", bound="PostV1MonitoringCircuitsVisualizationBodySelectorsItem")


@_attrs_define
class PostV1MonitoringCircuitsVisualizationBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_monitoring_circuits_visualization_body_selectors_item = cls(
            circuit_name=circuit_name,
            core_location=core_location,
            type_=type_,
        )

        post_v1_monitoring_circuits_visualization_body_selectors_item.additional_properties = d
        return post_v1_monitoring_circuits_visualization_body_selectors_item
