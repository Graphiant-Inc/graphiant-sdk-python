...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_aggregations_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_multipath import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpMultipath,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_redistributions import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_core_logical_interfaces_v2_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_profile import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemProfile,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_static_routes_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_wan_interface_v2 import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem']]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemProfile]):
        ...
        static_routes (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset,
            GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpMultipath"] = (
        UNSET
    )
    bgp_neighbors: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpRedistributions"
    ] = UNSET
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemStaticRoutesItem"]
    ] = UNSET
    wan_interface_v2: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemWanInterfaceV2"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpMultipath.from_dict(
                _bgp_multipath
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemWanInterfaceV2.from_dict(
                    _wan_interface_v2
                )
            )

        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item
