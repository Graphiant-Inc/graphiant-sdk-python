...
T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_address_families_item = cls(
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_address_families_item.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_address_families_item
