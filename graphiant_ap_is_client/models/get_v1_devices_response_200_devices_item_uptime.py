...
T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemUptime")


@_attrs_define
class GetV1DevicesResponse200DevicesItemUptime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_response_200_devices_item_uptime = cls(
            nanos=nanos,
            seconds=seconds,
        )

        get_v1_devices_response_200_devices_item_uptime.additional_properties = d
        return get_v1_devices_response_200_devices_item_uptime
