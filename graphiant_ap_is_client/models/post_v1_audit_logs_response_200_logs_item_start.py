...
T = TypeVar("T", bound="PostV1AuditLogsResponse200LogsItemStart")


@_attrs_define
class PostV1AuditLogsResponse200LogsItemStart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_logs_response_200_logs_item_start = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_logs_response_200_logs_item_start.additional_properties = d
        return post_v1_audit_logs_response_200_logs_item_start
