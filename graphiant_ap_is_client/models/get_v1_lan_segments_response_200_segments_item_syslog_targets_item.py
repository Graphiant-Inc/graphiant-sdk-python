...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_syslog_targets_item = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_syslog_targets_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_syslog_targets_item
