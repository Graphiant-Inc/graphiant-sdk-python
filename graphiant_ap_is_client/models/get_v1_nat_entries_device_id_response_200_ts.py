...
T = TypeVar("T", bound="GetV1NatEntriesDeviceIdResponse200Ts")


@_attrs_define
class GetV1NatEntriesDeviceIdResponse200Ts:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_nat_entries_device_id_response_200_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        get_v1_nat_entries_device_id_response_200_ts.additional_properties = d
        return get_v1_nat_entries_device_id_response_200_ts
