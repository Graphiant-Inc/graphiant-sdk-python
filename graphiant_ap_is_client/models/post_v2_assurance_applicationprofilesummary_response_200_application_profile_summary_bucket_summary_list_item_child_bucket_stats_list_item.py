...
T = TypeVar(
    "T",
    bound="PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemChildBucketStatsListItem",
)


@_attrs_define
class PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemChildBucketStatsListItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_child_bucket_stats_list_item = cls(
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_child_bucket_stats_list_item.additional_properties = d
        return post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_child_bucket_stats_list_item
