...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_config_updated_at import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_ip_sec import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_ipv_4 import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv4,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_ipv_6 import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_ipv_6_addresses_item import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_oper_updated_at import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemOperUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_sfp_optical_strength_item import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSfpOpticalStrengthItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceInterfacesItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceInterfacesItem:
    """
    Attributes:
        ...
        config_updated_at (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemConfigUpdatedAt]):
        ...
        ip_sec (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec]):
        ipv4 (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemOperUpdatedAt]):
        ...
        sfp_optical_strength (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSfpOpticalStrengthItem']]):
        speed_mbps (Union[Unset, str]):  Example: TYPE_UINT32.
        subinterfaces (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem']]):
    ...
    config_updated_at: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemConfigUpdatedAt"] = UNSET
    ...
    ip_sec: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec"] = UNSET
    ipv4: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6AddressesItem"]] = UNSET
    lan: Union[Unset, str] = UNSET
    lldp_enabled: Union[Unset, str] = UNSET
    max_transmission_unit: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    oper_updated_at: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemOperUpdatedAt"] = UNSET
    phy_address: Union[Unset, str] = UNSET
    security_zone: Union[Unset, str] = UNSET
    sfp_optical_strength: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSfpOpticalStrengthItem"]
    ] = UNSET
    speed_mbps: Union[Unset, str] = UNSET
    subinterfaces: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemConfigUpdatedAt.from_dict(
                _config_updated_at
            )
        ...
        if isinstance(_ip_sec, Unset):
            ...
            ip_sec = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec.from_dict(_ip_sec)
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        for sfp_optical_strength_item_data in _sfp_optical_strength or []:
            sfp_optical_strength_item = (
                GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSfpOpticalStrengthItem.from_dict(
        ...
        for subinterfaces_item_data in _subinterfaces or []:
            subinterfaces_item = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_interfaces_item
