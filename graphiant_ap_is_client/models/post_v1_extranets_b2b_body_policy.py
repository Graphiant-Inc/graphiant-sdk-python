...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_b2b_body_policy_profiles_item import PostV1ExtranetsB2BBodyPolicyProfilesItem
    from ..models.post_v1_extranets_b2b_body_policy_sites_item import PostV1ExtranetsB2BBodyPolicySitesItem
    from ..models.post_v1_extranets_b2b_body_policy_sla import PostV1ExtranetsB2BBodyPolicySla


T = TypeVar("T", bound="PostV1ExtranetsB2BBodyPolicy")


@_attrs_define
class PostV1ExtranetsB2BBodyPolicy:
    """
    Attributes:
        nat_pools (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        profiles (Union[Unset, list['PostV1ExtranetsB2BBodyPolicyProfilesItem']]):
        service_lan_segment (Union[Unset, str]):  Example: TYPE_INT64.
        service_prefixes (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        sites (Union[Unset, list['PostV1ExtranetsB2BBodyPolicySitesItem']]):
        sla (Union[Unset, PostV1ExtranetsB2BBodyPolicySla]):
        type_ (Union[Unset, str]):  Example: TYPE_ENUM.
    """

    nat_pools: Union[Unset, list[str]] = UNSET
    profiles: Union[Unset, list["PostV1ExtranetsB2BBodyPolicyProfilesItem"]] = UNSET
    service_lan_segment: Union[Unset, str] = UNSET
    service_prefixes: Union[Unset, list[str]] = UNSET
    sites: Union[Unset, list["PostV1ExtranetsB2BBodyPolicySitesItem"]] = UNSET
    sla: Union[Unset, "PostV1ExtranetsB2BBodyPolicySla"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for profiles_item_data in _profiles or []:
            profiles_item = PostV1ExtranetsB2BBodyPolicyProfilesItem.from_dict(profiles_item_data)
        ...
        for sites_item_data in _sites or []:
            sites_item = PostV1ExtranetsB2BBodyPolicySitesItem.from_dict(sites_item_data)
        ...
        if isinstance(_sla, Unset):
            ...
            sla = PostV1ExtranetsB2BBodyPolicySla.from_dict(_sla)

        type_ = d.pop("type", UNSET)

        post_v1_extranets_b2b_body_policy = cls(
            nat_pools=nat_pools,
            profiles=profiles,
        ...
        post_v1_extranets_b2b_body_policy.additional_properties = d
        return post_v1_extranets_b2b_body_policy
