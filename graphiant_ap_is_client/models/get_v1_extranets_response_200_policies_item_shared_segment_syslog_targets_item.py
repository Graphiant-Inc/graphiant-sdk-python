...
T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_syslog_targets_item = cls(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_syslog_targets_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment_syslog_targets_item
