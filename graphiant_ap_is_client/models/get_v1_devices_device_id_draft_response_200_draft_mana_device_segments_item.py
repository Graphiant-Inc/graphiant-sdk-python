...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_bgp_multipath import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_bgp_redistributions import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_dhcp_subnets_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_ipfix_exporters_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_ospfv_2_process import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv2Process,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_ospfv_3_process import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv3Process,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_overlay_filters import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOverlayFilters,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_static_routes_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item_syslog_targets_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset,
            GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemDhcpSubnetsItem']]):
        ...
        ipfix_exporters (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv3Process]):
        overlay_filters (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOverlayFilters]):
        ...
        static_routes (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpRedistributions"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemDhcpSubnetsItem"]
    ] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemIpfixExportersItem"]
    ] = UNSET
    ...
    static_routes: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemStaticRoutesItem"]
    ] = UNSET
    syslog_targets: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemSyslogTargetsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpMultipath.from_dict(
                _bgp_multipath
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv2Process.from_dict(
                _ospfv_2_process
            )
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOspfv3Process.from_dict(
                _ospfv_3_process
            )
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemOverlayFilters.from_dict(
                _overlay_filters
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_segments_item
