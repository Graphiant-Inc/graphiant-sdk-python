...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_address_families_item = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_address_families_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_address_families_item
