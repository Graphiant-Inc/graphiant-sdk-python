...
T = TypeVar("T", bound="PutV1AuthResponse204")


@_attrs_define
class PutV1AuthResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_auth_response_204 = cls(
            affected_users=affected_users,
            all_groups=all_groups,
        )

        put_v1_auth_response_204.additional_properties = d
        return put_v1_auth_response_204
