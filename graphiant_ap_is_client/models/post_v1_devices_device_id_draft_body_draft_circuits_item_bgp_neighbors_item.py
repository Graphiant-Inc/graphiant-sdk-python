...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item_address_families_item import (
        PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item_bfd import (
        PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_circuits_item_bgp_neighbors_item
