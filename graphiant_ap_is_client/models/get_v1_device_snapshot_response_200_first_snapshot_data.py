...
T = TypeVar("T", bound="GetV1DeviceSnapshotResponse200FirstSnapshotData")


@_attrs_define
class GetV1DeviceSnapshotResponse200FirstSnapshotData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_snapshot_response_200_first_snapshot_data = cls(
        ...
        get_v1_device_snapshot_response_200_first_snapshot_data.additional_properties = d
        return get_v1_device_snapshot_response_200_first_snapshot_data
