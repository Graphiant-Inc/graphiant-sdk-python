...
T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicyAuto")


@_attrs_define
class PostV1ExtranetsResponse200PolicyAuto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_response_200_policy_auto = cls(
            auto_propagate=auto_propagate,
            excluded_prefixes=excluded_prefixes,
        )

        post_v1_extranets_response_200_policy_auto.additional_properties = d
        return post_v1_extranets_response_200_policy_auto
