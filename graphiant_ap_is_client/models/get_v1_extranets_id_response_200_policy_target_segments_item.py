...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_aggregations_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_multipath import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpMultipath,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_redistributions import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_ipfix_exporters_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_2_process import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv2Process,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_overlay_filters import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_static_routes_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process]):
        overlay_filters (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem']]):
    ...
    bgp_multipath: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv2Process.from_dict(
                _ospfv_2_process
            )
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process.from_dict(
                _ospfv_3_process
            )
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOverlayFilters.from_dict(
                _overlay_filters
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item = cls(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item
