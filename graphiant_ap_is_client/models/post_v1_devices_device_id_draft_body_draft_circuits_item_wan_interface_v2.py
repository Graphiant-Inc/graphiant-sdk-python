...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemWanInterfaceV2")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftCircuitsItemWanInterfaceV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_circuits_item_wan_interface_v2 = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_circuits_item_wan_interface_v2.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_circuits_item_wan_interface_v2
