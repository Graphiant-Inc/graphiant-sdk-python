...
if TYPE_CHECKING:
    from ..models.post_v1_diagnostic_ping_pause_resume_response_204_result_trace_result_hops_item import (
        PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultHopsItem,
    )
    from ..models.post_v1_diagnostic_ping_pause_resume_response_204_result_trace_result_stopped_time import (
        PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultStoppedTime,
    )


T = TypeVar("T", bound="PostV1DiagnosticPingPauseResumeResponse204ResultTraceResult")


@_attrs_define
class PostV1DiagnosticPingPauseResumeResponse204ResultTraceResult:
    """
    Attributes:
        hops (Union[Unset, list['PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultHopsItem']]):
        ...
        stopped_time (Union[Unset, PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultStoppedTime]):
    """

    hops: Union[Unset, list["PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultHopsItem"]] = UNSET
    ...
    stopped_time: Union[Unset, "PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultStoppedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for hops_item_data in _hops or []:
            hops_item = PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultHopsItem.from_dict(hops_item_data)
        ...
        if isinstance(_stopped_time, Unset):
            ...
            stopped_time = PostV1DiagnosticPingPauseResumeResponse204ResultTraceResultStoppedTime.from_dict(
                _stopped_time
            )

        post_v1_diagnostic_ping_pause_resume_response_204_result_trace_result = cls(
            hops=hops,
        ...
        post_v1_diagnostic_ping_pause_resume_response_204_result_trace_result.additional_properties = d
        return post_v1_diagnostic_ping_pause_resume_response_204_result_trace_result
