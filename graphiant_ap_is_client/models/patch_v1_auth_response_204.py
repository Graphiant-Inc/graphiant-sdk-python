...
T = TypeVar("T", bound="PatchV1AuthResponse204")


@_attrs_define
class PatchV1AuthResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        patch_v1_auth_response_204 = cls(
            affected_users=affected_users,
            all_groups=all_groups,
        )

        patch_v1_auth_response_204.additional_properties = d
        return patch_v1_auth_response_204
