...
T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item = (
            cls(
                index=index,
                rx_power=rx_power,
                tx_bias=tx_bias,
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item.additional_properties = d
        return (
            get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item
        )
