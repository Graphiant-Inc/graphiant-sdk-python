...
T = TypeVar("T", bound="PostV1ExtranetsB2BConsumerResponse200SiteInformationItem")


@_attrs_define
class PostV1ExtranetsB2BConsumerResponse200SiteInformationItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_consumer_response_200_site_information_item = cls(
        ...
        post_v1_extranets_b2b_consumer_response_200_site_information_item.additional_properties = d
        return post_v1_extranets_b2b_consumer_response_200_site_information_item
