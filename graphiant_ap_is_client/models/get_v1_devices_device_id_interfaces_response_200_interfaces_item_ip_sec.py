...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ip_sec_established_time import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec:
    """
    Attributes:
        ...
        established_time (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSecEstablishedTime]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSecEstablishedTime.from_dict(
                _established_time
            )
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ip_sec = cls(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ip_sec.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item_ip_sec
