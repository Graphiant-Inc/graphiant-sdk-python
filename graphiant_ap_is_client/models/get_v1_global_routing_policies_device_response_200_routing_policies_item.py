...
if TYPE_CHECKING:
    from ..models.get_v1_global_routing_policies_device_response_200_routing_policies_item_statements_item import (
        GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItem")


@_attrs_define
class GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset, list['GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItem']]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItem.from_dict(
        ...
        get_v1_global_routing_policies_device_response_200_routing_policies_item = cls(
        ...
        get_v1_global_routing_policies_device_response_200_routing_policies_item.additional_properties = d
        return get_v1_global_routing_policies_device_response_200_routing_policies_item
