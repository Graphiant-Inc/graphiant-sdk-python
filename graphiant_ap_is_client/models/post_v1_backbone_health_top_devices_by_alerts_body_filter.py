...
T = TypeVar("T", bound="PostV1BackboneHealthTopDevicesByAlertsBodyFilter")


@_attrs_define
class PostV1BackboneHealthTopDevicesByAlertsBodyFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_backbone_health_top_devices_by_alerts_body_filter = cls(
        ...
        post_v1_backbone_health_top_devices_by_alerts_body_filter.additional_properties = d
        return post_v1_backbone_health_top_devices_by_alerts_body_filter
