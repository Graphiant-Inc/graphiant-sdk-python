...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemSyslogTargetsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_syslog_targets_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_syslog_targets_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_segments_item_syslog_targets_item
