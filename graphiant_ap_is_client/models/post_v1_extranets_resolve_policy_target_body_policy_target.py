...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_body_policy_target_prefix_set import (
        PostV1ExtranetsResolvePolicyTargetBodyPolicyTargetPrefixSet,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetBodyPolicyTarget")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetBodyPolicyTarget:
    """
    Attributes:
        excluded_devices (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
        prefix_set (Union[Unset, PostV1ExtranetsResolvePolicyTargetBodyPolicyTargetPrefixSet]):
        sites (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
    """

    excluded_devices: Union[Unset, list[str]] = UNSET
    prefix_set: Union[Unset, "PostV1ExtranetsResolvePolicyTargetBodyPolicyTargetPrefixSet"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_prefix_set, Unset):
            ...
            prefix_set = PostV1ExtranetsResolvePolicyTargetBodyPolicyTargetPrefixSet.from_dict(_prefix_set)

        sites = cast(list[str], d.pop("sites", UNSET))

        post_v1_extranets_resolve_policy_target_body_policy_target = cls(
            excluded_devices=excluded_devices,
            prefix_set=prefix_set,
            sites=sites,
        )

        post_v1_extranets_resolve_policy_target_body_policy_target.additional_properties = d
        return post_v1_extranets_resolve_policy_target_body_policy_target
