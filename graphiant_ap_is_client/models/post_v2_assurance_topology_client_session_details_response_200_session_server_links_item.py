...
T = TypeVar("T", bound="PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem")


@_attrs_define
class PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_topology_client_session_details_response_200_session_server_links_item = cls(
        ...
        post_v2_assurance_topology_client_session_details_response_200_session_server_links_item.additional_properties = d
        return post_v2_assurance_topology_client_session_details_response_200_session_server_links_item
