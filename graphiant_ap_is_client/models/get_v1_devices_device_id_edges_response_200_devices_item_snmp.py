...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_communities_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpCommunitiesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_engine_endpoints_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpEngineEndpointsItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_notify_filter_profiles_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpNotifyFilterProfilesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_targets_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpTargetsItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_usm_local_users_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmLocalUsersItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_usm_remote_users_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmRemoteUsersItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_snmp_vacm_groups_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmp")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmp:
    """
    Attributes:
        communities (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpTargetsItem']]):
        usm_local_users (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpVacmGroupsItem']]):
    """

    communities: Union[Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpCommunitiesItem"]] = UNSET
    ...
    notify_filter_profiles: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpNotifyFilterProfilesItem"]
    ] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmLocalUsersItem"]] = UNSET
    usm_remote_users: Union[Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmRemoteUsersItem"]] = (
        UNSET
    )
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpCommunitiesItem.from_dict(
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpTargetsItem.from_dict(targets_item_data)
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpVacmGroupsItem.from_dict(
                vacm_groups_item_data
            )

            vacm_groups.append(vacm_groups_item)

        get_v1_devices_device_id_edges_response_200_devices_item_snmp = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_snmp.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_snmp
