...
T = TypeVar("T", bound="PostV2AssuranceTopologyClientSessionsBodyFilter")


@_attrs_define
class PostV2AssuranceTopologyClientSessionsBodyFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_topology_client_sessions_body_filter = cls(
            client_site_ids=client_site_ids,
            region_ids=region_ids,
            server_site_ids=server_site_ids,
        )

        post_v2_assurance_topology_client_sessions_body_filter.additional_properties = d
        return post_v2_assurance_topology_client_sessions_body_filter
