...
T = TypeVar("T", bound="GetV1ExtranetsB2BConsumerIdResponse200PolicyItemOutboundSecurityRulesItemMatch")


@_attrs_define
class GetV1ExtranetsB2BConsumerIdResponse200PolicyItemOutboundSecurityRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_consumer_id_response_200_policy_item_outbound_security_rules_item_match = cls(
        ...
        get_v1_extranets_b2b_consumer_id_response_200_policy_item_outbound_security_rules_item_match.additional_properties = d
        return get_v1_extranets_b2b_consumer_id_response_200_policy_item_outbound_security_rules_item_match
