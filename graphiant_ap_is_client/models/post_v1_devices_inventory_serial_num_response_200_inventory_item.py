...
if TYPE_CHECKING:
    from ..models.post_v1_devices_inventory_serial_num_response_200_inventory_item_assigned_on import (
        PostV1DevicesInventorySerialNumResponse200InventoryItemAssignedOn,
    )
    from ..models.post_v1_devices_inventory_serial_num_response_200_inventory_item_created_on import (
        PostV1DevicesInventorySerialNumResponse200InventoryItemCreatedOn,
    )


T = TypeVar("T", bound="PostV1DevicesInventorySerialNumResponse200InventoryItem")


@_attrs_define
class PostV1DevicesInventorySerialNumResponse200InventoryItem:
    """
    Attributes:
        assigned_on (Union[Unset, PostV1DevicesInventorySerialNumResponse200InventoryItemAssignedOn]):
        created_on (Union[Unset, PostV1DevicesInventorySerialNumResponse200InventoryItemCreatedOn]):
    ...
    assigned_on: Union[Unset, "PostV1DevicesInventorySerialNumResponse200InventoryItemAssignedOn"] = UNSET
    created_on: Union[Unset, "PostV1DevicesInventorySerialNumResponse200InventoryItemCreatedOn"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_assigned_on, Unset):
            ...
            assigned_on = PostV1DevicesInventorySerialNumResponse200InventoryItemAssignedOn.from_dict(_assigned_on)
        ...
        if isinstance(_created_on, Unset):
            ...
            created_on = PostV1DevicesInventorySerialNumResponse200InventoryItemCreatedOn.from_dict(_created_on)
        ...
        post_v1_devices_inventory_serial_num_response_200_inventory_item = cls(
        ...
        post_v1_devices_inventory_serial_num_response_200_inventory_item.additional_properties = d
        return post_v1_devices_inventory_serial_num_response_200_inventory_item
