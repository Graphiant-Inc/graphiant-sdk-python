...
T = TypeVar("T", bound="GetV1DeviceRoutingOspfv3AreaInterfaceResponse200InterfacesItem")


@_attrs_define
class GetV1DeviceRoutingOspfv3AreaInterfaceResponse200InterfacesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_routing_ospfv_3_area_interface_response_200_interfaces_item = cls(
        ...
        get_v1_device_routing_ospfv_3_area_interface_response_200_interfaces_item.additional_properties = d
        return get_v1_device_routing_ospfv_3_area_interface_response_200_interfaces_item
