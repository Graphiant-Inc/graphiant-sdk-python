...
if TYPE_CHECKING:
    from ..models.get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item_community_item import (
        GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemCommunityItem,
    )
    from ..models.get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item_contributing_src import (
        GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemContributingSrc,
    )
    from ..models.get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item_ext_community_item import (
        GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemExtCommunityItem,
    )
    from ..models.get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item_last_modified import (
        GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemLastModified,
    )


T = TypeVar("T", bound="GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItem")


@_attrs_define
class GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItem:
    """
    Attributes:
        as_path (Union[Unset, list[str]]):  Example: ['23212, 45432'].
        community (Union[Unset, list['GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemCommunityItem']]):
        contributing_src (Union[Unset, GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemContributingSrc]):
        egress_interface (Union[Unset, str]):  Example: ATTInterface.
        ext_community (Union[Unset,
            list['GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemExtCommunityItem']]):
        is_stale (Union[Unset, str]):  Example: true.
        last_modified (Union[Unset, GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemLastModified]):
    ...
    community: Union[Unset, list["GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemCommunityItem"]] = UNSET
    contributing_src: Union[Unset, "GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemContributingSrc"] = UNSET
    egress_interface: Union[Unset, str] = UNSET
    ext_community: Union[Unset, list["GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemExtCommunityItem"]] = (
        UNSET
    )
    is_stale: Union[Unset, str] = UNSET
    last_modified: Union[Unset, "GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemLastModified"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for community_item_data in _community or []:
            community_item = GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemCommunityItem.from_dict(
                community_item_data
            )
        ...
        if isinstance(_contributing_src, Unset):
            ...
            contributing_src = GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemContributingSrc.from_dict(
                _contributing_src
            )
        ...
        for ext_community_item_data in _ext_community or []:
            ext_community_item = GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemExtCommunityItem.from_dict(
        ...
        if isinstance(_last_modified, Unset):
            ...
            last_modified = GetV1DeviceRoutingGraphiantRibResponse200RoutesItemPathItemLastModified.from_dict(
                _last_modified
            )
        ...
        get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item = cls(
            as_path=as_path,
            community=community,
        ...
        get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item.additional_properties = d
        return get_v1_device_routing_graphiant_rib_response_200_routes_item_path_item
