...
T = TypeVar("T", bound="GetV1GlobalIpfixSiteResponse200ExportersItem")


@_attrs_define
class GetV1GlobalIpfixSiteResponse200ExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_ipfix_site_response_200_exporters_item = cls(
        ...
        get_v1_global_ipfix_site_response_200_exporters_item.additional_properties = d
        return get_v1_global_ipfix_site_response_200_exporters_item
