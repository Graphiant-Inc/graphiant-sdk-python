...
T = TypeVar("T", bound="GetV1GlobalIpfixDeviceResponse200ExportersItem")


@_attrs_define
class GetV1GlobalIpfixDeviceResponse200ExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_ipfix_device_response_200_exporters_item = cls(
        ...
        get_v1_global_ipfix_device_response_200_exporters_item.additional_properties = d
        return get_v1_global_ipfix_device_response_200_exporters_item
