...
T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters")


@_attrs_define
class PostV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_response_200_devices_item_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        post_v1_devices_response_200_devices_item_segments_item_overlay_filters.additional_properties = d
        return post_v1_devices_response_200_devices_item_segments_item_overlay_filters
