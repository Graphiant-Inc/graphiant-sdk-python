...
if TYPE_CHECKING:
    from ..models.post_v1_global_snmps_response_200_snmps_item_communities_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemCommunitiesItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_engine_endpoints_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemEngineEndpointsItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_notify_filter_profiles_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemNotifyFilterProfilesItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_targets_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_usm_local_users_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_usm_remote_users_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemUsmRemoteUsersItem,
    )
    from ..models.post_v1_global_snmps_response_200_snmps_item_vacm_groups_item import (
        PostV1GlobalSnmpsResponse200SnmpsItemVacmGroupsItem,
    )


T = TypeVar("T", bound="PostV1GlobalSnmpsResponse200SnmpsItem")


@_attrs_define
class PostV1GlobalSnmpsResponse200SnmpsItem:
    """
    Attributes:
        communities (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem']]):
        usm_local_users (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['PostV1GlobalSnmpsResponse200SnmpsItemVacmGroupsItem']]):
    """

    communities: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemCommunitiesItem"]] = UNSET
    ...
    engine_endpoints: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemEngineEndpointsItem"]] = UNSET
    ...
    notify_filter_profiles: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemNotifyFilterProfilesItem"]] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem"]] = UNSET
    usm_remote_users: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemUsmRemoteUsersItem"]] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["PostV1GlobalSnmpsResponse200SnmpsItemVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = PostV1GlobalSnmpsResponse200SnmpsItemCommunitiesItem.from_dict(communities_item_data)
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = PostV1GlobalSnmpsResponse200SnmpsItemEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = PostV1GlobalSnmpsResponse200SnmpsItemNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem.from_dict(targets_item_data)
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = PostV1GlobalSnmpsResponse200SnmpsItemUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = PostV1GlobalSnmpsResponse200SnmpsItemUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = PostV1GlobalSnmpsResponse200SnmpsItemVacmGroupsItem.from_dict(vacm_groups_item_data)

            vacm_groups.append(vacm_groups_item)

        post_v1_global_snmps_response_200_snmps_item = cls(
        ...
        post_v1_global_snmps_response_200_snmps_item.additional_properties = d
        return post_v1_global_snmps_response_200_snmps_item
