...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_address_families_item import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_bfd import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item = cls(
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item
