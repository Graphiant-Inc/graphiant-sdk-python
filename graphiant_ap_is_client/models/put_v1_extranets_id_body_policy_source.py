...
if TYPE_CHECKING:
    from ..models.put_v1_extranets_id_body_policy_source_prefix_set import PutV1ExtranetsIdBodyPolicySourcePrefixSet


T = TypeVar("T", bound="PutV1ExtranetsIdBodyPolicySource")


@_attrs_define
class PutV1ExtranetsIdBodyPolicySource:
    """
    Attributes:
        excluded_devices (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
        prefix_set (Union[Unset, PutV1ExtranetsIdBodyPolicySourcePrefixSet]):
        sites (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
    """

    excluded_devices: Union[Unset, list[str]] = UNSET
    prefix_set: Union[Unset, "PutV1ExtranetsIdBodyPolicySourcePrefixSet"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_prefix_set, Unset):
            ...
            prefix_set = PutV1ExtranetsIdBodyPolicySourcePrefixSet.from_dict(_prefix_set)

        sites = cast(list[str], d.pop("sites", UNSET))

        put_v1_extranets_id_body_policy_source = cls(
            excluded_devices=excluded_devices,
            prefix_set=prefix_set,
            sites=sites,
        )

        put_v1_extranets_id_body_policy_source.additional_properties = d
        return put_v1_extranets_id_body_policy_source
