...
if TYPE_CHECKING:
    from ..models.post_v2_childalertlist_response_200_alert_list_item_children_alert_list import (
        PostV2ChildalertlistResponse200AlertListItemChildrenAlertList,
    )


T = TypeVar("T", bound="PostV2ChildalertlistResponse200AlertListItem")


@_attrs_define
class PostV2ChildalertlistResponse200AlertListItem:
    """
    Attributes:
        ...
        children_alert_list (Union[Unset, PostV2ChildalertlistResponse200AlertListItemChildrenAlertList]):
    ...
    children_alert_list: Union[Unset, "PostV2ChildalertlistResponse200AlertListItemChildrenAlertList"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_children_alert_list, Unset):
            ...
            children_alert_list = PostV2ChildalertlistResponse200AlertListItemChildrenAlertList.from_dict(
        ...
        post_v2_childalertlist_response_200_alert_list_item = cls(
        ...
        post_v2_childalertlist_response_200_alert_list_item.additional_properties = d
        return post_v2_childalertlist_response_200_alert_list_item
