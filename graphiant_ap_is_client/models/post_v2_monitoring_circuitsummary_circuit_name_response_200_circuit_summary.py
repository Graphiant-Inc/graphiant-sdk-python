...
T = TypeVar("T", bound="PostV2MonitoringCircuitsummaryCircuitNameResponse200CircuitSummary")


@_attrs_define
class PostV2MonitoringCircuitsummaryCircuitNameResponse200CircuitSummary:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_circuitsummary_circuit_name_response_200_circuit_summary = cls(
        ...
        post_v2_monitoring_circuitsummary_circuit_name_response_200_circuit_summary.additional_properties = d
        return post_v2_monitoring_circuitsummary_circuit_name_response_200_circuit_summary
