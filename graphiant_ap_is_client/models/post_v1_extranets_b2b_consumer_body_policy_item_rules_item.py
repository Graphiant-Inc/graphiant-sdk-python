...
T = TypeVar("T", bound="PostV1ExtranetsB2BConsumerBodyPolicyItemRulesItem")


@_attrs_define
class PostV1ExtranetsB2BConsumerBodyPolicyItemRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_consumer_body_policy_item_rules_item = cls(
            outside_nat_prefix=outside_nat_prefix,
            service_prefix=service_prefix,
        )

        post_v1_extranets_b2b_consumer_body_policy_item_rules_item.additional_properties = d
        return post_v1_extranets_b2b_consumer_body_policy_item_rules_item
