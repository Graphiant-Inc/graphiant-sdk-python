...
if TYPE_CHECKING:
    from ..models.get_v1_users_id_enterprises_response_200_enterprises_item_counts import (
        GetV1UsersIdEnterprisesResponse200EnterprisesItemCounts,
    )
    from ..models.get_v1_users_id_enterprises_response_200_enterprises_item_customers_item import (
        GetV1UsersIdEnterprisesResponse200EnterprisesItemCustomersItem,
    )
    from ..models.get_v1_users_id_enterprises_response_200_enterprises_item_eula_agreement_date import (
        GetV1UsersIdEnterprisesResponse200EnterprisesItemEulaAgreementDate,
    )


T = TypeVar("T", bound="GetV1UsersIdEnterprisesResponse200EnterprisesItem")


@_attrs_define
class GetV1UsersIdEnterprisesResponse200EnterprisesItem:
    """
    Attributes:
        ...
        counts (Union[Unset, GetV1UsersIdEnterprisesResponse200EnterprisesItemCounts]):
        customers (Union[Unset, list['GetV1UsersIdEnterprisesResponse200EnterprisesItemCustomersItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        eula_agreement_date (Union[Unset, GetV1UsersIdEnterprisesResponse200EnterprisesItemEulaAgreementDate]):
    ...
    counts: Union[Unset, "GetV1UsersIdEnterprisesResponse200EnterprisesItemCounts"] = UNSET
    customers: Union[Unset, list["GetV1UsersIdEnterprisesResponse200EnterprisesItemCustomersItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    eula_agreement_date: Union[Unset, "GetV1UsersIdEnterprisesResponse200EnterprisesItemEulaAgreementDate"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_counts, Unset):
            ...
            counts = GetV1UsersIdEnterprisesResponse200EnterprisesItemCounts.from_dict(_counts)

        customers = []
        _customers = d.pop("customers", UNSET)
        for customers_item_data in _customers or []:
            customers_item = GetV1UsersIdEnterprisesResponse200EnterprisesItemCustomersItem.from_dict(
                customers_item_data
            )
        ...
        if isinstance(_eula_agreement_date, Unset):
            ...
            eula_agreement_date = GetV1UsersIdEnterprisesResponse200EnterprisesItemEulaAgreementDate.from_dict(
        ...
        get_v1_users_id_enterprises_response_200_enterprises_item = cls(
        ...
        get_v1_users_id_enterprises_response_200_enterprises_item.additional_properties = d
        return get_v1_users_id_enterprises_response_200_enterprises_item
