...
T = TypeVar("T", bound="PostV2MonitoringTwampBodySelectorsItem")


@_attrs_define
class PostV2MonitoringTwampBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_twamp_body_selectors_item = cls(
        ...
        post_v2_monitoring_twamp_body_selectors_item.additional_properties = d
        return post_v2_monitoring_twamp_body_selectors_item
