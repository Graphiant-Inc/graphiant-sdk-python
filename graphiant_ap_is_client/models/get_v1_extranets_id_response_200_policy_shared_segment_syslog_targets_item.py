...
T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_response_200_policy_shared_segment_syslog_targets_item = cls(
        ...
        get_v1_extranets_id_response_200_policy_shared_segment_syslog_targets_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_shared_segment_syslog_targets_item
