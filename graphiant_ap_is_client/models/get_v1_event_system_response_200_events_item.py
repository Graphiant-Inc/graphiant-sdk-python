...
if TYPE_CHECKING:
    from ..models.get_v1_event_system_response_200_events_item_event_time import (
        GetV1EventSystemResponse200EventsItemEventTime,
    )


T = TypeVar("T", bound="GetV1EventSystemResponse200EventsItem")


@_attrs_define
class GetV1EventSystemResponse200EventsItem:
    """
    Attributes:
        ...
        event_time (Union[Unset, GetV1EventSystemResponse200EventsItemEventTime]):
    ...
    event_time: Union[Unset, "GetV1EventSystemResponse200EventsItemEventTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_event_time, Unset):
            ...
            event_time = GetV1EventSystemResponse200EventsItemEventTime.from_dict(_event_time)
        ...
        get_v1_event_system_response_200_events_item = cls(
            actions=actions,
            device_id=device_id,
        ...
        get_v1_event_system_response_200_events_item.additional_properties = d
        return get_v1_event_system_response_200_events_item
