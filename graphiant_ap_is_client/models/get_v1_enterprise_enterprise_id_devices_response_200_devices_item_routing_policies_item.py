...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_routing_policies_item_statements_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemRoutingPoliciesItemStatementsItem.from_dict(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_routing_policies_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_routing_policies_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_routing_policies_item
