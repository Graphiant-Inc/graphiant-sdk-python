...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item_bfd import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item_bgp_neighbors_item
