...
T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceLocation")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_location = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_location.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_location
