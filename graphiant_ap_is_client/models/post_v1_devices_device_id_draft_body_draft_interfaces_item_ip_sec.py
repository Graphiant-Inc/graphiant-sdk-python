...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_ip_sec_established_time import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec:
    """
    Attributes:
        ...
        established_time (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSecEstablishedTime]):
    ...
    established_time: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSecEstablishedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSecEstablishedTime.from_dict(
                _established_time
            )
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item_ip_sec = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item_ip_sec.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_interfaces_item_ip_sec
