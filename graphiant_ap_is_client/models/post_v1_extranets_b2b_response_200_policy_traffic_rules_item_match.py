...
T = TypeVar("T", bound="PostV1ExtranetsB2BResponse200PolicyTrafficRulesItemMatch")


@_attrs_define
class PostV1ExtranetsB2BResponse200PolicyTrafficRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_response_200_policy_traffic_rules_item_match = cls(
        ...
        post_v1_extranets_b2b_response_200_policy_traffic_rules_item_match.additional_properties = d
        return post_v1_extranets_b2b_response_200_policy_traffic_rules_item_match
