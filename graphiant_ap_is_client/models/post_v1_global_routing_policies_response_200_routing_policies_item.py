...
if TYPE_CHECKING:
    from ..models.post_v1_global_routing_policies_response_200_routing_policies_item_statements_item import (
        PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItem")


@_attrs_define
class PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset, list['PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[Unset, list["PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItem.from_dict(
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item = cls(
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item.additional_properties = d
        return post_v1_global_routing_policies_response_200_routing_policies_item
