...
T = TypeVar("T", bound="PostV1AppsCountBodyTimeWindowRecentTs")


@_attrs_define
class PostV1AppsCountBodyTimeWindowRecentTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_apps_count_body_time_window_recent_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_apps_count_body_time_window_recent_ts.additional_properties = d
        return post_v1_apps_count_body_time_window_recent_ts
