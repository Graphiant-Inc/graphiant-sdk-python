...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item_leases_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item_nameservers import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item
