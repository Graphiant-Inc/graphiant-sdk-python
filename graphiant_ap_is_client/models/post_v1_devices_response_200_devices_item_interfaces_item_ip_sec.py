...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_ip_sec_established_time import (
        PostV1DevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemInterfacesItemIpSec")


@_attrs_define
class PostV1DevicesResponse200DevicesItemInterfacesItemIpSec:
    """
    Attributes:
        ...
        established_time (Union[Unset, PostV1DevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime]):
    ...
    established_time: Union[Unset, "PostV1DevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = PostV1DevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime.from_dict(
                _established_time
            )
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_ip_sec = cls(
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_ip_sec.additional_properties = d
        return post_v1_devices_response_200_devices_item_interfaces_item_ip_sec
