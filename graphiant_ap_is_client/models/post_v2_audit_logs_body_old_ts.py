...
T = TypeVar("T", bound="PostV2AuditLogsBodyOldTs")


@_attrs_define
class PostV2AuditLogsBodyOldTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_audit_logs_body_old_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v2_audit_logs_body_old_ts.additional_properties = d
        return post_v2_audit_logs_body_old_ts
