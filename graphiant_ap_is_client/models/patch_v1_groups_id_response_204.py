...
T = TypeVar("T", bound="PatchV1GroupsIdResponse204")


@_attrs_define
class PatchV1GroupsIdResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        patch_v1_groups_id_response_204 = cls(
            affected_users=affected_users,
            enterprise_group=enterprise_group,
        )

        patch_v1_groups_id_response_204.additional_properties = d
        return patch_v1_groups_id_response_204
