...
T = TypeVar("T", bound="PostV1SitesResponse200SiteCreatedAt")


@_attrs_define
class PostV1SitesResponse200SiteCreatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_sites_response_200_site_created_at = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_sites_response_200_site_created_at.additional_properties = d
        return post_v1_sites_response_200_site_created_at
