...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicyTargetSegmentsItemBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_target_segments_item_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        put_v1_extranets_id_response_200_policy_target_segments_item_bgp_redistributions.additional_properties = d
        return put_v1_extranets_id_response_200_policy_target_segments_item_bgp_redistributions
