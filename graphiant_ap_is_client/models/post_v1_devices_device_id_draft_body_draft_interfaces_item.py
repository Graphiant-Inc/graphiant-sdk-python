...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_config_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemConfigUpdatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_ip_sec import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_ipv_4 import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv4,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_ipv_6 import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_ipv_6_addresses_item import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6AddressesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_oper_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemOperUpdatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_sfp_optical_strength_item import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSfpOpticalStrengthItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item_subinterfaces_item import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem:
    """
    Attributes:
        ...
        config_updated_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemConfigUpdatedAt]):
        ...
        ip_sec (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec]):
        ipv4 (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv4]):
        ipv6 (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemOperUpdatedAt]):
        ...
        sfp_optical_strength (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSfpOpticalStrengthItem']]):
        speed_mbps (Union[Unset, str]):  Example: TYPE_UINT32.
        subinterfaces (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem']]):
    ...
    config_updated_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemConfigUpdatedAt"] = UNSET
    ...
    ip_sec: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec"] = UNSET
    ipv4: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6AddressesItem"]] = UNSET
    lan: Union[Unset, str] = UNSET
    lldp_enabled: Union[Unset, str] = UNSET
    max_transmission_unit: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    oper_updated_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemOperUpdatedAt"] = UNSET
    phy_address: Union[Unset, str] = UNSET
    security_zone: Union[Unset, str] = UNSET
    sfp_optical_strength: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSfpOpticalStrengthItem"]
    ] = UNSET
    speed_mbps: Union[Unset, str] = UNSET
    subinterfaces: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemConfigUpdatedAt.from_dict(
                _config_updated_at
            )
        ...
        if isinstance(_ip_sec, Unset):
            ...
            ip_sec = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpSec.from_dict(_ip_sec)
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemOperUpdatedAt.from_dict(_oper_updated_at)
        ...
        for sfp_optical_strength_item_data in _sfp_optical_strength or []:
            sfp_optical_strength_item = (
                PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSfpOpticalStrengthItem.from_dict(
        ...
        for subinterfaces_item_data in _subinterfaces or []:
            subinterfaces_item = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItemSubinterfacesItem.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        post_v1_devices_device_id_draft_body_draft_interfaces_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_interfaces_item
