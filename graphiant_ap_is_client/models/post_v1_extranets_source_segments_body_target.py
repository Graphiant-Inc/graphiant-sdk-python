...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_source_segments_body_target_prefix_set import (
        PostV1ExtranetsSourceSegmentsBodyTargetPrefixSet,
    )


T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsBodyTarget")


@_attrs_define
class PostV1ExtranetsSourceSegmentsBodyTarget:
    """
    Attributes:
        excluded_devices (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
        prefix_set (Union[Unset, PostV1ExtranetsSourceSegmentsBodyTargetPrefixSet]):
        sites (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
    """

    excluded_devices: Union[Unset, list[str]] = UNSET
    prefix_set: Union[Unset, "PostV1ExtranetsSourceSegmentsBodyTargetPrefixSet"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_prefix_set, Unset):
            ...
            prefix_set = PostV1ExtranetsSourceSegmentsBodyTargetPrefixSet.from_dict(_prefix_set)

        sites = cast(list[str], d.pop("sites", UNSET))

        post_v1_extranets_source_segments_body_target = cls(
            excluded_devices=excluded_devices,
            prefix_set=prefix_set,
            sites=sites,
        )

        post_v1_extranets_source_segments_body_target.additional_properties = d
        return post_v1_extranets_source_segments_body_target
