...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item_config_updated_at import (
        PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_4 import (
        PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6 import (
        PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item_oper_updated_at import (
        PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv4 (Union[Unset, PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4]):
        ipv6 (Union[Unset, PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt]):
    ...
    config_updated_at: Union[
        Unset, "PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    duplex: Union[Unset, str] = UNSET
    enabled: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipv4: Union[Unset, "PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = (
                PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = PostV1DevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_interfaces_item_subinterfaces_item
