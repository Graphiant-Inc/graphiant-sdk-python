...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item_bfd import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor"
    ] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                    _bfd_neighbor
                )
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_segments_item_bgp_neighbors_item
