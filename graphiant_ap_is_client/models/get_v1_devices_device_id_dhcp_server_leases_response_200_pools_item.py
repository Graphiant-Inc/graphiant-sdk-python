...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item_leases_item import (
        GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemLeasesItem,
    )
    from ..models.get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item_nameservers import (
        GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemNameservers,
    )
    from ..models.get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item_ranges_item import (
        GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemRangesItem,
    )
    from ..models.get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item_static_leases_item import (
        GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItem")


@_attrs_define
class GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemNameservers]):
        ranges (Union[Unset, list['GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemRangesItem']]):
        static_leases (Union[Unset, list['GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemRangesItem"]] = UNSET
    static_leases: Union[Unset, list["GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemStaticLeasesItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemLeasesItem.from_dict(leases_item_data)
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemNameservers.from_dict(_nameservers)

        ranges = []
        _ranges = d.pop("ranges", UNSET)
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemRangesItem.from_dict(ranges_item_data)
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = GetV1DevicesDeviceIdDhcpServerLeasesResponse200PoolsItemStaticLeasesItem.from_dict(
        ...
        get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item = cls(
        ...
        get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item.additional_properties = d
        return get_v1_devices_device_id_dhcp_server_leases_response_200_pools_item
