...
if TYPE_CHECKING:
    from ..models.post_v1_sites_site_id_body_site_global_prefix_set_ops_item import (
        PostV1SitesSiteIdBodySiteGlobalPrefixSetOpsItem,
    )
    from ..models.post_v1_sites_site_id_body_site_ipfix_exporter_ops_item import (
        PostV1SitesSiteIdBodySiteIpfixExporterOpsItem,
    )
    from ..models.post_v1_sites_site_id_body_site_ipfix_exporter_ops_v2_item import (
        PostV1SitesSiteIdBodySiteIpfixExporterOpsV2Item,
    )
    from ..models.post_v1_sites_site_id_body_site_location import PostV1SitesSiteIdBodySiteLocation
    from ..models.post_v1_sites_site_id_body_site_prefix_set_ops_item import PostV1SitesSiteIdBodySitePrefixSetOpsItem
    from ..models.post_v1_sites_site_id_body_site_route_tag import PostV1SitesSiteIdBodySiteRouteTag
    from ..models.post_v1_sites_site_id_body_site_routing_policy_ops_item import (
        PostV1SitesSiteIdBodySiteRoutingPolicyOpsItem,
    )
    from ..models.post_v1_sites_site_id_body_site_snmp_ops_item import PostV1SitesSiteIdBodySiteSnmpOpsItem
    from ..models.post_v1_sites_site_id_body_site_syslog_server_ops_item import (
        PostV1SitesSiteIdBodySiteSyslogServerOpsItem,
    )
    from ..models.post_v1_sites_site_id_body_site_syslog_server_ops_v2_item import (
        PostV1SitesSiteIdBodySiteSyslogServerOpsV2Item,
    )
    from ..models.post_v1_sites_site_id_body_site_traffic_policy_ops_item import (
        PostV1SitesSiteIdBodySiteTrafficPolicyOpsItem,
    )


T = TypeVar("T", bound="PostV1SitesSiteIdBodySite")


@_attrs_define
class PostV1SitesSiteIdBodySite:
    """
    Attributes:
        global_prefix_set_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteGlobalPrefixSetOpsItem']]):
        ipfix_exporter_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteIpfixExporterOpsItem']]):
        ipfix_exporter_ops_v2 (Union[Unset, list['PostV1SitesSiteIdBodySiteIpfixExporterOpsV2Item']]):
        location (Union[Unset, PostV1SitesSiteIdBodySiteLocation]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        notes (Union[Unset, str]):  Example: TYPE_STRING.
        prefix_set_ops (Union[Unset, list['PostV1SitesSiteIdBodySitePrefixSetOpsItem']]):
        route_tag (Union[Unset, PostV1SitesSiteIdBodySiteRouteTag]):
        routing_policy_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteRoutingPolicyOpsItem']]):
        snmp_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteSnmpOpsItem']]):
        syslog_server_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteSyslogServerOpsItem']]):
        syslog_server_ops_v2 (Union[Unset, list['PostV1SitesSiteIdBodySiteSyslogServerOpsV2Item']]):
        traffic_policy_ops (Union[Unset, list['PostV1SitesSiteIdBodySiteTrafficPolicyOpsItem']]):
    """

    global_prefix_set_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteGlobalPrefixSetOpsItem"]] = UNSET
    ipfix_exporter_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteIpfixExporterOpsItem"]] = UNSET
    ipfix_exporter_ops_v2: Union[Unset, list["PostV1SitesSiteIdBodySiteIpfixExporterOpsV2Item"]] = UNSET
    location: Union[Unset, "PostV1SitesSiteIdBodySiteLocation"] = UNSET
    name: Union[Unset, str] = UNSET
    notes: Union[Unset, str] = UNSET
    prefix_set_ops: Union[Unset, list["PostV1SitesSiteIdBodySitePrefixSetOpsItem"]] = UNSET
    route_tag: Union[Unset, "PostV1SitesSiteIdBodySiteRouteTag"] = UNSET
    routing_policy_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteRoutingPolicyOpsItem"]] = UNSET
    snmp_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteSnmpOpsItem"]] = UNSET
    syslog_server_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteSyslogServerOpsItem"]] = UNSET
    syslog_server_ops_v2: Union[Unset, list["PostV1SitesSiteIdBodySiteSyslogServerOpsV2Item"]] = UNSET
    traffic_policy_ops: Union[Unset, list["PostV1SitesSiteIdBodySiteTrafficPolicyOpsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        from ..models.post_v1_sites_site_id_body_site_location import PostV1SitesSiteIdBodySiteLocation
        from ..models.post_v1_sites_site_id_body_site_prefix_set_ops_item import (
        ...
        for global_prefix_set_ops_item_data in _global_prefix_set_ops or []:
            global_prefix_set_ops_item = PostV1SitesSiteIdBodySiteGlobalPrefixSetOpsItem.from_dict(
        ...
        for ipfix_exporter_ops_item_data in _ipfix_exporter_ops or []:
            ipfix_exporter_ops_item = PostV1SitesSiteIdBodySiteIpfixExporterOpsItem.from_dict(
        ...
        for ipfix_exporter_ops_v2_item_data in _ipfix_exporter_ops_v2 or []:
            ipfix_exporter_ops_v2_item = PostV1SitesSiteIdBodySiteIpfixExporterOpsV2Item.from_dict(
        ...
        if isinstance(_location, Unset):
            ...
            location = PostV1SitesSiteIdBodySiteLocation.from_dict(_location)
        ...
        for prefix_set_ops_item_data in _prefix_set_ops or []:
            prefix_set_ops_item = PostV1SitesSiteIdBodySitePrefixSetOpsItem.from_dict(prefix_set_ops_item_data)
        ...
        if isinstance(_route_tag, Unset):
            ...
            route_tag = PostV1SitesSiteIdBodySiteRouteTag.from_dict(_route_tag)

        routing_policy_ops = []
        _routing_policy_ops = d.pop("routingPolicyOps", UNSET)
        for routing_policy_ops_item_data in _routing_policy_ops or []:
            routing_policy_ops_item = PostV1SitesSiteIdBodySiteRoutingPolicyOpsItem.from_dict(
        ...
        for snmp_ops_item_data in _snmp_ops or []:
            snmp_ops_item = PostV1SitesSiteIdBodySiteSnmpOpsItem.from_dict(snmp_ops_item_data)
        ...
        for syslog_server_ops_item_data in _syslog_server_ops or []:
            syslog_server_ops_item = PostV1SitesSiteIdBodySiteSyslogServerOpsItem.from_dict(syslog_server_ops_item_data)
        ...
        for syslog_server_ops_v2_item_data in _syslog_server_ops_v2 or []:
            syslog_server_ops_v2_item = PostV1SitesSiteIdBodySiteSyslogServerOpsV2Item.from_dict(
        ...
        for traffic_policy_ops_item_data in _traffic_policy_ops or []:
            traffic_policy_ops_item = PostV1SitesSiteIdBodySiteTrafficPolicyOpsItem.from_dict(
                traffic_policy_ops_item_data
            )

            traffic_policy_ops.append(traffic_policy_ops_item)

        post_v1_sites_site_id_body_site = cls(
        ...
        post_v1_sites_site_id_body_site.additional_properties = d
        return post_v1_sites_site_id_body_site
