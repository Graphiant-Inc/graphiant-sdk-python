...
if TYPE_CHECKING:
    from ..models.get_v1_global_routing_policies_site_response_200_routing_policies_item_statements_item import (
        GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItem")


@_attrs_define
class GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset, list['GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[Unset, list["GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItem.from_dict(
        ...
        get_v1_global_routing_policies_site_response_200_routing_policies_item = cls(
        ...
        get_v1_global_routing_policies_site_response_200_routing_policies_item.additional_properties = d
        return get_v1_global_routing_policies_site_response_200_routing_policies_item
