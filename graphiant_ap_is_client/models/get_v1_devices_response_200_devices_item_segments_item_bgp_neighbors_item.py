...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item_bfd import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item
