...
T = TypeVar("T", bound="DeleteV1GroupsIdMembersMemberIdResponse204")


@_attrs_define
class DeleteV1GroupsIdMembersMemberIdResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        delete_v1_groups_id_members_member_id_response_204 = cls(
            affected_users=affected_users,
            enterprise_group=enterprise_group,
        )

        delete_v1_groups_id_members_member_id_response_204.additional_properties = d
        return delete_v1_groups_id_members_member_id_response_204
