...
T = TypeVar("T", bound="PutV1GatewaysBodyDetailsOci")


@_attrs_define
class PutV1GatewaysBodyDetailsOci:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_gateways_body_details_oci = cls(
            description=description,
            fast_connect_ocid=fast_connect_ocid,
            routing_policy=routing_policy,
        )

        put_v1_gateways_body_details_oci.additional_properties = d
        return put_v1_gateways_body_details_oci
