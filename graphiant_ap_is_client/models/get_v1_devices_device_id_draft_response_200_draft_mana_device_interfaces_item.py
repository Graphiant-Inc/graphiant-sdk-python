...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_config_updated_at import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_ip_sec import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpSec,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_ipv_4 import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv4,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_ipv_6 import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_ipv_6_addresses_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_oper_updated_at import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemOperUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_sfp_optical_strength_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSfpOpticalStrengthItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item_subinterfaces_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSubinterfacesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItem:
    """
    Attributes:
        ...
        ip_sec (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpSec]):
        ipv4 (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemOperUpdatedAt]):
        ...
        sfp_optical_strength (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSfpOpticalStrengthItem']]):
        speed_mbps (Union[Unset, str]):  Example: TYPE_UINT32.
        subinterfaces (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSubinterfacesItem']]):
    ...
    config_updated_at: Union[
        Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemConfigUpdatedAt"
    ] = UNSET
    ...
    ip_sec: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpSec"] = UNSET
    ipv4: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    sfp_optical_strength: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSfpOpticalStrengthItem"]
    ] = UNSET
    speed_mbps: Union[Unset, str] = UNSET
    subinterfaces: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSubinterfacesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ip_sec, Unset):
            ...
            ip_sec = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpSec.from_dict(_ip_sec)
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        for sfp_optical_strength_item_data in _sfp_optical_strength or []:
            sfp_optical_strength_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSfpOpticalStrengthItem.from_dict(
        ...
        for subinterfaces_item_data in _subinterfaces or []:
            subinterfaces_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceInterfacesItemSubinterfacesItem.from_dict(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_interfaces_item
