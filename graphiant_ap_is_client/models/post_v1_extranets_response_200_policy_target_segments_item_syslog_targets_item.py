...
T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicyTargetSegmentsItemSyslogTargetsItem")


@_attrs_define
class PostV1ExtranetsResponse200PolicyTargetSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_response_200_policy_target_segments_item_syslog_targets_item = cls(
        ...
        post_v1_extranets_response_200_policy_target_segments_item_syslog_targets_item.additional_properties = d
        return post_v1_extranets_response_200_policy_target_segments_item_syslog_targets_item
