...
T = TypeVar("T", bound="PostV1GatewaysBodyDetailsAwsAdvanceSettings")


@_attrs_define
class PostV1GatewaysBodyDetailsAwsAdvanceSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_gateways_body_details_aws_advance_settings = cls(
        ...
        post_v1_gateways_body_details_aws_advance_settings.additional_properties = d
        return post_v1_gateways_body_details_aws_advance_settings
