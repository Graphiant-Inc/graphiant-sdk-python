...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_policy_zonepairs_response_200_zone_pairs_item_security_rulesets_item_rules_item_match import (
        GetV1DevicesDeviceIdPolicyZonepairsResponse200ZonePairsItemSecurityRulesetsItemRulesItemMatch,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdPolicyZonepairsResponse200ZonePairsItemSecurityRulesetsItemRulesItem")


@_attrs_define
class GetV1DevicesDeviceIdPolicyZonepairsResponse200ZonePairsItemSecurityRulesetsItemRulesItem:
    """
    Attributes:
    ...
    match: Union[
        Unset, "GetV1DevicesDeviceIdPolicyZonepairsResponse200ZonePairsItemSecurityRulesetsItemRulesItemMatch"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_match, Unset):
            ...
            match = (
                GetV1DevicesDeviceIdPolicyZonepairsResponse200ZonePairsItemSecurityRulesetsItemRulesItemMatch.from_dict(
                    _match
                )
            )
        ...
        get_v1_devices_device_id_policy_zonepairs_response_200_zone_pairs_item_security_rulesets_item_rules_item = cls(
            action=action,
        ...
        get_v1_devices_device_id_policy_zonepairs_response_200_zone_pairs_item_security_rulesets_item_rules_item.additional_properties = d
        return get_v1_devices_device_id_policy_zonepairs_response_200_zone_pairs_item_security_rulesets_item_rules_item
