...
T = TypeVar("T", bound="GetV2AllowlistByEnterpriseResponse200RecordsItem")


@_attrs_define
class GetV2AllowlistByEnterpriseResponse200RecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_allowlist_by_enterprise_response_200_records_item = cls(
        ...
        get_v2_allowlist_by_enterprise_response_200_records_item.additional_properties = d
        return get_v2_allowlist_by_enterprise_response_200_records_item
