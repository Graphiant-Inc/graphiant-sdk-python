...
T = TypeVar("T", bound="GetV2NotificationmutelistRuleIdResponse200RecordsItem")


@_attrs_define
class GetV2NotificationmutelistRuleIdResponse200RecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_notificationmutelist_rule_id_response_200_records_item = cls(
        ...
        get_v2_notificationmutelist_rule_id_response_200_records_item.additional_properties = d
        return get_v2_notificationmutelist_rule_id_response_200_records_item
