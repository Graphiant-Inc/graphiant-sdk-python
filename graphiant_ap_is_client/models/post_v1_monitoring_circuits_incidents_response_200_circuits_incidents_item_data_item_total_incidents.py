...
T = TypeVar("T", bound="PostV1MonitoringCircuitsIncidentsResponse200CircuitsIncidentsItemDataItemTotalIncidents")


@_attrs_define
class PostV1MonitoringCircuitsIncidentsResponse200CircuitsIncidentsItemDataItemTotalIncidents:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_monitoring_circuits_incidents_response_200_circuits_incidents_item_data_item_total_incidents = cls(
            num_fair_incidents=num_fair_incidents,
            num_poor_incidents=num_poor_incidents,
        )

        post_v1_monitoring_circuits_incidents_response_200_circuits_incidents_item_data_item_total_incidents.additional_properties = d
        return post_v1_monitoring_circuits_incidents_response_200_circuits_incidents_item_data_item_total_incidents
