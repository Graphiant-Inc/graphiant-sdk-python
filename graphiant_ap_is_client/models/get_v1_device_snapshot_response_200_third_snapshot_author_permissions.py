...
T = TypeVar("T", bound="GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions")


@_attrs_define
class GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_snapshot_response_200_third_snapshot_author_permissions = cls(
        ...
        get_v1_device_snapshot_response_200_third_snapshot_author_permissions.additional_properties = d
        return get_v1_device_snapshot_response_200_third_snapshot_author_permissions
