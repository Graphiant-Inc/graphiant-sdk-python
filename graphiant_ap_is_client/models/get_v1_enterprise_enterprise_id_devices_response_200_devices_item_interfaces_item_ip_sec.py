...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ip_sec_established_time import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec:
    """
    Attributes:
    ...
    established_time: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSecEstablishedTime.from_dict(
                    _established_time
                )
            )
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ip_sec = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ip_sec.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ip_sec
