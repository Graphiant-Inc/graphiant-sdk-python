...
T = TypeVar("T", bound="PostV1FlowsTopologyBodyTimeWindowOldTs")


@_attrs_define
class PostV1FlowsTopologyBodyTimeWindowOldTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_flows_topology_body_time_window_old_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_flows_topology_body_time_window_old_ts.additional_properties = d
        return post_v1_flows_topology_body_time_window_old_ts
