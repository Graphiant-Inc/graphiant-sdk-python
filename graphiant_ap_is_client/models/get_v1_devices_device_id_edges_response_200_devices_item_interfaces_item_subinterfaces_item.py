...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item_config_updated_at import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_4 import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6 import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item_oper_updated_at import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv4 (Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem']]):
    ...
    config_updated_at: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    duplex: Union[Unset, str] = UNSET
    enabled: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipv4: Union[Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    oper_updated_at: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                    _oper_updated_at
                )
            )
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_interfaces_item_subinterfaces_item
