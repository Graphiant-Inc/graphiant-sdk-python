...
T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemOverlayFilters")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_overlay_filters.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_segments_item_overlay_filters
