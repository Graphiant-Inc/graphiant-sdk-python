...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_aggregations_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpAggregationsItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_multipath import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpMultipath,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_neighbors_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_bgp_redistributions import (
        PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_ipfix_exporters_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentIpfixExportersItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_ospfv_2_process import (
        PostV1ExtranetsResponse200PolicySharedSegmentOspfv2Process,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_ospfv_3_process import (
        PostV1ExtranetsResponse200PolicySharedSegmentOspfv3Process,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_overlay_filters import (
        PostV1ExtranetsResponse200PolicySharedSegmentOverlayFilters,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_static_routes_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentStaticRoutesItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_syslog_targets_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentSyslogTargetsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicySharedSegment")


@_attrs_define
class PostV1ExtranetsResponse200PolicySharedSegment:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentBgpMultipath]):
        bgp_neighbors (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentOspfv2Process]):
        ospfv_3_process (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentOspfv3Process]):
        overlay_filters (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = PostV1ExtranetsResponse200PolicySharedSegmentBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = PostV1ExtranetsResponse200PolicySharedSegmentBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = PostV1ExtranetsResponse200PolicySharedSegmentBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = PostV1ExtranetsResponse200PolicySharedSegmentIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = PostV1ExtranetsResponse200PolicySharedSegmentOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = PostV1ExtranetsResponse200PolicySharedSegmentOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = PostV1ExtranetsResponse200PolicySharedSegmentOverlayFilters.from_dict(_overlay_filters)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = PostV1ExtranetsResponse200PolicySharedSegmentStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = PostV1ExtranetsResponse200PolicySharedSegmentSyslogTargetsItem.from_dict(
        ...
        post_v1_extranets_response_200_policy_shared_segment = cls(
        ...
        post_v1_extranets_response_200_policy_shared_segment.additional_properties = d
        return post_v1_extranets_response_200_policy_shared_segment
