...
T = TypeVar("T", bound="GetV1PortalPrivateDetailsResponse200DetailsItem")


@_attrs_define
class GetV1PortalPrivateDetailsResponse200DetailsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_portal_private_details_response_200_details_item = cls(
            api_key=api_key,
        ...
        get_v1_portal_private_details_response_200_details_item.additional_properties = d
        return get_v1_portal_private_details_response_200_details_item
