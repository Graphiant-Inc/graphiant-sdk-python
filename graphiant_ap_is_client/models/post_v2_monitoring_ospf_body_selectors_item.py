...
T = TypeVar("T", bound="PostV2MonitoringOspfBodySelectorsItem")


@_attrs_define
class PostV2MonitoringOspfBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_ospf_body_selectors_item = cls(
            router_id=router_id,
            type_=type_,
            vrf=vrf,
        )

        post_v2_monitoring_ospf_body_selectors_item.additional_properties = d
        return post_v2_monitoring_ospf_body_selectors_item
