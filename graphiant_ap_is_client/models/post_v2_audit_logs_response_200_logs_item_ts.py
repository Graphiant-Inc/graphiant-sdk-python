...
T = TypeVar("T", bound="PostV2AuditLogsResponse200LogsItemTs")


@_attrs_define
class PostV2AuditLogsResponse200LogsItemTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_audit_logs_response_200_logs_item_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v2_audit_logs_response_200_logs_item_ts.additional_properties = d
        return post_v2_audit_logs_response_200_logs_item_ts
