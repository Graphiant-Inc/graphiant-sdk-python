...
T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemSiteLocation")


@_attrs_define
class PostV1DevicesResponse200DevicesItemSiteLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_response_200_devices_item_site_location = cls(
        ...
        post_v1_devices_response_200_devices_item_site_location.additional_properties = d
        return post_v1_devices_response_200_devices_item_site_location
