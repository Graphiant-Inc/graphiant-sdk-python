...
T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicyDpiApplicationsItem")


@_attrs_define
class GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicyDpiApplicationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_dpi_applications_item = cls(
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_dpi_applications_item.additional_properties = d
        return get_v1_global_traffic_policies_site_response_200_traffic_policy_dpi_applications_item
