...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftLocation")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_location = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_location.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_location
