...
T = TypeVar("T", bound="PostV1GlobalSiteListsBodyEntriesItemTag")


@_attrs_define
class PostV1GlobalSiteListsBodyEntriesItemTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_site_lists_body_entries_item_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        post_v1_global_site_lists_body_entries_item_tag.additional_properties = d
        return post_v1_global_site_lists_body_entries_item_tag
