...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp import (
        GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp,
    )
    from ..models.get_v1_devices_response_200_devices_item_ipsec_tunnels_item_static import (
        GetV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemIpsecTunnelsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, GetV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "GetV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = GetV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        get_v1_devices_response_200_devices_item_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        get_v1_devices_response_200_devices_item_ipsec_tunnels_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_ipsec_tunnels_item
