...
if TYPE_CHECKING:
    from ..models.get_v1_groups_id_response_200_group_permissions import GetV1GroupsIdResponse200GroupPermissions


T = TypeVar("T", bound="GetV1GroupsIdResponse200Group")


@_attrs_define
class GetV1GroupsIdResponse200Group:
    """
    Attributes:
        ...
        permissions (Union[Unset, GetV1GroupsIdResponse200GroupPermissions]):
    ...
    permissions: Union[Unset, "GetV1GroupsIdResponse200GroupPermissions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_permissions, Unset):
            ...
            permissions = GetV1GroupsIdResponse200GroupPermissions.from_dict(_permissions)

        time_window_end = d.pop("timeWindowEnd", UNSET)

        time_window_start = d.pop("timeWindowStart", UNSET)

        get_v1_groups_id_response_200_group = cls(
        ...
        get_v1_groups_id_response_200_group.additional_properties = d
        return get_v1_groups_id_response_200_group
