...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemPrefixSetsItemEntriesItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemPrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_prefix_sets_item_entries_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_prefix_sets_item_entries_item
