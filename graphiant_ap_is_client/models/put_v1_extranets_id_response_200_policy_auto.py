...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicyAuto")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicyAuto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_auto = cls(
            auto_propagate=auto_propagate,
            excluded_prefixes=excluded_prefixes,
        )

        put_v1_extranets_id_response_200_policy_auto.additional_properties = d
        return put_v1_extranets_id_response_200_policy_auto
