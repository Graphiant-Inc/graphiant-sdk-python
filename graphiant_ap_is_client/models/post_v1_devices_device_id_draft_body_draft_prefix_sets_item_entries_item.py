...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItemEntriesItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        post_v1_devices_device_id_draft_body_draft_prefix_sets_item_entries_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_prefix_sets_item_entries_item
