...
T = TypeVar("T", bound="GetV2IntegrationGettypesEnterpriseIdResponse200IntegrationsItemIntegrationsItemDetails")


@_attrs_define
class GetV2IntegrationGettypesEnterpriseIdResponse200IntegrationsItemIntegrationsItemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_integration_gettypes_enterprise_id_response_200_integrations_item_integrations_item_details = cls(
            opsgenie_key=opsgenie_key,
            opsramp_details=opsramp_details,
            webhook_url=webhook_url,
        )

        get_v2_integration_gettypes_enterprise_id_response_200_integrations_item_integrations_item_details.additional_properties = d
        return get_v2_integration_gettypes_enterprise_id_response_200_integrations_item_integrations_item_details
