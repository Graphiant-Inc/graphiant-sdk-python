...
T = TypeVar("T", bound="PostV1DiagnosticTracerouteBodyParams")


@_attrs_define
class PostV1DiagnosticTracerouteBodyParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_diagnostic_traceroute_body_params = cls(
        ...
        post_v1_diagnostic_traceroute_body_params.additional_properties = d
        return post_v1_diagnostic_traceroute_body_params
