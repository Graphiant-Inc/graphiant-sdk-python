...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_bgp_address_families_item import (
        GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgpAddressFamiliesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgpAddressFamiliesItem']]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgpAddressFamiliesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgpAddressFamiliesItem.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_bgp = cls(
        ...
        get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_bgp.additional_properties = d
        return get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_bgp
