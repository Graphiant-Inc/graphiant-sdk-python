...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item_address_families_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item_bfd import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfd,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item_bfd_neighbor import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item = cls(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item
