...
T = TypeVar("T", bound="GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem")


@_attrs_define
class GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_policy_sites_item = cls(
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_policy_sites_item.additional_properties = d
        return get_v1_extranets_b2b_id_producer_response_200_policy_policy_sites_item
