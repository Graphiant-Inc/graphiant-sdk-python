...
T = TypeVar("T", bound="GetV1GlobalSnmpsSiteResponse200SnmpsItemUsmLocalUsersItem")


@_attrs_define
class GetV1GlobalSnmpsSiteResponse200SnmpsItemUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_site_response_200_snmps_item_usm_local_users_item = cls(
        ...
        get_v1_global_snmps_site_response_200_snmps_item_usm_local_users_item.additional_properties = d
        return get_v1_global_snmps_site_response_200_snmps_item_usm_local_users_item
