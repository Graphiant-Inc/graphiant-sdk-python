...
T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicyZoneFirewallsItemIp")


@_attrs_define
class GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicyZoneFirewallsItemIp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_ip = cls(
            block_land_attacks=block_land_attacks,
            session_limit=session_limit,
            urpf=urpf,
        )

        get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_ip.additional_properties = d
        return get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_ip
