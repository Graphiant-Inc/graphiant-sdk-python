...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item_leases_item import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item_nameservers import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    static_leases: Union[
        Unset, list["GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_target_segments_item_dhcp_subnets_item
