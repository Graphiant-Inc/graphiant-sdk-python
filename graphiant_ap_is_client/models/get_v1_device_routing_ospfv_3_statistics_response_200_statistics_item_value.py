...
T = TypeVar("T", bound="GetV1DeviceRoutingOspfv3StatisticsResponse200StatisticsItemValue")


@_attrs_define
class GetV1DeviceRoutingOspfv3StatisticsResponse200StatisticsItemValue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_routing_ospfv_3_statistics_response_200_statistics_item_value = cls(
            discontinuity_time=discontinuity_time,
            route_count=route_count,
        )

        get_v1_device_routing_ospfv_3_statistics_response_200_statistics_item_value.additional_properties = d
        return get_v1_device_routing_ospfv_3_statistics_response_200_statistics_item_value
