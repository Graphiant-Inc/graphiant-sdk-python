...
if TYPE_CHECKING:
    from ..models.get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item_leases_item import (
        GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item_nameservers import (
        GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemStaticLeasesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemLeasesItem.from_dict(leases_item_data)
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemNameservers.from_dict(_nameservers)

        ranges = []
        _ranges = d.pop("ranges", UNSET)
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemRangesItem.from_dict(ranges_item_data)
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item
