...
T = TypeVar("T", bound="GetV1GlobalSnmpsSiteResponse200SnmpsItemTargetsItem")


@_attrs_define
class GetV1GlobalSnmpsSiteResponse200SnmpsItemTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_site_response_200_snmps_item_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        get_v1_global_snmps_site_response_200_snmps_item_targets_item.additional_properties = d
        return get_v1_global_snmps_site_response_200_snmps_item_targets_item
