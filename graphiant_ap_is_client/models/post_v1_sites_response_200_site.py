...
if TYPE_CHECKING:
    from ..models.post_v1_sites_response_200_site_created_at import PostV1SitesResponse200SiteCreatedAt
    from ..models.post_v1_sites_response_200_site_devices_item import PostV1SitesResponse200SiteDevicesItem
    from ..models.post_v1_sites_response_200_site_location import PostV1SitesResponse200SiteLocation
    from ..models.post_v1_sites_response_200_site_policy_tag import PostV1SitesResponse200SitePolicyTag
    from ..models.post_v1_sites_response_200_site_updated_at import PostV1SitesResponse200SiteUpdatedAt


T = TypeVar("T", bound="PostV1SitesResponse200Site")


@_attrs_define
class PostV1SitesResponse200Site:
    """
    Attributes:
        address (Union[Unset, str]):  Example: TYPE_STRING.
        created_at (Union[Unset, PostV1SitesResponse200SiteCreatedAt]):
        devices (Union[Unset, list['PostV1SitesResponse200SiteDevicesItem']]):
        edge_count (Union[Unset, str]):  Example: TYPE_UINT32.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        location (Union[Unset, PostV1SitesResponse200SiteLocation]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        notes (Union[Unset, str]):  Example: TYPE_STRING.
        policy_reference_count (Union[Unset, str]):  Example: TYPE_UINT32.
        policy_tag (Union[Unset, PostV1SitesResponse200SitePolicyTag]):
        ...
        updated_at (Union[Unset, PostV1SitesResponse200SiteUpdatedAt]):
    """

    address: Union[Unset, str] = UNSET
    created_at: Union[Unset, "PostV1SitesResponse200SiteCreatedAt"] = UNSET
    devices: Union[Unset, list["PostV1SitesResponse200SiteDevicesItem"]] = UNSET
    edge_count: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    location: Union[Unset, "PostV1SitesResponse200SiteLocation"] = UNSET
    name: Union[Unset, str] = UNSET
    notes: Union[Unset, str] = UNSET
    policy_reference_count: Union[Unset, str] = UNSET
    policy_tag: Union[Unset, "PostV1SitesResponse200SitePolicyTag"] = UNSET
    segment_count: Union[Unset, str] = UNSET
    site_list_reference_count: Union[Unset, str] = UNSET
    tags: Union[Unset, list[str]] = UNSET
    updated_at: Union[Unset, "PostV1SitesResponse200SiteUpdatedAt"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_created_at, Unset):
            ...
            created_at = PostV1SitesResponse200SiteCreatedAt.from_dict(_created_at)

        devices = []
        _devices = d.pop("devices", UNSET)
        for devices_item_data in _devices or []:
            devices_item = PostV1SitesResponse200SiteDevicesItem.from_dict(devices_item_data)
        ...
        if isinstance(_location, Unset):
            ...
            location = PostV1SitesResponse200SiteLocation.from_dict(_location)
        ...
        if isinstance(_policy_tag, Unset):
            ...
            policy_tag = PostV1SitesResponse200SitePolicyTag.from_dict(_policy_tag)
        ...
        if isinstance(_updated_at, Unset):
            ...
            updated_at = PostV1SitesResponse200SiteUpdatedAt.from_dict(_updated_at)

        post_v1_sites_response_200_site = cls(
            address=address,
        ...
        post_v1_sites_response_200_site.additional_properties = d
        return post_v1_sites_response_200_site
