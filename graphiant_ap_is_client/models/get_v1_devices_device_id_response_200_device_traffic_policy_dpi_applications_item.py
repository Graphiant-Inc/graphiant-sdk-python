...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceTrafficPolicyDpiApplicationsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceTrafficPolicyDpiApplicationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_traffic_policy_dpi_applications_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_traffic_policy_dpi_applications_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_traffic_policy_dpi_applications_item
