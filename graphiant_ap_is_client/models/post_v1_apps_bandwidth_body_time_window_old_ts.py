...
T = TypeVar("T", bound="PostV1AppsBandwidthBodyTimeWindowOldTs")


@_attrs_define
class PostV1AppsBandwidthBodyTimeWindowOldTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_apps_bandwidth_body_time_window_old_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_apps_bandwidth_body_time_window_old_ts.additional_properties = d
        return post_v1_apps_bandwidth_body_time_window_old_ts
