...
T = TypeVar("T", bound="GetV1ExtranetsB2BConsumerIdResponse200SiteInformationItem")


@_attrs_define
class GetV1ExtranetsB2BConsumerIdResponse200SiteInformationItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_consumer_id_response_200_site_information_item = cls(
        ...
        get_v1_extranets_b2b_consumer_id_response_200_site_information_item.additional_properties = d
        return get_v1_extranets_b2b_consumer_id_response_200_site_information_item
