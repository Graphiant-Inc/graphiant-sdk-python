...
if TYPE_CHECKING:
    from ..models.get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item_asexternal_lsa import (
        GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemAsexternalLsa,
    )
    from ..models.get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item_network_lsa import (
        GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemNetworkLsa,
    )
    from ..models.get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item_router_lsa import (
        GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemRouterLsa,
    )
    from ..models.get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item_summary_lsa import (
        GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemSummaryLsa,
    )


T = TypeVar("T", bound="GetV1DeviceRoutingOspfv3LsdbResponse200LsasItem")


@_attrs_define
class GetV1DeviceRoutingOspfv3LsdbResponse200LsasItem:
    """
    Attributes:
        advertising_router (Union[Unset, str]):  Example: 172.121.12.34.
        age (Union[Unset, str]):  Example: 3242342.
        asexternal_lsa (Union[Unset, GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemAsexternalLsa]):
        checksum (Union[Unset, str]):  Example: 2343232.
        length (Union[Unset, str]):  Example: 123132.
        link_id (Union[Unset, str]):  Example: 143.12.1.5.
        network_lsa (Union[Unset, GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemNetworkLsa]):
        router_lsa (Union[Unset, GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemRouterLsa]):
        sequence_number (Union[Unset, str]):  Example: 2147483649.
        summary_lsa (Union[Unset, GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemSummaryLsa]):
        type_ (Union[Unset, str]):  Example: Router.
    """

    advertising_router: Union[Unset, str] = UNSET
    age: Union[Unset, str] = UNSET
    asexternal_lsa: Union[Unset, "GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemAsexternalLsa"] = UNSET
    checksum: Union[Unset, str] = UNSET
    length: Union[Unset, str] = UNSET
    link_id: Union[Unset, str] = UNSET
    network_lsa: Union[Unset, "GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemNetworkLsa"] = UNSET
    router_lsa: Union[Unset, "GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemRouterLsa"] = UNSET
    sequence_number: Union[Unset, str] = UNSET
    summary_lsa: Union[Unset, "GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemSummaryLsa"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_asexternal_lsa, Unset):
            ...
            asexternal_lsa = GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemAsexternalLsa.from_dict(_asexternal_lsa)
        ...
        if isinstance(_network_lsa, Unset):
            ...
            network_lsa = GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemNetworkLsa.from_dict(_network_lsa)
        ...
        if isinstance(_router_lsa, Unset):
            ...
            router_lsa = GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemRouterLsa.from_dict(_router_lsa)
        ...
        if isinstance(_summary_lsa, Unset):
            ...
            summary_lsa = GetV1DeviceRoutingOspfv3LsdbResponse200LsasItemSummaryLsa.from_dict(_summary_lsa)

        type_ = d.pop("type", UNSET)

        get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item = cls(
        ...
        get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item.additional_properties = d
        return get_v1_device_routing_ospfv_3_lsdb_response_200_lsas_item
