...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_targets_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_snmp_targets_item
