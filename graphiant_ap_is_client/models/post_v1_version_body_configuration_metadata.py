...
T = TypeVar("T", bound="PostV1VersionBodyConfigurationMetadata")


@_attrs_define
class PostV1VersionBodyConfigurationMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_version_body_configuration_metadata = cls(
            commit_confirm=commit_confirm,
            description=description,
            name=name,
        )

        post_v1_version_body_configuration_metadata.additional_properties = d
        return post_v1_version_body_configuration_metadata
