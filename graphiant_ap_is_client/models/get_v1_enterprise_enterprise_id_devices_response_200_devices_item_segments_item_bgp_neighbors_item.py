...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item_bfd import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset, list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeig
            hborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd]):
    ...
    address_families: Union[
        Unset,
        list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem"],
    ] = UNSET
    bfd: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd.from_dict(
                _bfd
            )
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_segments_item_bgp_neighbors_item
