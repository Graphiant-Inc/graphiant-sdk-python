...
T = TypeVar("T", bound="PutV1GatewaysBodyDetailsIpsecGatewayTunnel2")


@_attrs_define
class PutV1GatewaysBodyDetailsIpsecGatewayTunnel2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_gateways_body_details_ipsec_gateway_tunnel_2 = cls(
        ...
        put_v1_gateways_body_details_ipsec_gateway_tunnel_2.additional_properties = d
        return put_v1_gateways_body_details_ipsec_gateway_tunnel_2
