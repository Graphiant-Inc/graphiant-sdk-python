...
T = TypeVar("T", bound="PostV1ExtranetsB2BIdCustomerBodyInvitesItem")


@_attrs_define
class PostV1ExtranetsB2BIdCustomerBodyInvitesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_id_customer_body_invites_item = cls(
        ...
        post_v1_extranets_b2b_id_customer_body_invites_item.additional_properties = d
        return post_v1_extranets_b2b_id_customer_body_invites_item
