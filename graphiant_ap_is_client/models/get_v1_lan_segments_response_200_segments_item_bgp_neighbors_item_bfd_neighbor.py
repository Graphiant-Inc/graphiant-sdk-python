...
if TYPE_CHECKING:
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor_last_updated import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborLastUpdated,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor_time_in_state import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborTimeInState,
    )


T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor:
    """
    Attributes:
        ...
        last_updated (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborLastUpdated]):
        ...
        time_in_state (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborTimeInState]):
    ...
    last_updated: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborLastUpdated"] = UNSET
    ...
    time_in_state: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborTimeInState"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_last_updated, Unset):
            ...
            last_updated = GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborLastUpdated.from_dict(
                _last_updated
            )
        ...
        if isinstance(_time_in_state, Unset):
            ...
            time_in_state = GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighborTimeInState.from_dict(
                _time_in_state
            )

        up = d.pop("up", UNSET)

        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor
