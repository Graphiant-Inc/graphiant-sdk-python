...
T = TypeVar("T", bound="PostV2MonitoringCircuitsVisualizationResponse200DataItemSelector")


@_attrs_define
class PostV2MonitoringCircuitsVisualizationResponse200DataItemSelector:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_circuits_visualization_response_200_data_item_selector = cls(
            circuit_name=circuit_name,
            core_location=core_location,
            type_=type_,
        )

        post_v2_monitoring_circuits_visualization_response_200_data_item_selector.additional_properties = d
        return post_v2_monitoring_circuits_visualization_response_200_data_item_selector
