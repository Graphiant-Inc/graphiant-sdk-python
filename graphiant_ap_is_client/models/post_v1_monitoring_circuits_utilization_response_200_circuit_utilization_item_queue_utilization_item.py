...
T = TypeVar("T", bound="PostV1MonitoringCircuitsUtilizationResponse200CircuitUtilizationItemQueueUtilizationItem")


@_attrs_define
class PostV1MonitoringCircuitsUtilizationResponse200CircuitUtilizationItemQueueUtilizationItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_monitoring_circuits_utilization_response_200_circuit_utilization_item_queue_utilization_item = cls(
        ...
        post_v1_monitoring_circuits_utilization_response_200_circuit_utilization_item_queue_utilization_item.additional_properties = d
        return post_v1_monitoring_circuits_utilization_response_200_circuit_utilization_item_queue_utilization_item
