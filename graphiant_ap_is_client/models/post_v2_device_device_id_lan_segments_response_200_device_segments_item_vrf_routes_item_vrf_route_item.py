...
T = TypeVar("T", bound="PostV2DeviceDeviceIdLanSegmentsResponse200DeviceSegmentsItemVrfRoutesItemVrfRouteItem")


@_attrs_define
class PostV2DeviceDeviceIdLanSegmentsResponse200DeviceSegmentsItemVrfRoutesItemVrfRouteItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_device_device_id_lan_segments_response_200_device_segments_item_vrf_routes_item_vrf_route_item = cls(
        ...
        post_v2_device_device_id_lan_segments_response_200_device_segments_item_vrf_routes_item_vrf_route_item.additional_properties = d
        return post_v2_device_device_id_lan_segments_response_200_device_segments_item_vrf_routes_item_vrf_route_item
