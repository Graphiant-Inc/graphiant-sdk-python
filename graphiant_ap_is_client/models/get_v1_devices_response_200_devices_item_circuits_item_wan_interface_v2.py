...
T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemCircuitsItemWanInterfaceV2")


@_attrs_define
class GetV1DevicesResponse200DevicesItemCircuitsItemWanInterfaceV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_response_200_devices_item_circuits_item_wan_interface_v2 = cls(
        ...
        get_v1_devices_response_200_devices_item_circuits_item_wan_interface_v2.additional_properties = d
        return get_v1_devices_response_200_devices_item_circuits_item_wan_interface_v2
