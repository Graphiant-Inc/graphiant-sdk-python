...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_ospfv_3_process_areas_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessAreasItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_ospfv_3_process_redistributed_protocols_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessRedistributedProtocolsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3Process")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3Process:
    """
    Attributes:
        admin_distance (Union[Unset, str]):  Example: 100.
        areas (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessAreasItem']]):
    ...
    areas: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessAreasItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for areas_item_data in _areas or []:
            areas_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessAreasItem.from_dict(
                    areas_item_data
                )
            )
        ...
        for redistributed_protocols_item_data in _redistributed_protocols or []:
            redistributed_protocols_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOspfv3ProcessRedistributedProtocolsItem.from_dict(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_ospfv_3_process = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_ospfv_3_process.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_ospfv_3_process
