...
T = TypeVar("T", bound="PostV1DevicesBringupBody")


@_attrs_define
class PostV1DevicesBringupBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_bringup_body = cls(
            device_ids=device_ids,
        )

        post_v1_devices_bringup_body.additional_properties = d
        return post_v1_devices_bringup_body
