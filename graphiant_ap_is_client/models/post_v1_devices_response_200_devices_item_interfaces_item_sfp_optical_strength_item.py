...
T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item = cls(
            index=index,
            rx_power=rx_power,
            tx_bias=tx_bias,
            tx_power=tx_power,
        ...
        post_v1_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item
