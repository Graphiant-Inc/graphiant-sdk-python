...
T = TypeVar("T", bound="PostV1SitesBodySiteRouteTag")


@_attrs_define
class PostV1SitesBodySiteRouteTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_sites_body_site_route_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        post_v1_sites_body_site_route_tag.additional_properties = d
        return post_v1_sites_body_site_route_tag
