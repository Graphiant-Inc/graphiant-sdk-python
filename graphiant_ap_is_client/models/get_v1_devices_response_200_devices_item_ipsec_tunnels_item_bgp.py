...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp_address_families_item import (
        GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp")


@_attrs_define
class GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem']]):
    ...
    address_families: Union[Unset, list["GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = GetV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem.from_dict(
        ...
        get_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp = cls(
        ...
        get_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp.additional_properties = d
        return get_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp
