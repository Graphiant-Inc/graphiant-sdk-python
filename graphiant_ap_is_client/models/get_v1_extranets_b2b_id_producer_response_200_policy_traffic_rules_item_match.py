...
T = TypeVar("T", bound="GetV1ExtranetsB2BIdProducerResponse200PolicyTrafficRulesItemMatch")


@_attrs_define
class GetV1ExtranetsB2BIdProducerResponse200PolicyTrafficRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_traffic_rules_item_match = cls(
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_traffic_rules_item_match.additional_properties = d
        return get_v1_extranets_b2b_id_producer_response_200_policy_traffic_rules_item_match
