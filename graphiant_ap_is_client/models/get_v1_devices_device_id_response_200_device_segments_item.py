...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_multipath import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_redistributions import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_dhcp_subnets_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_ipfix_exporters_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_ospfv_2_process import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv2Process,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_ospfv_3_process import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv3Process,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_overlay_filters import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOverlayFilters,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_static_routes_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_syslog_targets_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSegmentsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv3Process]):
        overlay_filters (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemOverlayFilters.from_dict(
                _overlay_filters
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_segments_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_segments_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_segments_item
