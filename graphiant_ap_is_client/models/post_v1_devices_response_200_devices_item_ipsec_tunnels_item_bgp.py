...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp_address_families_item import (
        PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp")


@_attrs_define
class PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem']]):
    ...
    address_families: Union[
        Unset, list["PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem.from_dict(
        ...
        post_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp = cls(
        ...
        post_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp.additional_properties = d
        return post_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp
