...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item_bfd import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1DevicesDeviceIdResponse200DeviceSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_segments_item_bgp_neighbors_item
