...
T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemIpfixExportersItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemIpfixExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_response_200_devices_item_ipfix_exporters_item = cls(
        ...
        get_v1_devices_response_200_devices_item_ipfix_exporters_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_ipfix_exporters_item
