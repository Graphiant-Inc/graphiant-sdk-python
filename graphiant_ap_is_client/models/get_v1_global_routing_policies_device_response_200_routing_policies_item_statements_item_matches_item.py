...
if TYPE_CHECKING:
    from ..models.get_v1_global_routing_policies_device_response_200_routing_policies_item_statements_item_matches_item_route_tag import (
        GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag,
    )


T = TypeVar("T", bound="GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItemMatchesItem")


@_attrs_define
class GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItemMatchesItem:
    """
    Attributes:
    ...
    route_tag: Union[
        Unset, "GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_route_tag, Unset):
            ...
            route_tag = GetV1GlobalRoutingPoliciesDeviceResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag.from_dict(
                _route_tag
            )
        ...
        get_v1_global_routing_policies_device_response_200_routing_policies_item_statements_item_matches_item = cls(
            community=community,
            id=id,
        ...
        get_v1_global_routing_policies_device_response_200_routing_policies_item_statements_item_matches_item.additional_properties = d
        return get_v1_global_routing_policies_device_response_200_routing_policies_item_statements_item_matches_item
