...
T = TypeVar("T", bound="PostV2MonitoringBgpBodySelectorsItem")


@_attrs_define
class PostV2MonitoringBgpBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_bgp_body_selectors_item = cls(
            peer_address=peer_address,
            type_=type_,
            vrf=vrf,
        )

        post_v2_monitoring_bgp_body_selectors_item.additional_properties = d
        return post_v2_monitoring_bgp_body_selectors_item
