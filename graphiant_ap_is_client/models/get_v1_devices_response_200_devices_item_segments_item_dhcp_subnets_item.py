...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_leases_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_nameservers import (
        GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item
