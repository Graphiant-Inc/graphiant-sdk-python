...
T = TypeVar("T", bound="GetV1SitesResponse200SitesItemLocation")


@_attrs_define
class GetV1SitesResponse200SitesItemLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_sites_response_200_sites_item_location = cls(
        ...
        get_v1_sites_response_200_sites_item_location.additional_properties = d
        return get_v1_sites_response_200_sites_item_location
