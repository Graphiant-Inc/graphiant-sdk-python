...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_ospfv_2_process_areas_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessAreasItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_ospfv_2_process_redistributed_protocols_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessRedistributedProtocolsItem,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2Process")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2Process:
    """
    Attributes:
        admin_distance (Union[Unset, str]):  Example: 100.
        areas (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessAreasItem']]):
        ...
        redistributed_protocols (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessRedistributedProtocolsItem']]):
        router_id (Union[Unset, str]):  Example: TYPE_STRING.
    """

    admin_distance: Union[Unset, str] = UNSET
    areas: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessAreasItem"]] = UNSET
    auto_router_id: Union[Unset, str] = UNSET
    default_originate: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    redistributed_protocols: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessRedistributedProtocolsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for areas_item_data in _areas or []:
            areas_item = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessAreasItem.from_dict(
                areas_item_data
            )
        ...
        for redistributed_protocols_item_data in _redistributed_protocols or []:
            redistributed_protocols_item = (
                PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOspfv2ProcessRedistributedProtocolsItem.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_ospfv_2_process = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_ospfv_2_process.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_segments_item_ospfv_2_process
