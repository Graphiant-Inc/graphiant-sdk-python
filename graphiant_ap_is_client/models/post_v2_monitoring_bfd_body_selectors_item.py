...
T = TypeVar("T", bound="PostV2MonitoringBfdBodySelectorsItem")


@_attrs_define
class PostV2MonitoringBfdBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_bfd_body_selectors_item = cls(
            if_index=if_index,
            peer_address=peer_address,
            type_=type_,
        )

        post_v2_monitoring_bfd_body_selectors_item.additional_properties = d
        return post_v2_monitoring_bfd_body_selectors_item
