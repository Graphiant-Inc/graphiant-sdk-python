...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpRedistributions")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_redistributions.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_redistributions
