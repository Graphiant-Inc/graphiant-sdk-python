...
T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemDhcpRelay")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItemDhcpRelay:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_dhcp_relay = cls(
            dhcpv_4_relays=dhcpv_4_relays,
            dhcpv_6_relays=dhcpv_6_relays,
            id=id,
        )

        get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_dhcp_relay.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item_dhcp_relay
