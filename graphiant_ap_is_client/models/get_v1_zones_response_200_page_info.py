...
T = TypeVar("T", bound="GetV1ZonesResponse200PageInfo")


@_attrs_define
class GetV1ZonesResponse200PageInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_zones_response_200_page_info = cls(
        ...
        get_v1_zones_response_200_page_info.additional_properties = d
        return get_v1_zones_response_200_page_info
