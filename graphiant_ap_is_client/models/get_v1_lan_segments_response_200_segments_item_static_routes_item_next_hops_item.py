...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItemNextHopsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItemNextHopsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hops_item = cls(
            circuit=circuit,
            id=id,
            metric=metric,
        ...
        get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hops_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hops_item
