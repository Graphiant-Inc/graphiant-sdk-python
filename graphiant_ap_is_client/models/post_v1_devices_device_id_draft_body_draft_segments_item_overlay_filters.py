...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOverlayFilters")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        post_v1_devices_device_id_draft_body_draft_segments_item_overlay_filters.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_segments_item_overlay_filters
