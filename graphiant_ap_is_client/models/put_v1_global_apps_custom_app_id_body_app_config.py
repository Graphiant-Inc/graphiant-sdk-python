...
if TYPE_CHECKING:
    from ..models.put_v1_global_apps_custom_app_id_body_app_config_port_ranges_item import (
        PutV1GlobalAppsCustomAppIdBodyAppConfigPortRangesItem,
    )


T = TypeVar("T", bound="PutV1GlobalAppsCustomAppIdBodyAppConfig")


@_attrs_define
class PutV1GlobalAppsCustomAppIdBodyAppConfig:
    """
    Attributes:
        ...
        port_ranges (Union[Unset, list['PutV1GlobalAppsCustomAppIdBodyAppConfigPortRangesItem']]):
    ...
    port_ranges: Union[Unset, list["PutV1GlobalAppsCustomAppIdBodyAppConfigPortRangesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for port_ranges_item_data in _port_ranges or []:
            port_ranges_item = PutV1GlobalAppsCustomAppIdBodyAppConfigPortRangesItem.from_dict(port_ranges_item_data)

            port_ranges.append(port_ranges_item)

        url = d.pop("url", UNSET)

        put_v1_global_apps_custom_app_id_body_app_config = cls(
        ...
        put_v1_global_apps_custom_app_id_body_app_config.additional_properties = d
        return put_v1_global_apps_custom_app_id_body_app_config
