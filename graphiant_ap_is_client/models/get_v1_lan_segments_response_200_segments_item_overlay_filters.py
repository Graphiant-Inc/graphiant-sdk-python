...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemOverlayFilters")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        get_v1_lan_segments_response_200_segments_item_overlay_filters.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_overlay_filters
