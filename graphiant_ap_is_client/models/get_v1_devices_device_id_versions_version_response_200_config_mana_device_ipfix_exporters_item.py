...
T = TypeVar("T", bound="GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpfixExportersItem")


@_attrs_define
class GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpfixExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipfix_exporters_item = cls(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipfix_exporters_item.additional_properties = d
        return get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipfix_exporters_item
