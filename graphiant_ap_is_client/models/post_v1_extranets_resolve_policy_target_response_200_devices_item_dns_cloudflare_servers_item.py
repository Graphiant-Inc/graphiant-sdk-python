...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemDnsCloudflareServersItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemDnsCloudflareServersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_dns_cloudflare_servers_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_dns_cloudflare_servers_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_dns_cloudflare_servers_item
