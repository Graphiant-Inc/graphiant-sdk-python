...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item_config_updated_at import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_4 import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6 import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item_oper_updated_at import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv6 (Union[Unset,
            GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset, list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubint
    ...
    config_updated_at: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    ...
    ipv4: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4"
    ] = UNSET
    ipv6: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6"
    ] = UNSET
    ...
    oper_updated_at: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                _config_updated_at
            )
        ...
        ipv4: Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4]
        if isinstance(_ipv4, Unset):
            ipv4 = UNSET
        else:
            ipv4 = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4.from_dict(
                    _ipv4
                )
            )

        _ipv6 = d.pop("ipv6", UNSET)
        ipv6: Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]
        if isinstance(_ipv6, Unset):
            ipv6 = UNSET
        else:
            ipv6 = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6.from_dict(
                    _ipv6
                )
            )
        ...
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item
