...
T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicyHostPrefixSetEntriesItem")


@_attrs_define
class PostV1ExtranetsResponse200PolicyHostPrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_response_200_policy_host_prefix_set_entries_item = cls(
            ip_prefix=ip_prefix,
        ...
        post_v1_extranets_response_200_policy_host_prefix_set_entries_item.additional_properties = d
        return post_v1_extranets_response_200_policy_host_prefix_set_entries_item
