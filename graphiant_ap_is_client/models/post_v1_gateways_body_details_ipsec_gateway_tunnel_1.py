...
T = TypeVar("T", bound="PostV1GatewaysBodyDetailsIpsecGatewayTunnel1")


@_attrs_define
class PostV1GatewaysBodyDetailsIpsecGatewayTunnel1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_gateways_body_details_ipsec_gateway_tunnel_1 = cls(
        ...
        post_v1_gateways_body_details_ipsec_gateway_tunnel_1.additional_properties = d
        return post_v1_gateways_body_details_ipsec_gateway_tunnel_1
