...
T = TypeVar("T", bound="PostV1GlobalIpfixResponse200ExportersItem")


@_attrs_define
class PostV1GlobalIpfixResponse200ExportersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_ipfix_response_200_exporters_item = cls(
        ...
        post_v1_global_ipfix_response_200_exporters_item.additional_properties = d
        return post_v1_global_ipfix_response_200_exporters_item
