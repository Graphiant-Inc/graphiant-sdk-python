...
T = TypeVar("T", bound="PostV2AssuranceTopologyClientSessionsResponse200SessionsItemClientLinksItem")


@_attrs_define
class PostV2AssuranceTopologyClientSessionsResponse200SessionsItemClientLinksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_topology_client_sessions_response_200_sessions_item_client_links_item = cls(
        ...
        post_v2_assurance_topology_client_sessions_response_200_sessions_item_client_links_item.additional_properties = d
        return post_v2_assurance_topology_client_sessions_response_200_sessions_item_client_links_item
