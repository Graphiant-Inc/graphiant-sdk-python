...
T = TypeVar("T", bound="GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem")


@_attrs_define
class GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_device_response_200_snmps_item_usm_local_users_item = cls(
        ...
        get_v1_global_snmps_device_response_200_snmps_item_usm_local_users_item.additional_properties = d
        return get_v1_global_snmps_device_response_200_snmps_item_usm_local_users_item
