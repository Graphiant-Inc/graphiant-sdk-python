...
T = TypeVar("T", bound="PutV1ExtranetsB2BIdBodyPolicySla")


@_attrs_define
class PutV1ExtranetsB2BIdBodyPolicySla:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_b2b_id_body_policy_sla = cls(
            backup_circuit=backup_circuit,
            class_=class_,
            primary_circuit=primary_circuit,
        )

        put_v1_extranets_b2b_id_body_policy_sla.additional_properties = d
        return put_v1_extranets_b2b_id_body_policy_sla
