...
T = TypeVar("T", bound="GetV1GlobalSyslogsSiteResponse200CollectorsItem")


@_attrs_define
class GetV1GlobalSyslogsSiteResponse200CollectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_syslogs_site_response_200_collectors_item = cls(
        ...
        get_v1_global_syslogs_site_response_200_collectors_item.additional_properties = d
        return get_v1_global_syslogs_site_response_200_collectors_item
