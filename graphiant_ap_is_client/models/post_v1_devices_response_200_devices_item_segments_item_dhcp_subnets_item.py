...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_leases_item import (
        PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_nameservers import (
        PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_ranges_item import (
        PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item_static_leases_item import (
        PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                PostV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item = cls(
        ...
        post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item
