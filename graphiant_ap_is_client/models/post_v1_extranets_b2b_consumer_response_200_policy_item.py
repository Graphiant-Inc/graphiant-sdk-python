...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_b2b_consumer_response_200_policy_item_inbound_security_rules_item import (
        PostV1ExtranetsB2BConsumerResponse200PolicyItemInboundSecurityRulesItem,
    )
    from ..models.post_v1_extranets_b2b_consumer_response_200_policy_item_outbound_security_rules_item import (
        PostV1ExtranetsB2BConsumerResponse200PolicyItemOutboundSecurityRulesItem,
    )
    from ..models.post_v1_extranets_b2b_consumer_response_200_policy_item_rules_item import (
        PostV1ExtranetsB2BConsumerResponse200PolicyItemRulesItem,
    )
    from ..models.post_v1_extranets_b2b_consumer_response_200_policy_item_traffic_rules_item import (
        PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsB2BConsumerResponse200PolicyItem")


@_attrs_define
class PostV1ExtranetsB2BConsumerResponse200PolicyItem:
    """
    Attributes:
        consumer_lan_segment (Union[Unset, str]):  Example: TYPE_INT64.
        inbound_security_rules (Union[Unset,
            list['PostV1ExtranetsB2BConsumerResponse200PolicyItemInboundSecurityRulesItem']]):
        outbound_security_rules (Union[Unset,
            list['PostV1ExtranetsB2BConsumerResponse200PolicyItemOutboundSecurityRulesItem']]):
        restricted_prefixes (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        rules (Union[Unset, list['PostV1ExtranetsB2BConsumerResponse200PolicyItemRulesItem']]):
        traffic_rules (Union[Unset, list['PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItem']]):
    """

    consumer_lan_segment: Union[Unset, str] = UNSET
    inbound_security_rules: Union[
        Unset, list["PostV1ExtranetsB2BConsumerResponse200PolicyItemInboundSecurityRulesItem"]
    ] = UNSET
    outbound_security_rules: Union[
        Unset, list["PostV1ExtranetsB2BConsumerResponse200PolicyItemOutboundSecurityRulesItem"]
    ] = UNSET
    restricted_prefixes: Union[Unset, list[str]] = UNSET
    rules: Union[Unset, list["PostV1ExtranetsB2BConsumerResponse200PolicyItemRulesItem"]] = UNSET
    traffic_rules: Union[Unset, list["PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for inbound_security_rules_item_data in _inbound_security_rules or []:
            inbound_security_rules_item = (
                PostV1ExtranetsB2BConsumerResponse200PolicyItemInboundSecurityRulesItem.from_dict(
        ...
        for outbound_security_rules_item_data in _outbound_security_rules or []:
            outbound_security_rules_item = (
                PostV1ExtranetsB2BConsumerResponse200PolicyItemOutboundSecurityRulesItem.from_dict(
        ...
        for rules_item_data in _rules or []:
            rules_item = PostV1ExtranetsB2BConsumerResponse200PolicyItemRulesItem.from_dict(rules_item_data)
        ...
        for traffic_rules_item_data in _traffic_rules or []:
            traffic_rules_item = PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItem.from_dict(
                traffic_rules_item_data
            )

            traffic_rules.append(traffic_rules_item)

        post_v1_extranets_b2b_consumer_response_200_policy_item = cls(
        ...
        post_v1_extranets_b2b_consumer_response_200_policy_item.additional_properties = d
        return post_v1_extranets_b2b_consumer_response_200_policy_item
