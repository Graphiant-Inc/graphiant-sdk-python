...
if TYPE_CHECKING:
    from ..models.post_v2_device_device_id_topology_response_200_nodes_item_connections_item_last_established_time import (
        PostV2DeviceDeviceIdTopologyResponse200NodesItemConnectionsItemLastEstablishedTime,
    )


T = TypeVar("T", bound="PostV2DeviceDeviceIdTopologyResponse200NodesItemConnectionsItem")


@_attrs_define
class PostV2DeviceDeviceIdTopologyResponse200NodesItemConnectionsItem:
    """
    Attributes:
    ...
    last_established_time: Union[
        Unset, "PostV2DeviceDeviceIdTopologyResponse200NodesItemConnectionsItemLastEstablishedTime"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_last_established_time, Unset):
            ...
            last_established_time = (
                PostV2DeviceDeviceIdTopologyResponse200NodesItemConnectionsItemLastEstablishedTime.from_dict(
        ...
        post_v2_device_device_id_topology_response_200_nodes_item_connections_item = cls(
            active=active,
        ...
        post_v2_device_device_id_topology_response_200_nodes_item_connections_item.additional_properties = d
        return post_v2_device_device_id_topology_response_200_nodes_item_connections_item
