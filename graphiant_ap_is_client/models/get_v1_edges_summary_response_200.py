...
if TYPE_CHECKING:
    from ..models.get_v1_edges_summary_response_200_edges_summary_item import (
        GetV1EdgesSummaryResponse200EdgesSummaryItem,
    )


T = TypeVar("T", bound="GetV1EdgesSummaryResponse200")


@_attrs_define
class GetV1EdgesSummaryResponse200:
    """
    Attributes:
        edges_summary (Union[Unset, list['GetV1EdgesSummaryResponse200EdgesSummaryItem']]):
        is_new_count (Union[Unset, str]):  Example: TYPE_UINT32.
    """

    edges_summary: Union[Unset, list["GetV1EdgesSummaryResponse200EdgesSummaryItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for edges_summary_item_data in _edges_summary or []:
            edges_summary_item = GetV1EdgesSummaryResponse200EdgesSummaryItem.from_dict(edges_summary_item_data)

            edges_summary.append(edges_summary_item)

        is_new_count = d.pop("isNewCount", UNSET)

        get_v1_edges_summary_response_200 = cls(
            edges_summary=edges_summary,
            is_new_count=is_new_count,
        )

        get_v1_edges_summary_response_200.additional_properties = d
        return get_v1_edges_summary_response_200
