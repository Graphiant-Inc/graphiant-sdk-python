...
T = TypeVar("T", bound="PostV1GlobalSyslogsResponse200CollectorsItem")


@_attrs_define
class PostV1GlobalSyslogsResponse200CollectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_syslogs_response_200_collectors_item = cls(
        ...
        post_v1_global_syslogs_response_200_collectors_item.additional_properties = d
        return post_v1_global_syslogs_response_200_collectors_item
