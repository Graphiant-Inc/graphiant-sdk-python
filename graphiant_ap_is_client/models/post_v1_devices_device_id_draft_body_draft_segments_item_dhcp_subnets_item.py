...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item_leases_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item_nameservers import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item_ranges_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item_static_leases_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                PostV1DevicesDeviceIdDraftBodyDraftSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_segments_item_dhcp_subnets_item
