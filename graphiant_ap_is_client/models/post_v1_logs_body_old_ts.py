...
T = TypeVar("T", bound="PostV1LogsBodyOldTs")


@_attrs_define
class PostV1LogsBodyOldTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_logs_body_old_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_logs_body_old_ts.additional_properties = d
        return post_v1_logs_body_old_ts
