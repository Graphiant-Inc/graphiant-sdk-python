...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_ip_sec_established_time import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSec:
    """
    Attributes:
        ...
        established_time (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSecEstablishedTime]):
    ...
    established_time: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSecEstablishedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemIpSecEstablishedTime.from_dict(
                _established_time
            )
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item_ip_sec = cls(
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item_ip_sec.additional_properties = d
        return get_v1_devices_device_id_response_200_device_interfaces_item_ip_sec
