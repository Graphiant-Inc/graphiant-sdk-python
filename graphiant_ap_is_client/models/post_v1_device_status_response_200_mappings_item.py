...
if TYPE_CHECKING:
    from ..models.post_v1_device_status_response_200_mappings_item_connect_time import (
        PostV1DeviceStatusResponse200MappingsItemConnectTime,
    )


T = TypeVar("T", bound="PostV1DeviceStatusResponse200MappingsItem")


@_attrs_define
class PostV1DeviceStatusResponse200MappingsItem:
    """
    Attributes:
        connect_time (Union[Unset, PostV1DeviceStatusResponse200MappingsItemConnectTime]):
    ...
    connect_time: Union[Unset, "PostV1DeviceStatusResponse200MappingsItemConnectTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_connect_time, Unset):
            ...
            connect_time = PostV1DeviceStatusResponse200MappingsItemConnectTime.from_dict(_connect_time)
        ...
        post_v1_device_status_response_200_mappings_item = cls(
        ...
        post_v1_device_status_response_200_mappings_item.additional_properties = d
        return post_v1_device_status_response_200_mappings_item
