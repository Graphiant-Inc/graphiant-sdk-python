...
T = TypeVar("T", bound="PutV1GroupsBodyPermissions")


@_attrs_define
class PutV1GroupsBodyPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_groups_body_permissions = cls(
        ...
        put_v1_groups_body_permissions.additional_properties = d
        return put_v1_groups_body_permissions
