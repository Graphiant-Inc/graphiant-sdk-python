...
T = TypeVar("T", bound="PostV2AuditLogsBodyRecentTs")


@_attrs_define
class PostV2AuditLogsBodyRecentTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_audit_logs_body_recent_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v2_audit_logs_body_recent_ts.additional_properties = d
        return post_v2_audit_logs_body_recent_ts
