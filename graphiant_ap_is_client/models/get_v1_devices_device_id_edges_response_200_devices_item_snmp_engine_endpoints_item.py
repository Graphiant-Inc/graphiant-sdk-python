...
T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpEngineEndpointsItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSnmpEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_snmp_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_snmp_engine_endpoints_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_snmp_engine_endpoints_item
