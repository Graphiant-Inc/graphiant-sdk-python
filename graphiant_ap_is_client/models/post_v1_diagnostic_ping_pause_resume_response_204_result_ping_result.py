...
if TYPE_CHECKING:
    from ..models.post_v1_diagnostic_ping_pause_resume_response_204_result_ping_result_completed_time import (
        PostV1DiagnosticPingPauseResumeResponse204ResultPingResultCompletedTime,
    )


T = TypeVar("T", bound="PostV1DiagnosticPingPauseResumeResponse204ResultPingResult")


@_attrs_define
class PostV1DiagnosticPingPauseResumeResponse204ResultPingResult:
    """
    Attributes:
        avg_loss (Union[Unset, str]):  Example: 64.
        avg_time (Union[Unset, str]):  Example: 3.
        completed_time (Union[Unset, PostV1DiagnosticPingPauseResumeResponse204ResultPingResultCompletedTime]):
    ...
    completed_time: Union[Unset, "PostV1DiagnosticPingPauseResumeResponse204ResultPingResultCompletedTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_completed_time, Unset):
            ...
            completed_time = PostV1DiagnosticPingPauseResumeResponse204ResultPingResultCompletedTime.from_dict(
                _completed_time
            )
        ...
        post_v1_diagnostic_ping_pause_resume_response_204_result_ping_result = cls(
            avg_loss=avg_loss,
            avg_time=avg_time,
        ...
        post_v1_diagnostic_ping_pause_resume_response_204_result_ping_result.additional_properties = d
        return post_v1_diagnostic_ping_pause_resume_response_204_result_ping_result
