...
T = TypeVar("T", bound="PostV2DeviceDeviceIdTopologyResponse200NodesItemCircuitInfoItem")


@_attrs_define
class PostV2DeviceDeviceIdTopologyResponse200NodesItemCircuitInfoItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_device_device_id_topology_response_200_nodes_item_circuit_info_item = cls(
        ...
        post_v2_device_device_id_topology_response_200_nodes_item_circuit_info_item.additional_properties = d
        return post_v2_device_device_id_topology_response_200_nodes_item_circuit_info_item
