...
if TYPE_CHECKING:
    from ..models.get_v1_gateways_id_details_response_200_details_ipsec_gateway_routing import (
        GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayRouting,
    )
    from ..models.get_v1_gateways_id_details_response_200_details_ipsec_gateway_tunnel_1 import (
        GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel1,
    )
    from ..models.get_v1_gateways_id_details_response_200_details_ipsec_gateway_tunnel_2 import (
        GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2,
    )


T = TypeVar("T", bound="GetV1GatewaysIdDetailsResponse200DetailsIpsecGateway")


@_attrs_define
class GetV1GatewaysIdDetailsResponse200DetailsIpsecGateway:
    """
    Attributes:
        ...
        routing (Union[Unset, GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayRouting]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        tunnel1 (Union[Unset, GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel1]):
        tunnel2 (Union[Unset, GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2]):
    ...
    routing: Union[Unset, "GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayRouting"] = UNSET
    tcp_mss: Union[Unset, str] = UNSET
    tunnel1: Union[Unset, "GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel1"] = UNSET
    tunnel2: Union[Unset, "GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_routing, Unset):
            ...
            routing = GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayRouting.from_dict(_routing)
        ...
        if isinstance(_tunnel1, Unset):
            ...
            tunnel1 = GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel1.from_dict(_tunnel1)
        ...
        if isinstance(_tunnel2, Unset):
            ...
            tunnel2 = GetV1GatewaysIdDetailsResponse200DetailsIpsecGatewayTunnel2.from_dict(_tunnel2)

        vpn_profile = d.pop("vpnProfile", UNSET)

        get_v1_gateways_id_details_response_200_details_ipsec_gateway = cls(
        ...
        get_v1_gateways_id_details_response_200_details_ipsec_gateway.additional_properties = d
        return get_v1_gateways_id_details_response_200_details_ipsec_gateway
