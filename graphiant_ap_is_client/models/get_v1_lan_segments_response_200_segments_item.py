...
if TYPE_CHECKING:
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_aggregations_item import (
        GetV1LanSegmentsResponse200SegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_multipath import (
        GetV1LanSegmentsResponse200SegmentsItemBgpMultipath,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_redistributions import (
        GetV1LanSegmentsResponse200SegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_dhcp_subnets_item import (
        GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_ipfix_exporters_item import (
        GetV1LanSegmentsResponse200SegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_ospfv_2_process import (
        GetV1LanSegmentsResponse200SegmentsItemOspfv2Process,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_ospfv_3_process import (
        GetV1LanSegmentsResponse200SegmentsItemOspfv3Process,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_overlay_filters import (
        GetV1LanSegmentsResponse200SegmentsItemOverlayFilters,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_static_routes_item import (
        GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_syslog_targets_item import (
        GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemOspfv3Process]):
        overlay_filters (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1LanSegmentsResponse200SegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1LanSegmentsResponse200SegmentsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1LanSegmentsResponse200SegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1LanSegmentsResponse200SegmentsItemDhcpSubnetsItem.from_dict(dhcp_subnets_item_data)
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1LanSegmentsResponse200SegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1LanSegmentsResponse200SegmentsItemOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1LanSegmentsResponse200SegmentsItemOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1LanSegmentsResponse200SegmentsItemOverlayFilters.from_dict(_overlay_filters)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1LanSegmentsResponse200SegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_lan_segments_response_200_segments_item = cls(
        ...
        get_v1_lan_segments_response_200_segments_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item
