...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item_leases_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item_nameservers import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem']]):
        ...
        nameservers (Union[Unset,
            GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem"]
    ] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers"
    ] = UNSET
    ranges: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem"]
    ] = UNSET
    static_leases: Union[
        Unset, list["GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                    leases_item_data
                )
            )
        ...
        nameservers: Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers]
        if isinstance(_nameservers, Unset):
            nameservers = UNSET
        else:
            nameservers = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                    _nameservers
                )
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                    ranges_item_data
                )
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_segments_item_dhcp_subnets_item
