...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd = cls(
            enabled=enabled,
            minimum_interval=minimum_interval,
            multiplier=multiplier,
        )

        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd
