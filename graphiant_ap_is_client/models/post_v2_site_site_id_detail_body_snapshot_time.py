...
T = TypeVar("T", bound="PostV2SiteSiteIdDetailBodySnapshotTime")


@_attrs_define
class PostV2SiteSiteIdDetailBodySnapshotTime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_site_site_id_detail_body_snapshot_time = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v2_site_site_id_detail_body_snapshot_time.additional_properties = d
        return post_v2_site_site_id_detail_body_snapshot_time
