...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_ipsec_tunnels_item_bgp import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemBgp,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_ipsec_tunnels_item_static import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        get_v1_devices_device_id_draft_response_200_draft_mana_device_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_ipsec_tunnels_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_ipsec_tunnels_item
