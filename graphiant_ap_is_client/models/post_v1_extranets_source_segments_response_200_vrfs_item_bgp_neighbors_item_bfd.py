...
T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd = cls(
            enabled=enabled,
            minimum_interval=minimum_interval,
            multiplier=multiplier,
        )

        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd
