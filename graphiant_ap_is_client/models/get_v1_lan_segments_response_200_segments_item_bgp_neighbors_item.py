...
if TYPE_CHECKING:
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(_bfd_neighbor)
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                GetV1LanSegmentsResponse200SegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_bgp_neighbors_item
