...
T = TypeVar("T", bound="PutV1ExtranetsIdBodyPolicyAuto")


@_attrs_define
class PutV1ExtranetsIdBodyPolicyAuto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_body_policy_auto = cls(
            auto_propagate=auto_propagate,
            excluded_prefixes=excluded_prefixes,
        )

        put_v1_extranets_id_body_policy_auto.additional_properties = d
        return put_v1_extranets_id_body_policy_auto
