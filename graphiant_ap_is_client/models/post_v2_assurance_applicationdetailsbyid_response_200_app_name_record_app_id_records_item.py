...
T = TypeVar("T", bound="PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem")


@_attrs_define
class PostV2AssuranceApplicationdetailsbyidResponse200AppNameRecordAppIdRecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_applicationdetailsbyid_response_200_app_name_record_app_id_records_item = cls(
        ...
        post_v2_assurance_applicationdetailsbyid_response_200_app_name_record_app_id_records_item.additional_properties = d
        return post_v2_assurance_applicationdetailsbyid_response_200_app_name_record_app_id_records_item
