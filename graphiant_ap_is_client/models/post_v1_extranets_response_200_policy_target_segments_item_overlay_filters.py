...
T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicyTargetSegmentsItemOverlayFilters")


@_attrs_define
class PostV1ExtranetsResponse200PolicyTargetSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_response_200_policy_target_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        post_v1_extranets_response_200_policy_target_segments_item_overlay_filters.additional_properties = d
        return post_v1_extranets_response_200_policy_target_segments_item_overlay_filters
