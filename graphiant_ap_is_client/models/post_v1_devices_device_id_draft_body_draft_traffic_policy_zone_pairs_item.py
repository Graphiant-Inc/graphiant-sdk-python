...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicyZonePairsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicyZonePairsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_traffic_policy_zone_pairs_item = cls(
            inside=inside,
            outside=outside,
            ruleset=ruleset,
        ...
        post_v1_devices_device_id_draft_body_draft_traffic_policy_zone_pairs_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_traffic_policy_zone_pairs_item
