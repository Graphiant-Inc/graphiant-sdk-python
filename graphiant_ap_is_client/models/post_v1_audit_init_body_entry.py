...
if TYPE_CHECKING:
    from ..models.post_v1_audit_init_body_entry_end import PostV1AuditInitBodyEntryEnd
    from ..models.post_v1_audit_init_body_entry_failed_target_results_item import (
        PostV1AuditInitBodyEntryFailedTargetResultsItem,
    )
    from ..models.post_v1_audit_init_body_entry_start import PostV1AuditInitBodyEntryStart
    from ..models.post_v1_audit_init_body_entry_targets_item import PostV1AuditInitBodyEntryTargetsItem


T = TypeVar("T", bound="PostV1AuditInitBodyEntry")


@_attrs_define
class PostV1AuditInitBodyEntry:
    """
    Attributes:
        ...
        end (Union[Unset, PostV1AuditInitBodyEntryEnd]):
        failed_target_results (Union[Unset, list['PostV1AuditInitBodyEntryFailedTargetResultsItem']]):
        ...
        start (Union[Unset, PostV1AuditInitBodyEntryStart]):
        status (Union[Unset, str]):  Example: Failure.
        targets (Union[Unset, list['PostV1AuditInitBodyEntryTargetsItem']]):
    ...
    end: Union[Unset, "PostV1AuditInitBodyEntryEnd"] = UNSET
    failed_target_results: Union[Unset, list["PostV1AuditInitBodyEntryFailedTargetResultsItem"]] = UNSET
    info: Union[Unset, str] = UNSET
    reason: Union[Unset, str] = UNSET
    service: Union[Unset, str] = UNSET
    span_id: Union[Unset, str] = UNSET
    start: Union[Unset, "PostV1AuditInitBodyEntryStart"] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["PostV1AuditInitBodyEntryTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_end, Unset):
            ...
            end = PostV1AuditInitBodyEntryEnd.from_dict(_end)

        failed_target_results = []
        _failed_target_results = d.pop("failedTargetResults", UNSET)
        for failed_target_results_item_data in _failed_target_results or []:
            failed_target_results_item = PostV1AuditInitBodyEntryFailedTargetResultsItem.from_dict(
        ...
        if isinstance(_start, Unset):
            ...
            start = PostV1AuditInitBodyEntryStart.from_dict(_start)
        ...
        for targets_item_data in _targets or []:
            targets_item = PostV1AuditInitBodyEntryTargetsItem.from_dict(targets_item_data)

            targets.append(targets_item)

        trace_id = d.pop("traceId", UNSET)

        post_v1_audit_init_body_entry = cls(
            activity=activity,
            actor=actor,
            category=category,
            end=end,
        ...
        post_v1_audit_init_body_entry.additional_properties = d
        return post_v1_audit_init_body_entry
