...
T = TypeVar("T", bound="PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItemMatch")


@_attrs_define
class PostV1ExtranetsB2BConsumerResponse200PolicyItemTrafficRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_consumer_response_200_policy_item_traffic_rules_item_match = cls(
        ...
        post_v1_extranets_b2b_consumer_response_200_policy_item_traffic_rules_item_match.additional_properties = d
        return post_v1_extranets_b2b_consumer_response_200_policy_item_traffic_rules_item_match
