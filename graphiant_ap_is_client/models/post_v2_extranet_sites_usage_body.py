...
if TYPE_CHECKING:
    from ..models.post_v2_extranet_sites_usage_body_time_window import PostV2ExtranetSitesUsageBodyTimeWindow


T = TypeVar("T", bound="PostV2ExtranetSitesUsageBody")


@_attrs_define
class PostV2ExtranetSitesUsageBody:
    """
    Attributes:
        ...
        time_window (Union[Unset, PostV2ExtranetSitesUsageBodyTimeWindow]):
    ...
    time_window: Union[Unset, "PostV2ExtranetSitesUsageBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV2ExtranetSitesUsageBodyTimeWindow.from_dict(_time_window)

        vrf_id = d.pop("vrfId", UNSET)

        post_v2_extranet_sites_usage_body = cls(
            id=id,
            is_b2b=is_b2b,
        ...
        post_v2_extranet_sites_usage_body.additional_properties = d
        return post_v2_extranet_sites_usage_body
