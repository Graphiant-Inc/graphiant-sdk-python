...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_bucketdetails_body_time_window import PostV2AssuranceBucketdetailsBodyTimeWindow


T = TypeVar("T", bound="PostV2AssuranceBucketdetailsBody")


@_attrs_define
class PostV2AssuranceBucketdetailsBody:
    """
    Attributes:
        bucket_id (Union[Unset, str]):  Example: TYPE_ENUM.
        time_window (Union[Unset, PostV2AssuranceBucketdetailsBodyTimeWindow]):
        unclassified_only (Union[Unset, str]):  Example: TYPE_BOOL.
    """

    bucket_id: Union[Unset, str] = UNSET
    time_window: Union[Unset, "PostV2AssuranceBucketdetailsBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV2AssuranceBucketdetailsBodyTimeWindow.from_dict(_time_window)

        unclassified_only = d.pop("unclassifiedOnly", UNSET)

        post_v2_assurance_bucketdetails_body = cls(
            bucket_id=bucket_id,
            time_window=time_window,
            unclassified_only=unclassified_only,
        )

        post_v2_assurance_bucketdetails_body.additional_properties = d
        return post_v2_assurance_bucketdetails_body
