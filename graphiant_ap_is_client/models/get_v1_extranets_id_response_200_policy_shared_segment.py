...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_bgp_aggregations_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentBgpAggregationsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_bgp_multipath import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentBgpMultipath,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_bgp_neighbors_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_bgp_redistributions import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_ipfix_exporters_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_ospfv_2_process import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv2Process,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_ospfv_3_process import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv3Process,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_overlay_filters import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_static_routes_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentStaticRoutesItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_shared_segment_syslog_targets_item import (
        GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicySharedSegment")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicySharedSegment:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1ExtranetsIdResponse200PolicySharedSegmentBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv3Process]):
        overlay_filters (Union[Unset, GetV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "GetV1ExtranetsIdResponse200PolicySharedSegmentBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1ExtranetsIdResponse200PolicySharedSegmentBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1ExtranetsIdResponse200PolicySharedSegmentBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1ExtranetsIdResponse200PolicySharedSegmentBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1ExtranetsIdResponse200PolicySharedSegmentIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1ExtranetsIdResponse200PolicySharedSegmentOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters.from_dict(_overlay_filters)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1ExtranetsIdResponse200PolicySharedSegmentStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1ExtranetsIdResponse200PolicySharedSegmentSyslogTargetsItem.from_dict(
        ...
        get_v1_extranets_id_response_200_policy_shared_segment = cls(
        ...
        get_v1_extranets_id_response_200_policy_shared_segment.additional_properties = d
        return get_v1_extranets_id_response_200_policy_shared_segment
