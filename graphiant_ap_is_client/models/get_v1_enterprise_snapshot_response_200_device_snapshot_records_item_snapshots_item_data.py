...
T = TypeVar("T", bound="GetV1EnterpriseSnapshotResponse200DeviceSnapshotRecordsItemSnapshotsItemData")


@_attrs_define
class GetV1EnterpriseSnapshotResponse200DeviceSnapshotRecordsItemSnapshotsItemData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_snapshot_response_200_device_snapshot_records_item_snapshots_item_data = cls(
        ...
        get_v1_enterprise_snapshot_response_200_device_snapshot_records_item_snapshots_item_data.additional_properties = d
        return get_v1_enterprise_snapshot_response_200_device_snapshot_records_item_snapshots_item_data
