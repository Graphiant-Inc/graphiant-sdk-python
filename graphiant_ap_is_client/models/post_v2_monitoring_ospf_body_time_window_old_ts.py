...
T = TypeVar("T", bound="PostV2MonitoringOspfBodyTimeWindowOldTs")


@_attrs_define
class PostV2MonitoringOspfBodyTimeWindowOldTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_ospf_body_time_window_old_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v2_monitoring_ospf_body_time_window_old_ts.additional_properties = d
        return post_v2_monitoring_ospf_body_time_window_old_ts
