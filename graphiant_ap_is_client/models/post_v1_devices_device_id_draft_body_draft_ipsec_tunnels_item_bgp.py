...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_bgp_address_families_item import (
        PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgpAddressFamiliesItem,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgpAddressFamiliesItem']]):
    ...
    address_families: Union[
        Unset, list["PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgpAddressFamiliesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgpAddressFamiliesItem.from_dict(
        ...
        post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_bgp = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_bgp.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_bgp
