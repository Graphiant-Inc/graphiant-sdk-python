...
T = TypeVar("T", bound="PutV1PolicyPrefixSetsIdResponse200PrefixSetEntriesItem")


@_attrs_define
class PutV1PolicyPrefixSetsIdResponse200PrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_policy_prefix_sets_id_response_200_prefix_set_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        put_v1_policy_prefix_sets_id_response_200_prefix_set_entries_item.additional_properties = d
        return put_v1_policy_prefix_sets_id_response_200_prefix_set_entries_item
