...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_segments_item_syslog_targets_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_segments_item_syslog_targets_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_segments_item_syslog_targets_item
