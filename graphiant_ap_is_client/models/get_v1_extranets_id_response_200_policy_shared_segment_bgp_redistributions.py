...
T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicySharedSegmentBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_response_200_policy_shared_segment_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        get_v1_extranets_id_response_200_policy_shared_segment_bgp_redistributions.additional_properties = d
        return get_v1_extranets_id_response_200_policy_shared_segment_bgp_redistributions
