...
T = TypeVar("T", bound="PostV1ExtranetsB2BBodyPolicySitesItem")


@_attrs_define
class PostV1ExtranetsB2BBodyPolicySitesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_body_policy_sites_item = cls(
        ...
        post_v1_extranets_b2b_body_policy_sites_item.additional_properties = d
        return post_v1_extranets_b2b_body_policy_sites_item
