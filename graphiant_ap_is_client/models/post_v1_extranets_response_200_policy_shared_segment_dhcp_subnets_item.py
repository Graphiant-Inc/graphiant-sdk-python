...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item_leases_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item_nameservers import (
        PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemNameservers,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item_ranges_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem,
    )
    from ..models.post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item_static_leases_item import (
        PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem")


@_attrs_define
class PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = PostV1ExtranetsResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item = cls(
        ...
        post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item.additional_properties = d
        return post_v1_extranets_response_200_policy_shared_segment_dhcp_subnets_item
