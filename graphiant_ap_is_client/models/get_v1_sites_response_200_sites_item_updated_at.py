...
T = TypeVar("T", bound="GetV1SitesResponse200SitesItemUpdatedAt")


@_attrs_define
class GetV1SitesResponse200SitesItemUpdatedAt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_sites_response_200_sites_item_updated_at = cls(
            nanos=nanos,
            seconds=seconds,
        )

        get_v1_sites_response_200_sites_item_updated_at.additional_properties = d
        return get_v1_sites_response_200_sites_item_updated_at
