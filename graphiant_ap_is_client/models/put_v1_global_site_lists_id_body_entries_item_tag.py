...
T = TypeVar("T", bound="PutV1GlobalSiteListsIdBodyEntriesItemTag")


@_attrs_define
class PutV1GlobalSiteListsIdBodyEntriesItemTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_global_site_lists_id_body_entries_item_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        put_v1_global_site_lists_id_body_entries_item_tag.additional_properties = d
        return put_v1_global_site_lists_id_body_entries_item_tag
