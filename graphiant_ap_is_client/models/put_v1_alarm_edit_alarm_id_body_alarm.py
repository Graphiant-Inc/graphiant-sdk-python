...
if TYPE_CHECKING:
    from ..models.put_v1_alarm_edit_alarm_id_body_alarm_filter_item import PutV1AlarmEditAlarmIdBodyAlarmFilterItem


T = TypeVar("T", bound="PutV1AlarmEditAlarmIdBodyAlarm")


@_attrs_define
class PutV1AlarmEditAlarmIdBodyAlarm:
    """
    Attributes:
        ...
        filter_ (Union[Unset, list['PutV1AlarmEditAlarmIdBodyAlarmFilterItem']]):
    ...
    filter_: Union[Unset, list["PutV1AlarmEditAlarmIdBodyAlarmFilterItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for filter_item_data in _filter_ or []:
            filter_item = PutV1AlarmEditAlarmIdBodyAlarmFilterItem.from_dict(filter_item_data)
        ...
        put_v1_alarm_edit_alarm_id_body_alarm = cls(
            component=component,
        ...
        put_v1_alarm_edit_alarm_id_body_alarm.additional_properties = d
        return put_v1_alarm_edit_alarm_id_body_alarm
