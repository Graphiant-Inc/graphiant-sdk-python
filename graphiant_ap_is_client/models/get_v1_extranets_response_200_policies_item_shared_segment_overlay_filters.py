...
T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        get_v1_extranets_response_200_policies_item_shared_segment_overlay_filters.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment_overlay_filters
