...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_bgp_multipath import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_bgp_redistributions import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_core_logical_interfaces_v2_item import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_profile import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemProfile,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_static_routes_item import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_circuits_item_wan_interface_v2 import (
        GetV1DevicesDeviceIdResponse200DeviceCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceCircuitsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceCircuitsItemProfile]):
        ...
        static_routes (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions"] = UNSET
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceCircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceCircuitsItemStaticRoutesItem"]] = UNSET
    wan_interface_v2: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceCircuitsItemWanInterfaceV2"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = (
                GetV1DevicesDeviceIdResponse200DeviceCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = GetV1DevicesDeviceIdResponse200DeviceCircuitsItemWanInterfaceV2.from_dict(
                _wan_interface_v2
            )

        get_v1_devices_device_id_response_200_device_circuits_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_circuits_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_circuits_item
