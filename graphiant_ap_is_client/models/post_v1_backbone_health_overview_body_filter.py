...
T = TypeVar("T", bound="PostV1BackboneHealthOverviewBodyFilter")


@_attrs_define
class PostV1BackboneHealthOverviewBodyFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_backbone_health_overview_body_filter = cls(
        ...
        post_v1_backbone_health_overview_body_filter.additional_properties = d
        return post_v1_backbone_health_overview_body_filter
