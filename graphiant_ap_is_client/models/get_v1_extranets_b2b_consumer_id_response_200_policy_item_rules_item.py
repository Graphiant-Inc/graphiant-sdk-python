...
T = TypeVar("T", bound="GetV1ExtranetsB2BConsumerIdResponse200PolicyItemRulesItem")


@_attrs_define
class GetV1ExtranetsB2BConsumerIdResponse200PolicyItemRulesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_consumer_id_response_200_policy_item_rules_item = cls(
            outside_nat_prefix=outside_nat_prefix,
            service_prefix=service_prefix,
        )

        get_v1_extranets_b2b_consumer_id_response_200_policy_item_rules_item.additional_properties = d
        return get_v1_extranets_b2b_consumer_id_response_200_policy_item_rules_item
