...
if TYPE_CHECKING:
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item_address_families_item import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item_bfd import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem")


@_attrs_define
class GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfdNeighbor"] = (
        UNSET
    )
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item = cls(
        ...
        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item.additional_properties = d
        return get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item
