...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_connectivity_response_200_edges_item_connections_management_connection_item_last_established_time import (
        GetV1DevicesDeviceIdConnectivityResponse200EdgesItemConnectionsManagementConnectionItemLastEstablishedTime,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdConnectivityResponse200EdgesItemConnectionsManagementConnectionItem")


@_attrs_define
class GetV1DevicesDeviceIdConnectivityResponse200EdgesItemConnectionsManagementConnectionItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_last_established_time, Unset):
            ...
            last_established_time = GetV1DevicesDeviceIdConnectivityResponse200EdgesItemConnectionsManagementConnectionItemLastEstablishedTime.from_dict(
        ...
        get_v1_devices_device_id_connectivity_response_200_edges_item_connections_management_connection_item = cls(
            dest_ip=dest_ip,
            dest_port=dest_port,
        ...
        get_v1_devices_device_id_connectivity_response_200_edges_item_connections_management_connection_item.additional_properties = d
        return get_v1_devices_device_id_connectivity_response_200_edges_item_connections_management_connection_item
