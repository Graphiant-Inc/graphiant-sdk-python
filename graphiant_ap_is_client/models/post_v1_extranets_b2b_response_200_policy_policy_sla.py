...
T = TypeVar("T", bound="PostV1ExtranetsB2BResponse200PolicyPolicySla")


@_attrs_define
class PostV1ExtranetsB2BResponse200PolicyPolicySla:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_response_200_policy_policy_sla = cls(
            backup_circuit=backup_circuit,
            class_=class_,
            primary_circuit=primary_circuit,
        )

        post_v1_extranets_b2b_response_200_policy_policy_sla.additional_properties = d
        return post_v1_extranets_b2b_response_200_policy_policy_sla
