...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_bgp import (
        GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp,
    )
    from ..models.get_v1_devices_device_id_response_200_device_ipsec_tunnels_item_static import (
        GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = GetV1DevicesDeviceIdResponse200DeviceIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        get_v1_devices_device_id_response_200_device_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        get_v1_devices_device_id_response_200_device_ipsec_tunnels_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_ipsec_tunnels_item
