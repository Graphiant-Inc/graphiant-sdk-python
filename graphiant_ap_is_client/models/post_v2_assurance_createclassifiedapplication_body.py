...
T = TypeVar("T", bound="PostV2AssuranceCreateclassifiedapplicationBody")


@_attrs_define
class PostV2AssuranceCreateclassifiedapplicationBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_createclassifiedapplication_body = cls(
            app_name=app_name,
        ...
        post_v2_assurance_createclassifiedapplication_body.additional_properties = d
        return post_v2_assurance_createclassifiedapplication_body
