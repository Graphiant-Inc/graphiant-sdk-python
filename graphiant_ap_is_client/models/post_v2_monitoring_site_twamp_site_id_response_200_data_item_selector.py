...
T = TypeVar("T", bound="PostV2MonitoringSiteTwampSiteIdResponse200DataItemSelector")


@_attrs_define
class PostV2MonitoringSiteTwampSiteIdResponse200DataItemSelector:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_site_twamp_site_id_response_200_data_item_selector = cls(
        ...
        post_v2_monitoring_site_twamp_site_id_response_200_data_item_selector.additional_properties = d
        return post_v2_monitoring_site_twamp_site_id_response_200_data_item_selector
