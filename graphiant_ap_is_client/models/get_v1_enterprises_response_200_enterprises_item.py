...
if TYPE_CHECKING:
    from ..models.get_v1_enterprises_response_200_enterprises_item_counts import (
        GetV1EnterprisesResponse200EnterprisesItemCounts,
    )
    from ..models.get_v1_enterprises_response_200_enterprises_item_customers_item import (
        GetV1EnterprisesResponse200EnterprisesItemCustomersItem,
    )
    from ..models.get_v1_enterprises_response_200_enterprises_item_eula_agreement_date import (
        GetV1EnterprisesResponse200EnterprisesItemEulaAgreementDate,
    )


T = TypeVar("T", bound="GetV1EnterprisesResponse200EnterprisesItem")


@_attrs_define
class GetV1EnterprisesResponse200EnterprisesItem:
    """
    Attributes:
        ...
        counts (Union[Unset, GetV1EnterprisesResponse200EnterprisesItemCounts]):
        customers (Union[Unset, list['GetV1EnterprisesResponse200EnterprisesItemCustomersItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        eula_agreement_date (Union[Unset, GetV1EnterprisesResponse200EnterprisesItemEulaAgreementDate]):
    ...
    counts: Union[Unset, "GetV1EnterprisesResponse200EnterprisesItemCounts"] = UNSET
    customers: Union[Unset, list["GetV1EnterprisesResponse200EnterprisesItemCustomersItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    eula_agreement_date: Union[Unset, "GetV1EnterprisesResponse200EnterprisesItemEulaAgreementDate"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_counts, Unset):
            ...
            counts = GetV1EnterprisesResponse200EnterprisesItemCounts.from_dict(_counts)

        customers = []
        _customers = d.pop("customers", UNSET)
        for customers_item_data in _customers or []:
            customers_item = GetV1EnterprisesResponse200EnterprisesItemCustomersItem.from_dict(customers_item_data)
        ...
        if isinstance(_eula_agreement_date, Unset):
            ...
            eula_agreement_date = GetV1EnterprisesResponse200EnterprisesItemEulaAgreementDate.from_dict(
        ...
        get_v1_enterprises_response_200_enterprises_item = cls(
        ...
        get_v1_enterprises_response_200_enterprises_item.additional_properties = d
        return get_v1_enterprises_response_200_enterprises_item
