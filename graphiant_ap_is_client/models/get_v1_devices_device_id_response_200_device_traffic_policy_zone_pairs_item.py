...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceTrafficPolicyZonePairsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceTrafficPolicyZonePairsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_traffic_policy_zone_pairs_item = cls(
            inside=inside,
            outside=outside,
            ruleset=ruleset,
        ...
        get_v1_devices_device_id_response_200_device_traffic_policy_zone_pairs_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_traffic_policy_zone_pairs_item
