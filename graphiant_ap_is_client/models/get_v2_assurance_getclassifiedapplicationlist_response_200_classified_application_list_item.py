...
T = TypeVar("T", bound="GetV2AssuranceGetclassifiedapplicationlistResponse200ClassifiedApplicationListItem")


@_attrs_define
class GetV2AssuranceGetclassifiedapplicationlistResponse200ClassifiedApplicationListItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_assurance_getclassifiedapplicationlist_response_200_classified_application_list_item = cls(
            app_name=app_name,
        ...
        get_v2_assurance_getclassifiedapplicationlist_response_200_classified_application_list_item.additional_properties = d
        return get_v2_assurance_getclassifiedapplicationlist_response_200_classified_application_list_item
