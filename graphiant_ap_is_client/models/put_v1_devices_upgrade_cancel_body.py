...
T = TypeVar("T", bound="PutV1DevicesUpgradeCancelBody")


@_attrs_define
class PutV1DevicesUpgradeCancelBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_upgrade_cancel_body = cls(
            device_ids=device_ids,
        )

        put_v1_devices_upgrade_cancel_body.additional_properties = d
        return put_v1_devices_upgrade_cancel_body
