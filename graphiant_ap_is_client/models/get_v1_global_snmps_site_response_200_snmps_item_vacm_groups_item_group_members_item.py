...
T = TypeVar("T", bound="GetV1GlobalSnmpsSiteResponse200SnmpsItemVacmGroupsItemGroupMembersItem")


@_attrs_define
class GetV1GlobalSnmpsSiteResponse200SnmpsItemVacmGroupsItemGroupMembersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_site_response_200_snmps_item_vacm_groups_item_group_members_item = cls(
            id=id,
        ...
        get_v1_global_snmps_site_response_200_snmps_item_vacm_groups_item_group_members_item.additional_properties = d
        return get_v1_global_snmps_site_response_200_snmps_item_vacm_groups_item_group_members_item
