...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_routing_policies_item_statements_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItemStatementsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemRoutingPoliciesItemStatementsItem.from_dict(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_routing_policies_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_routing_policies_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_routing_policies_item
