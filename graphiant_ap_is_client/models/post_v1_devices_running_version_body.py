...
T = TypeVar("T", bound="PostV1DevicesRunningVersionBody")


@_attrs_define
class PostV1DevicesRunningVersionBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_running_version_body = cls(
            device_ids=device_ids,
        )

        post_v1_devices_running_version_body.additional_properties = d
        return post_v1_devices_running_version_body
