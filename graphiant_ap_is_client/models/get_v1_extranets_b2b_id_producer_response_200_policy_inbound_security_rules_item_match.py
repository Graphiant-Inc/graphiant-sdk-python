...
T = TypeVar("T", bound="GetV1ExtranetsB2BIdProducerResponse200PolicyInboundSecurityRulesItemMatch")


@_attrs_define
class GetV1ExtranetsB2BIdProducerResponse200PolicyInboundSecurityRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_inbound_security_rules_item_match = cls(
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_inbound_security_rules_item_match.additional_properties = d
        return get_v1_extranets_b2b_id_producer_response_200_policy_inbound_security_rules_item_match
