...
T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_sfp_optical_strength_item = cls(
            index=index,
            rx_power=rx_power,
            tx_bias=tx_bias,
            tx_power=tx_power,
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item_sfp_optical_strength_item.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item_sfp_optical_strength_item
