...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item_address_families_item import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item_bfd import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfdNeighbor"] = (
        UNSET
    )
    ...
    time_since_last_oper_change: Union[
        Unset, "GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = GetV1ExtranetsResponse200PoliciesItemTargetSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item = cls(
        ...
        get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_target_segments_item_bgp_neighbors_item
