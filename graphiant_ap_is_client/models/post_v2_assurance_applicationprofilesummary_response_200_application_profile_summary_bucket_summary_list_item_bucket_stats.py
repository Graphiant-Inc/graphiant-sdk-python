...
T = TypeVar(
    "T",
    bound="PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemBucketStats",
)


@_attrs_define
class PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemBucketStats:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_bucket_stats = cls(
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_bucket_stats.additional_properties = d
        return post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_bucket_stats
