...
if TYPE_CHECKING:
    from ..models.get_v1_global_apps_custom_app_id_response_200_app_config_port_ranges_item import (
        GetV1GlobalAppsCustomAppIdResponse200AppConfigPortRangesItem,
    )


T = TypeVar("T", bound="GetV1GlobalAppsCustomAppIdResponse200AppConfig")


@_attrs_define
class GetV1GlobalAppsCustomAppIdResponse200AppConfig:
    """
    Attributes:
        ...
        port_ranges (Union[Unset, list['GetV1GlobalAppsCustomAppIdResponse200AppConfigPortRangesItem']]):
    ...
    port_ranges: Union[Unset, list["GetV1GlobalAppsCustomAppIdResponse200AppConfigPortRangesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for port_ranges_item_data in _port_ranges or []:
            port_ranges_item = GetV1GlobalAppsCustomAppIdResponse200AppConfigPortRangesItem.from_dict(
        ...
        get_v1_global_apps_custom_app_id_response_200_app_config = cls(
        ...
        get_v1_global_apps_custom_app_id_response_200_app_config.additional_properties = d
        return get_v1_global_apps_custom_app_id_response_200_app_config
