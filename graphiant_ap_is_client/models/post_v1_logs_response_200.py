...
if TYPE_CHECKING:
    from ..models.post_v1_logs_response_200_histogram_item import PostV1LogsResponse200HistogramItem
    from ..models.post_v1_logs_response_200_logs_item import PostV1LogsResponse200LogsItem


T = TypeVar("T", bound="PostV1LogsResponse200")


@_attrs_define
class PostV1LogsResponse200:
    """
    Attributes:
        cursor_ref (Union[Unset, str]):  Example: TYPE_STRING.
        histogram (Union[Unset, list['PostV1LogsResponse200HistogramItem']]):
        logs (Union[Unset, list['PostV1LogsResponse200LogsItem']]):
        total_logs (Union[Unset, str]):  Example: TYPE_UINT64.
    """

    cursor_ref: Union[Unset, str] = UNSET
    histogram: Union[Unset, list["PostV1LogsResponse200HistogramItem"]] = UNSET
    logs: Union[Unset, list["PostV1LogsResponse200LogsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for histogram_item_data in _histogram or []:
            histogram_item = PostV1LogsResponse200HistogramItem.from_dict(histogram_item_data)
        ...
        for logs_item_data in _logs or []:
            logs_item = PostV1LogsResponse200LogsItem.from_dict(logs_item_data)

            logs.append(logs_item)

        total_logs = d.pop("totalLogs", UNSET)

        post_v1_logs_response_200 = cls(
        ...
        post_v1_logs_response_200.additional_properties = d
        return post_v1_logs_response_200
