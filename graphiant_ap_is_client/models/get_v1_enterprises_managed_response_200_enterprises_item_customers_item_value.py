...
if TYPE_CHECKING:
    from ..models.get_v1_enterprises_managed_response_200_enterprises_item_customers_item_value_counts import (
        GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValueCounts,
    )


T = TypeVar("T", bound="GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValue")


@_attrs_define
class GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValue:
    """
    Attributes:
        admin_email (Union[Unset, str]):  Example: TYPE_STRING.
        company_name (Union[Unset, str]):  Example: TYPE_STRING.
        counts (Union[Unset, GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValueCounts]):
    ...
    counts: Union[Unset, "GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValueCounts"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_counts, Unset):
            ...
            counts = GetV1EnterprisesManagedResponse200EnterprisesItemCustomersItemValueCounts.from_dict(_counts)

        enterprise_id = d.pop("enterpriseId", UNSET)

        impersonation_enabled = d.pop("impersonationEnabled", UNSET)

        get_v1_enterprises_managed_response_200_enterprises_item_customers_item_value = cls(
        ...
        get_v1_enterprises_managed_response_200_enterprises_item_customers_item_value.additional_properties = d
        return get_v1_enterprises_managed_response_200_enterprises_item_customers_item_value
