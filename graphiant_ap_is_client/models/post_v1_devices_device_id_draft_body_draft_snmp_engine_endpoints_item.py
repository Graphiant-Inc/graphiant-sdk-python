...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_engine_endpoints_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_snmp_engine_endpoints_item
