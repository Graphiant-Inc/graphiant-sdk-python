...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipsec_tunnels_item_bgp import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemBgp,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipsec_tunnels_item_static import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItem")


@_attrs_define
class GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceIpsecTunnelsItemStatic.from_dict(
                _static
            )
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipsec_tunnels_item.additional_properties = d
        return get_v1_devices_device_id_versions_version_response_200_config_mana_device_ipsec_tunnels_item
