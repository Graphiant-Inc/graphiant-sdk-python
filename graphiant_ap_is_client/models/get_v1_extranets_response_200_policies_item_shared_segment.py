...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_aggregations_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpAggregationsItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_multipath import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpMultipath,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_neighbors_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_bgp_redistributions import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_ipfix_exporters_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentIpfixExportersItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_ospfv_2_process import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv2Process,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_ospfv_3_process import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv3Process,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_overlay_filters import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_static_routes_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentStaticRoutesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_syslog_targets_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegment")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegment:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv3Process]):
        overlay_filters (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem']]):
    ...
    bgp_multipath: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv2Process.from_dict(
                _ospfv_2_process
            )
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1ExtranetsResponse200PoliciesItemSharedSegmentOspfv3Process.from_dict(
                _ospfv_3_process
            )
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1ExtranetsResponse200PoliciesItemSharedSegmentOverlayFilters.from_dict(
                _overlay_filters
            )
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentSyslogTargetsItem.from_dict(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment = cls(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment
