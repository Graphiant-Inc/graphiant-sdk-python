...
T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicyZoneFirewallsItemUdp")


@_attrs_define
class GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicyZoneFirewallsItemUdp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_udp = cls(
            expiry=expiry,
            unidirectional_flow_limit=unidirectional_flow_limit,
        )

        get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_udp.additional_properties = d
        return get_v1_global_traffic_policies_device_response_200_traffic_policy_zone_firewalls_item_udp
