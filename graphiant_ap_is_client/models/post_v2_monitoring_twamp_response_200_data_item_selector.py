...
T = TypeVar("T", bound="PostV2MonitoringTwampResponse200DataItemSelector")


@_attrs_define
class PostV2MonitoringTwampResponse200DataItemSelector:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_twamp_response_200_data_item_selector = cls(
        ...
        post_v2_monitoring_twamp_response_200_data_item_selector.additional_properties = d
        return post_v2_monitoring_twamp_response_200_data_item_selector
