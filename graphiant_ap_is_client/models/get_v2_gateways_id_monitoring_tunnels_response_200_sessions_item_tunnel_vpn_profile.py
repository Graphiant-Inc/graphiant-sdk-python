...
T = TypeVar("T", bound="GetV2GatewaysIdMonitoringTunnelsResponse200SessionsItemTunnelVpnProfile")


@_attrs_define
class GetV2GatewaysIdMonitoringTunnelsResponse200SessionsItemTunnelVpnProfile:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_gateways_id_monitoring_tunnels_response_200_sessions_item_tunnel_vpn_profile = cls(
        ...
        get_v2_gateways_id_monitoring_tunnels_response_200_sessions_item_tunnel_vpn_profile.additional_properties = d
        return get_v2_gateways_id_monitoring_tunnels_response_200_sessions_item_tunnel_vpn_profile
