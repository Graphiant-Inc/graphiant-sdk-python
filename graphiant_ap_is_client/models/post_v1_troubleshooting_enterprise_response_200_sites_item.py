...
if TYPE_CHECKING:
    from ..models.post_v1_troubleshooting_enterprise_response_200_sites_item_region import (
        PostV1TroubleshootingEnterpriseResponse200SitesItemRegion,
    )


T = TypeVar("T", bound="PostV1TroubleshootingEnterpriseResponse200SitesItem")


@_attrs_define
class PostV1TroubleshootingEnterpriseResponse200SitesItem:
    """
    Attributes:
        ...
        region (Union[Unset, PostV1TroubleshootingEnterpriseResponse200SitesItemRegion]):
    ...
    region: Union[Unset, "PostV1TroubleshootingEnterpriseResponse200SitesItemRegion"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_region, Unset):
            ...
            region = PostV1TroubleshootingEnterpriseResponse200SitesItemRegion.from_dict(_region)
        ...
        post_v1_troubleshooting_enterprise_response_200_sites_item = cls(
        ...
        post_v1_troubleshooting_enterprise_response_200_sites_item.additional_properties = d
        return post_v1_troubleshooting_enterprise_response_200_sites_item
