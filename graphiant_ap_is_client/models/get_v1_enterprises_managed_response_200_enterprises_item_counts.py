...
T = TypeVar("T", bound="GetV1EnterprisesManagedResponse200EnterprisesItemCounts")


@_attrs_define
class GetV1EnterprisesManagedResponse200EnterprisesItemCounts:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprises_managed_response_200_enterprises_item_counts = cls(
        ...
        get_v1_enterprises_managed_response_200_enterprises_item_counts.additional_properties = d
        return get_v1_enterprises_managed_response_200_enterprises_item_counts
