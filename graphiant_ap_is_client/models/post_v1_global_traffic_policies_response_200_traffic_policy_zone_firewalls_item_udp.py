...
T = TypeVar("T", bound="PostV1GlobalTrafficPoliciesResponse200TrafficPolicyZoneFirewallsItemUdp")


@_attrs_define
class PostV1GlobalTrafficPoliciesResponse200TrafficPolicyZoneFirewallsItemUdp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_traffic_policies_response_200_traffic_policy_zone_firewalls_item_udp = cls(
            expiry=expiry,
            unidirectional_flow_limit=unidirectional_flow_limit,
        )

        post_v1_global_traffic_policies_response_200_traffic_policy_zone_firewalls_item_udp.additional_properties = d
        return post_v1_global_traffic_policies_response_200_traffic_policy_zone_firewalls_item_udp
