...
T = TypeVar("T", bound="PutV2IntegrationIntegrationIdBodyIntegrationBodyDetails")


@_attrs_define
class PutV2IntegrationIntegrationIdBodyIntegrationBodyDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v2_integration_integration_id_body_integration_body_details = cls(
            opsgenie_key=opsgenie_key,
            opsramp_details=opsramp_details,
            webhook_url=webhook_url,
        )

        put_v2_integration_integration_id_body_integration_body_details.additional_properties = d
        return put_v2_integration_integration_id_body_integration_body_details
