...
T = TypeVar("T", bound="PostV2NotificationCreateBodyNotificationBody")


@_attrs_define
class PostV2NotificationCreateBodyNotificationBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_notification_create_body_notification_body = cls(
        ...
        post_v2_notification_create_body_notification_body.additional_properties = d
        return post_v2_notification_create_body_notification_body
