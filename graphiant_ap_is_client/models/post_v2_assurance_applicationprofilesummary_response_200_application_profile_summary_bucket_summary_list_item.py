...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_bucket_stats import (
        PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemBucketStats,
    )
    from ..models.post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item_child_bucket_stats_list_item import (
...
T = TypeVar(
    "T", bound="PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItem"
)


@_attrs_define
class PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItem:
    """
    Attributes:
        ...
        bucket_stats (Union[Unset,
            PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemBucketStats]):
        child_bucket_list (Union[Unset, list[str]]):  Example: ['TYPE_ENUM'].
        child_bucket_stats_list (Union[Unset, list['PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfil
            eSummaryBucketSummaryListItemChildBucketStatsListItem']]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bucket_stats, Unset):
            ...
            bucket_stats = PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemBucketStats.from_dict(
                _bucket_stats
            )
        ...
        for child_bucket_stats_list_item_data in _child_bucket_stats_list or []:
            child_bucket_stats_list_item = PostV2AssuranceApplicationprofilesummaryResponse200ApplicationProfileSummaryBucketSummaryListItemChildBucketStatsListItem.from_dict(
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item = cls(
        ...
        post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item.additional_properties = d
        return post_v2_assurance_applicationprofilesummary_response_200_application_profile_summary_bucket_summary_list_item
