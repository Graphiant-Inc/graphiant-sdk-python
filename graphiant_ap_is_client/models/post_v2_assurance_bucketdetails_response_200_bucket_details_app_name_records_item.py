...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item_app_id_records_item import (
        PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem,
    )


T = TypeVar("T", bound="PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItem")


@_attrs_define
class PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItem:
    """
    Attributes:
        ...
        app_id_records (Union[Unset,
            list['PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem']]):
    ...
    app_id_records: Union[
        Unset, list["PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for app_id_records_item_data in _app_id_records or []:
            app_id_records_item = (
                PostV2AssuranceBucketdetailsResponse200BucketDetailsAppNameRecordsItemAppIdRecordsItem.from_dict(
        ...
        post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item = cls(
        ...
        post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item.additional_properties = d
        return post_v2_assurance_bucketdetails_response_200_bucket_details_app_name_records_item
