...
T = TypeVar("T", bound="PutV1PolicyPrefixSetsIdBodyEntriesItemValue")


@_attrs_define
class PutV1PolicyPrefixSetsIdBodyEntriesItemValue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_policy_prefix_sets_id_body_entries_item_value = cls(
            ip_prefix=ip_prefix,
        ...
        put_v1_policy_prefix_sets_id_body_entries_item_value.additional_properties = d
        return put_v1_policy_prefix_sets_id_body_entries_item_value
