...
T = TypeVar("T", bound="DeleteV1ExtranetsIdResponse200DevicesItem")


@_attrs_define
class DeleteV1ExtranetsIdResponse200DevicesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        delete_v1_extranets_id_response_200_devices_item = cls(
            device_id=device_id,
        ...
        delete_v1_extranets_id_response_200_devices_item.additional_properties = d
        return delete_v1_extranets_id_response_200_devices_item
