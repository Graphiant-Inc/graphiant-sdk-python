...
if TYPE_CHECKING:
    from ..models.get_v1_global_traffic_policies_device_response_200_traffic_policy_security_rulesets_item_rules_item_match import (
        GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch,
    )


T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItem")


@_attrs_define
class GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItem:
    """
    Attributes:
    ...
    match: Union[
        Unset, "GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        match: Union[Unset, GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch]
        if isinstance(_match, Unset):
            match = UNSET
        else:
            match = (
                GetV1GlobalTrafficPoliciesDeviceResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch.from_dict(
                    _match
                )
            )
        ...
        get_v1_global_traffic_policies_device_response_200_traffic_policy_security_rulesets_item_rules_item = cls(
            action=action,
        ...
        get_v1_global_traffic_policies_device_response_200_traffic_policy_security_rulesets_item_rules_item.additional_properties = d
        return get_v1_global_traffic_policies_device_response_200_traffic_policy_security_rulesets_item_rules_item
