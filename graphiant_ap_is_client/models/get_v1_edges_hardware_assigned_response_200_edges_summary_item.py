...
if TYPE_CHECKING:
    from ..models.get_v1_edges_hardware_assigned_response_200_edges_summary_item_assigned_on import (
        GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemAssignedOn,
    )
    from ..models.get_v1_edges_hardware_assigned_response_200_edges_summary_item_first_appeared_on import (
        GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemFirstAppearedOn,
    )
    from ..models.get_v1_edges_hardware_assigned_response_200_edges_summary_item_last_booted_at import (
        GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLastBootedAt,
    )
    from ..models.get_v1_edges_hardware_assigned_response_200_edges_summary_item_location import (
        GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation,
    )
    from ..models.get_v1_edges_hardware_assigned_response_200_edges_summary_item_upgrade_summary import (
        GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemUpgradeSummary,
    )


T = TypeVar("T", bound="GetV1EdgesHardwareAssignedResponse200EdgesSummaryItem")


@_attrs_define
class GetV1EdgesHardwareAssignedResponse200EdgesSummaryItem:
    """
    Attributes:
        assigned_on (Union[Unset, GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemAssignedOn]):
        ...
        first_appeared_on (Union[Unset, GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemFirstAppearedOn]):
        ...
        last_booted_at (Union[Unset, GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLastBootedAt]):
        location (Union[Unset, GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation]):
        ...
        upgrade_summary (Union[Unset, GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemUpgradeSummary]):
    """

    assigned_on: Union[Unset, "GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemAssignedOn"] = UNSET
    device_id: Union[Unset, str] = UNSET
    discovered_location: Union[Unset, str] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    enterprise_name: Union[Unset, str] = UNSET
    first_appeared_on: Union[Unset, "GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemFirstAppearedOn"] = UNSET
    ...
    last_booted_at: Union[Unset, "GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLastBootedAt"] = UNSET
    location: Union[Unset, "GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation"] = UNSET
    ...
    upgrade_summary: Union[Unset, "GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemUpgradeSummary"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_assigned_on, Unset):
            ...
            assigned_on = GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemAssignedOn.from_dict(_assigned_on)
        ...
        if isinstance(_first_appeared_on, Unset):
            ...
            first_appeared_on = GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemFirstAppearedOn.from_dict(
                _first_appeared_on
            )
        ...
        if isinstance(_last_booted_at, Unset):
            ...
            last_booted_at = GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLastBootedAt.from_dict(
                _last_booted_at
            )
        ...
        if isinstance(_location, Unset):
            ...
            location = GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation.from_dict(_location)
        ...
        if isinstance(_upgrade_summary, Unset):
            ...
            upgrade_summary = GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemUpgradeSummary.from_dict(
                _upgrade_summary
            )

        get_v1_edges_hardware_assigned_response_200_edges_summary_item = cls(
        ...
        get_v1_edges_hardware_assigned_response_200_edges_summary_item.additional_properties = d
        return get_v1_edges_hardware_assigned_response_200_edges_summary_item
