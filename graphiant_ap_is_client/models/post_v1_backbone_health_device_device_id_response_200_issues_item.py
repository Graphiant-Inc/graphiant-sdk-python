...
if TYPE_CHECKING:
    from ..models.post_v1_backbone_health_device_device_id_response_200_issues_item_end_time import (
        PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemEndTime,
    )
    from ..models.post_v1_backbone_health_device_device_id_response_200_issues_item_start_time import (
        PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemStartTime,
    )


T = TypeVar("T", bound="PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItem")


@_attrs_define
class PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItem:
    """
    Attributes:
        ...
        end_time (Union[Unset, PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemEndTime]):
        ...
        start_time (Union[Unset, PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemStartTime]):
    ...
    end_time: Union[Unset, "PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemEndTime"] = UNSET
    ...
    start_time: Union[Unset, "PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemStartTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_end_time, Unset):
            ...
            end_time = PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemEndTime.from_dict(_end_time)
        ...
        if isinstance(_start_time, Unset):
            ...
            start_time = PostV1BackboneHealthDeviceDeviceIdResponse200IssuesItemStartTime.from_dict(_start_time)

        status = d.pop("status", UNSET)

        post_v1_backbone_health_device_device_id_response_200_issues_item = cls(
            alert_id=alert_id,
        ...
        post_v1_backbone_health_device_device_id_response_200_issues_item.additional_properties = d
        return post_v1_backbone_health_device_device_id_response_200_issues_item
