...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemTrafficPolicyDpiApplicationsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemTrafficPolicyDpiApplicationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_traffic_policy_dpi_applications_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_traffic_policy_dpi_applications_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_traffic_policy_dpi_applications_item
