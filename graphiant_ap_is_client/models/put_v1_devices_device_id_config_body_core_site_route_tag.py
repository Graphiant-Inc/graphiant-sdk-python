...
T = TypeVar("T", bound="PutV1DevicesDeviceIdConfigBodyCoreSiteRouteTag")


@_attrs_define
class PutV1DevicesDeviceIdConfigBodyCoreSiteRouteTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_device_id_config_body_core_site_route_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        put_v1_devices_device_id_config_body_core_site_route_tag.additional_properties = d
        return put_v1_devices_device_id_config_body_core_site_route_tag
