...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_communities_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpCommunitiesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_engine_endpoints_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_notify_filter_profiles_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpNotifyFilterProfilesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_targets_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_usm_local_users_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_usm_remote_users_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmRemoteUsersItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp_vacm_groups_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSnmp")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSnmp:
    """
    Attributes:
        communities (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem']]):
        usm_local_users (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSnmpVacmGroupsItem']]):
    """

    communities: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpCommunitiesItem"]] = UNSET
    ...
    engine_endpoints: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem"]] = UNSET
    ...
    targets: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem"]] = UNSET
    usm_remote_users: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmRemoteUsersItem"]] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSnmpVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpCommunitiesItem.from_dict(communities_item_data)
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpTargetsItem.from_dict(targets_item_data)
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = PostV1DevicesDeviceIdDraftBodyDraftSnmpVacmGroupsItem.from_dict(vacm_groups_item_data)

            vacm_groups.append(vacm_groups_item)

        post_v1_devices_device_id_draft_body_draft_snmp = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_snmp.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_snmp
