...
T = TypeVar("T", bound="PostV1BwtrackerRegionSiteSummaryResponse200BwusageSummaryBwuageRegionItem")


@_attrs_define
class PostV1BwtrackerRegionSiteSummaryResponse200BwusageSummaryBwuageRegionItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_bwtracker_region_site_summary_response_200_bwusage_summary_bwuage_region_item = cls(
            region_id=region_id,
        ...
        post_v1_bwtracker_region_site_summary_response_200_bwusage_summary_bwuage_region_item.additional_properties = d
        return post_v1_bwtracker_region_site_summary_response_200_bwusage_summary_bwuage_region_item
