...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_multipath import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_redistributions import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_core_logical_interfaces_v2_item import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_profile import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfile,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_static_routes_item import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_circuits_response_200_circuits_item_wan_interface_v2 import (
        GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItem")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfile]):
        ...
        static_routes (Union[Unset, list['GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset, GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[Unset, list["GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpAggregationsItem"]] = (
        UNSET
    )
    bgp_multipath: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions"] = UNSET
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItem"]] = UNSET
    wan_interface_v2: Union[Unset, "GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = (
                GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2.from_dict(
                _wan_interface_v2
            )

        get_v1_devices_device_id_circuits_response_200_circuits_item = cls(
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item
