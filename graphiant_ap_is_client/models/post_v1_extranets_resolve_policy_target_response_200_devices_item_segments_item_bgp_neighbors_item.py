...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item_address_families_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item_bfd import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item_bfd_neighbor import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeig
            hborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd]):
    ...
    address_families: Union[
        Unset,
        list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem"],
    ] = UNSET
    bfd: Union[Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfd.from_dict(
                _bfd
            )
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_bgp_neighbors_item
