...
T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemTrafficPolicyDpiApplicationsItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemTrafficPolicyDpiApplicationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_traffic_policy_dpi_applications_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_traffic_policy_dpi_applications_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_traffic_policy_dpi_applications_item
