...
T = TypeVar("T", bound="PutV1DevicesDeviceIdConfigBodyEdgeLocalRouteTagEntry")


@_attrs_define
class PutV1DevicesDeviceIdConfigBodyEdgeLocalRouteTagEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_device_id_config_body_edge_local_route_tag_entry = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        put_v1_devices_device_id_config_body_edge_local_route_tag_entry.additional_properties = d
        return put_v1_devices_device_id_config_body_edge_local_route_tag_entry
