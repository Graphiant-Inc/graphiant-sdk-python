...
T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicyZonePairsItem")


@_attrs_define
class GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicyZonePairsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_zone_pairs_item = cls(
            inside=inside,
            outside=outside,
            ruleset=ruleset,
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_zone_pairs_item.additional_properties = d
        return get_v1_global_traffic_policies_site_response_200_traffic_policy_zone_pairs_item
