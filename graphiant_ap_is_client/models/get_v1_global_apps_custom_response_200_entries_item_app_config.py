...
if TYPE_CHECKING:
    from ..models.get_v1_global_apps_custom_response_200_entries_item_app_config_port_ranges_item import (
        GetV1GlobalAppsCustomResponse200EntriesItemAppConfigPortRangesItem,
    )


T = TypeVar("T", bound="GetV1GlobalAppsCustomResponse200EntriesItemAppConfig")


@_attrs_define
class GetV1GlobalAppsCustomResponse200EntriesItemAppConfig:
    """
    Attributes:
        ...
        port_ranges (Union[Unset, list['GetV1GlobalAppsCustomResponse200EntriesItemAppConfigPortRangesItem']]):
    ...
    port_ranges: Union[Unset, list["GetV1GlobalAppsCustomResponse200EntriesItemAppConfigPortRangesItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for port_ranges_item_data in _port_ranges or []:
            port_ranges_item = GetV1GlobalAppsCustomResponse200EntriesItemAppConfigPortRangesItem.from_dict(
                port_ranges_item_data
            )
        ...
        get_v1_global_apps_custom_response_200_entries_item_app_config = cls(
        ...
        get_v1_global_apps_custom_response_200_entries_item_app_config.additional_properties = d
        return get_v1_global_apps_custom_response_200_entries_item_app_config
