...
T = TypeVar("T", bound="GetV1EnterpriseAllocationResponse200RegionalAllocationsItem")


@_attrs_define
class GetV1EnterpriseAllocationResponse200RegionalAllocationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_allocation_response_200_regional_allocations_item = cls(
        ...
        get_v1_enterprise_allocation_response_200_regional_allocations_item.additional_properties = d
        return get_v1_enterprise_allocation_response_200_regional_allocations_item
