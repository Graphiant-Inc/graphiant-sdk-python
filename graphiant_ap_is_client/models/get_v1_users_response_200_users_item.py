...
T = TypeVar("T", bound="GetV1UsersResponse200UsersItem")


@_attrs_define
class GetV1UsersResponse200UsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_users_response_200_users_item = cls(
            email=email,
        ...
        get_v1_users_response_200_users_item.additional_properties = d
        return get_v1_users_response_200_users_item
