...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2_primary_ipv_4_server import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv4Server,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2_primary_ipv_6_server import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv6Server,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2_secondary_ipv_4_server import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv4Server,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2_secondary_ipv_6_server import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv6Server,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2:
    """
    Attributes:
    ...
    primary_ipv_4_server: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv4Server"
    ] = UNSET
    primary_ipv_6_server: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv6Server"
    ] = UNSET
    secondary_ipv_4_server: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv4Server"
    ] = UNSET
    secondary_ipv_6_server: Union[
        Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv6Server"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_primary_ipv_4_server, Unset):
            ...
            primary_ipv_4_server = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv4Server.from_dict(
        ...
        if isinstance(_primary_ipv_6_server, Unset):
            ...
            primary_ipv_6_server = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2PrimaryIpv6Server.from_dict(
        ...
        if isinstance(_secondary_ipv_4_server, Unset):
            ...
            secondary_ipv_4_server = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv4Server.from_dict(
        ...
        if isinstance(_secondary_ipv_6_server, Unset):
            ...
            secondary_ipv_6_server = (
                GetV1DevicesDeviceIdEdgesResponse200DevicesItemDnsStaticServersV2SecondaryIpv6Server.from_dict(
                    _secondary_ipv_6_server
                )
            )

        get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2 = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_dns_static_servers_v2
