...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_snmp_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        get_v1_devices_device_id_response_200_device_snmp_targets_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_snmp_targets_item
