...
if TYPE_CHECKING:
    from ..models.get_v1_groups_enterprises_response_200_groups_item_permissions import (
        GetV1GroupsEnterprisesResponse200GroupsItemPermissions,
    )


T = TypeVar("T", bound="GetV1GroupsEnterprisesResponse200GroupsItem")


@_attrs_define
class GetV1GroupsEnterprisesResponse200GroupsItem:
    """
    Attributes:
        ...
        permissions (Union[Unset, GetV1GroupsEnterprisesResponse200GroupsItemPermissions]):
    ...
    permissions: Union[Unset, "GetV1GroupsEnterprisesResponse200GroupsItemPermissions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_permissions, Unset):
            ...
            permissions = GetV1GroupsEnterprisesResponse200GroupsItemPermissions.from_dict(_permissions)

        time_window_end = d.pop("timeWindowEnd", UNSET)

        time_window_start = d.pop("timeWindowStart", UNSET)

        get_v1_groups_enterprises_response_200_groups_item = cls(
        ...
        get_v1_groups_enterprises_response_200_groups_item.additional_properties = d
        return get_v1_groups_enterprises_response_200_groups_item
