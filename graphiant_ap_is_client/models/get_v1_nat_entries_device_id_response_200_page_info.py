...
T = TypeVar("T", bound="GetV1NatEntriesDeviceIdResponse200PageInfo")


@_attrs_define
class GetV1NatEntriesDeviceIdResponse200PageInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_nat_entries_device_id_response_200_page_info = cls(
        ...
        get_v1_nat_entries_device_id_response_200_page_info.additional_properties = d
        return get_v1_nat_entries_device_id_response_200_page_info
