...
if TYPE_CHECKING:
    from ..models.post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_actions_item_community import (
        PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity,
    )


T = TypeVar("T", bound="PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemActionsItem")


@_attrs_define
class PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemActionsItem:
    """
    Attributes:
    ...
    community: Union[
        Unset, "PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_community, Unset):
            ...
            community = (
                PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity.from_dict(
                    _community
                )
            )
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_actions_item = cls(
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_actions_item.additional_properties = d
        return post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_actions_item
