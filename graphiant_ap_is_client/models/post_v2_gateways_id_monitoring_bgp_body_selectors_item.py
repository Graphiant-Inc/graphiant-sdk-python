...
T = TypeVar("T", bound="PostV2GatewaysIdMonitoringBgpBodySelectorsItem")


@_attrs_define
class PostV2GatewaysIdMonitoringBgpBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_gateways_id_monitoring_bgp_body_selectors_item = cls(
        ...
        post_v2_gateways_id_monitoring_bgp_body_selectors_item.additional_properties = d
        return post_v2_gateways_id_monitoring_bgp_body_selectors_item
