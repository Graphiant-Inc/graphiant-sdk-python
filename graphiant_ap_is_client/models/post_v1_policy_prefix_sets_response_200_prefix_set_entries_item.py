...
T = TypeVar("T", bound="PostV1PolicyPrefixSetsResponse200PrefixSetEntriesItem")


@_attrs_define
class PostV1PolicyPrefixSetsResponse200PrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_policy_prefix_sets_response_200_prefix_set_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        post_v1_policy_prefix_sets_response_200_prefix_set_entries_item.additional_properties = d
        return post_v1_policy_prefix_sets_response_200_prefix_set_entries_item
