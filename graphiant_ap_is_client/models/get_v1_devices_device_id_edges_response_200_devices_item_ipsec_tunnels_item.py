...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_ipsec_tunnels_item_bgp import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemBgp,
    )
    from ..models.get_v1_devices_device_id_edges_response_200_devices_item_ipsec_tunnels_item_static import (
        GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = GetV1DevicesDeviceIdEdgesResponse200DevicesItemIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        get_v1_devices_device_id_edges_response_200_devices_item_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_ipsec_tunnels_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_ipsec_tunnels_item
