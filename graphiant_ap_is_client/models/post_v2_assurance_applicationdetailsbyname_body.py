...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_applicationdetailsbyname_body_time_window import (
        PostV2AssuranceApplicationdetailsbynameBodyTimeWindow,
    )


T = TypeVar("T", bound="PostV2AssuranceApplicationdetailsbynameBody")


@_attrs_define
class PostV2AssuranceApplicationdetailsbynameBody:
    """
    Attributes:
        ...
        time_window (Union[Unset, PostV2AssuranceApplicationdetailsbynameBodyTimeWindow]):
    """

    app_id_key: Union[Unset, str] = UNSET
    app_name: Union[Unset, str] = UNSET
    bucket_id: Union[Unset, str] = UNSET
    time_window: Union[Unset, "PostV2AssuranceApplicationdetailsbynameBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV2AssuranceApplicationdetailsbynameBodyTimeWindow.from_dict(_time_window)

        post_v2_assurance_applicationdetailsbyname_body = cls(
        ...
        post_v2_assurance_applicationdetailsbyname_body.additional_properties = d
        return post_v2_assurance_applicationdetailsbyname_body
