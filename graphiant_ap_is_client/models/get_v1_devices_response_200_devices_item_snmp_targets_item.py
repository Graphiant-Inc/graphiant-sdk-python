...
T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemSnmpTargetsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemSnmpTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_response_200_devices_item_snmp_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        get_v1_devices_response_200_devices_item_snmp_targets_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_snmp_targets_item
