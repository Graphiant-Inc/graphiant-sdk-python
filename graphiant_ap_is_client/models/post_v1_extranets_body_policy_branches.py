...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_body_policy_branches_prefix_set import PostV1ExtranetsBodyPolicyBranchesPrefixSet


T = TypeVar("T", bound="PostV1ExtranetsBodyPolicyBranches")


@_attrs_define
class PostV1ExtranetsBodyPolicyBranches:
    """
    Attributes:
        excluded_devices (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
        prefix_set (Union[Unset, PostV1ExtranetsBodyPolicyBranchesPrefixSet]):
        sites (Union[Unset, list[str]]):  Example: ['TYPE_INT64'].
    """

    excluded_devices: Union[Unset, list[str]] = UNSET
    prefix_set: Union[Unset, "PostV1ExtranetsBodyPolicyBranchesPrefixSet"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.post_v1_extranets_body_policy_branches_prefix_set import (
        ...
        if isinstance(_prefix_set, Unset):
            ...
            prefix_set = PostV1ExtranetsBodyPolicyBranchesPrefixSet.from_dict(_prefix_set)

        sites = cast(list[str], d.pop("sites", UNSET))

        post_v1_extranets_body_policy_branches = cls(
            excluded_devices=excluded_devices,
            prefix_set=prefix_set,
            sites=sites,
        )

        post_v1_extranets_body_policy_branches.additional_properties = d
        return post_v1_extranets_body_policy_branches
