...
T = TypeVar("T", bound="PostV2MonitoringCircuitsStatusResponse200NetworkStatusSiteStatus")


@_attrs_define
class PostV2MonitoringCircuitsStatusResponse200NetworkStatusSiteStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_circuits_status_response_200_network_status_site_status = cls(
        ...
        post_v2_monitoring_circuits_status_response_200_network_status_site_status.additional_properties = d
        return post_v2_monitoring_circuits_status_response_200_network_status_site_status
