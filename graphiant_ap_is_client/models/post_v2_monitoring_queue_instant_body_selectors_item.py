...
T = TypeVar("T", bound="PostV2MonitoringQueueInstantBodySelectorsItem")


@_attrs_define
class PostV2MonitoringQueueInstantBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_queue_instant_body_selectors_item = cls(
            interface_name=interface_name,
            sla_class=sla_class,
            type_=type_,
        )

        post_v2_monitoring_queue_instant_body_selectors_item.additional_properties = d
        return post_v2_monitoring_queue_instant_body_selectors_item
