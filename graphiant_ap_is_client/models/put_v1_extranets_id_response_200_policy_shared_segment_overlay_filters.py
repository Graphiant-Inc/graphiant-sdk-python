...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicySharedSegmentOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        put_v1_extranets_id_response_200_policy_shared_segment_overlay_filters.additional_properties = d
        return put_v1_extranets_id_response_200_policy_shared_segment_overlay_filters
