...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftDnsCloudflareServersItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftDnsCloudflareServersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_dns_cloudflare_servers_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_dns_cloudflare_servers_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_dns_cloudflare_servers_item
