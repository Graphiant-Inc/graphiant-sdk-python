...
T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicyHostPrefixSetEntriesItem")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicyHostPrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_extranets_id_response_200_policy_host_prefix_set_entries_item = cls(
            ip_prefix=ip_prefix,
        ...
        put_v1_extranets_id_response_200_policy_host_prefix_set_entries_item.additional_properties = d
        return put_v1_extranets_id_response_200_policy_host_prefix_set_entries_item
