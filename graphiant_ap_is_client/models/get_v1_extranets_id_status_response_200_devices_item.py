...
T = TypeVar("T", bound="GetV1ExtranetsIdStatusResponse200DevicesItem")


@_attrs_define
class GetV1ExtranetsIdStatusResponse200DevicesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_status_response_200_devices_item = cls(
            device_id=device_id,
        ...
        get_v1_extranets_id_status_response_200_devices_item.additional_properties = d
        return get_v1_extranets_id_status_response_200_devices_item
