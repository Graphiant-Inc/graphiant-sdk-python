...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item_config_updated_at import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_4 import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6 import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item_oper_updated_at import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv6 (Union[Unset,
            PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubint
            erfacesItemIpv6AddressesItem']]):
    ...
    config_updated_at: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    ...
    ipv4: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4"
    ] = UNSET
    ipv6: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6"
    ] = UNSET
    ...
    oper_updated_at: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                _config_updated_at
            )
        ...
        ipv4: Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4]
        if isinstance(_ipv4, Unset):
            ipv4 = UNSET
        else:
            ipv4 = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv4.from_dict(
                    _ipv4
                )
            )

        _ipv6 = d.pop("ipv6", UNSET)
        ipv6: Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6]
        if isinstance(_ipv6, Unset):
            ipv6 = UNSET
        else:
            ipv6 = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6.from_dict(
                    _ipv6
                )
            )
        ...
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_subinterfaces_item
