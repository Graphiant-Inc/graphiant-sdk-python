...
if TYPE_CHECKING:
    from ..models.post_v1_apps_visualization_body_time_window import PostV1AppsVisualizationBodyTimeWindow


T = TypeVar("T", bound="PostV1AppsVisualizationBody")


@_attrs_define
class PostV1AppsVisualizationBody:
    """
    Attributes:
        ...
        time_window (Union[Unset, PostV1AppsVisualizationBodyTimeWindow]):
    """
    ...
    time_window: Union[Unset, "PostV1AppsVisualizationBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV1AppsVisualizationBodyTimeWindow.from_dict(_time_window)

        post_v1_apps_visualization_body = cls(
        ...
        post_v1_apps_visualization_body.additional_properties = d
        return post_v1_apps_visualization_body
