...
if TYPE_CHECKING:
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_communities_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemCommunitiesItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_engine_endpoints_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemEngineEndpointsItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_notify_filter_profiles_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemNotifyFilterProfilesItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_targets_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemTargetsItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_usm_local_users_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_usm_remote_users_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmRemoteUsersItem,
    )
    from ..models.get_v1_global_snmps_device_response_200_snmps_item_vacm_groups_item import (
        GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItem,
    )


T = TypeVar("T", bound="GetV1GlobalSnmpsDeviceResponse200SnmpsItem")


@_attrs_define
class GetV1GlobalSnmpsDeviceResponse200SnmpsItem:
    """
    Attributes:
        communities (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemTargetsItem']]):
        usm_local_users (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItem']]):
    """

    communities: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemCommunitiesItem"]] = UNSET
    ...
    engine_endpoints: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemEngineEndpointsItem"]] = UNSET
    ...
    notify_filter_profiles: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemNotifyFilterProfilesItem"]] = (
        UNSET
    )
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem"]] = UNSET
    usm_remote_users: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmRemoteUsersItem"]] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemCommunitiesItem.from_dict(
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemTargetsItem.from_dict(targets_item_data)
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = GetV1GlobalSnmpsDeviceResponse200SnmpsItemVacmGroupsItem.from_dict(vacm_groups_item_data)

            vacm_groups.append(vacm_groups_item)

        get_v1_global_snmps_device_response_200_snmps_item = cls(
        ...
        get_v1_global_snmps_device_response_200_snmps_item.additional_properties = d
        return get_v1_global_snmps_device_response_200_snmps_item
