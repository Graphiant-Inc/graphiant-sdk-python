...
T = TypeVar("T", bound="GetV1GlobalIpsecProfileIdResponse200IpsecProfile")


@_attrs_define
class GetV1GlobalIpsecProfileIdResponse200IpsecProfile:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_ipsec_profile_id_response_200_ipsec_profile = cls(
        ...
        get_v1_global_ipsec_profile_id_response_200_ipsec_profile.additional_properties = d
        return get_v1_global_ipsec_profile_id_response_200_ipsec_profile
