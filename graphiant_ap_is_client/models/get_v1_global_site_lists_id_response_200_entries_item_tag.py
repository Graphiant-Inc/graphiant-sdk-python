...
T = TypeVar("T", bound="GetV1GlobalSiteListsIdResponse200EntriesItemTag")


@_attrs_define
class GetV1GlobalSiteListsIdResponse200EntriesItemTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_site_lists_id_response_200_entries_item_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        get_v1_global_site_lists_id_response_200_entries_item_tag.additional_properties = d
        return get_v1_global_site_lists_id_response_200_entries_item_tag
