...
T = TypeVar("T", bound="PostV1BwtrackerEnterpriseSummaryResponse200BwusageSummaryBwusageRoleSummaryItem")


@_attrs_define
class PostV1BwtrackerEnterpriseSummaryResponse200BwusageSummaryBwusageRoleSummaryItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_bwtracker_enterprise_summary_response_200_bwusage_summary_bwusage_role_summary_item = cls(
            role_id=role_id,
            role_name=role_name,
            usage_kbps=usage_kbps,
        )

        post_v1_bwtracker_enterprise_summary_response_200_bwusage_summary_bwusage_role_summary_item.additional_properties = d
        return post_v1_bwtracker_enterprise_summary_response_200_bwusage_summary_bwusage_role_summary_item
