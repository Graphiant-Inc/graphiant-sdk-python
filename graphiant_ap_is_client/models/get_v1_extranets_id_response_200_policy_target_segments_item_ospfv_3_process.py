...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process_areas_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessAreasItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process_redistributed_protocols_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessRedistributedProtocolsItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3Process:
    """
    Attributes:
        admin_distance (Union[Unset, str]):  Example: 100.
        areas (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessAreasItem']]):
        default_originate (Union[Unset, str]):  Example: TYPE_ENUM.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        redistributed_protocols (Union[Unset,
            list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessRedistributedProtocolsItem']]):
    ...
    areas: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessAreasItem"]] = UNSET
    default_originate: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    redistributed_protocols: Union[
        Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessRedistributedProtocolsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for areas_item_data in _areas or []:
            areas_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessAreasItem.from_dict(
                areas_item_data
            )
        ...
        for redistributed_protocols_item_data in _redistributed_protocols or []:
            redistributed_protocols_item = (
                GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemOspfv3ProcessRedistributedProtocolsItem.from_dict(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process = cls(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item_ospfv_3_process
