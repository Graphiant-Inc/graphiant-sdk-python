...
T = TypeVar("T", bound="PutV1DevicesDeviceIdConfigBodyCoreSiteLocation")


@_attrs_define
class PutV1DevicesDeviceIdConfigBodyCoreSiteLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_device_id_config_body_core_site_location = cls(
        ...
        put_v1_devices_device_id_config_body_core_site_location.additional_properties = d
        return put_v1_devices_device_id_config_body_core_site_location
