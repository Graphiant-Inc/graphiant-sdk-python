...
T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegmentBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_bgp_redistributions.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment_bgp_redistributions
