...
T = TypeVar("T", bound="PatchV1GroupsIdBodyPermissions")


@_attrs_define
class PatchV1GroupsIdBodyPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        patch_v1_groups_id_body_permissions = cls(
        ...
        patch_v1_groups_id_body_permissions.additional_properties = d
        return patch_v1_groups_id_body_permissions
