...
T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSnmpEngineEndpointsItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSnmpEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_engine_endpoints_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_engine_endpoints_item
