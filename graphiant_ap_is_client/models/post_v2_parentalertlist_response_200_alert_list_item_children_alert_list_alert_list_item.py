...
if TYPE_CHECKING:
    from ..models.post_v2_parentalertlist_response_200_alert_list_item_children_alert_list_alert_list_item_children_alert_list import (
        PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItemChildrenAlertList,
    )


T = TypeVar("T", bound="PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItem")


@_attrs_define
class PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItem:
    """
    Attributes:
        ...
        children_alert_list (Union[Unset,
            PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItemChildrenAlertList]):
    ...
    children_alert_list: Union[
        Unset, "PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItemChildrenAlertList"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_children_alert_list, Unset):
            ...
            children_alert_list = (
                PostV2ParentalertlistResponse200AlertListItemChildrenAlertListAlertListItemChildrenAlertList.from_dict(
        ...
        post_v2_parentalertlist_response_200_alert_list_item_children_alert_list_alert_list_item = cls(
        ...
        post_v2_parentalertlist_response_200_alert_list_item_children_alert_list_alert_list_item.additional_properties = d
        return post_v2_parentalertlist_response_200_alert_list_item_children_alert_list_alert_list_item
