...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_b2b_id_producer_response_200_policy_policy_profiles_item import (
        GetV1ExtranetsB2BIdProducerResponse200PolicyPolicyProfilesItem,
    )
    from ..models.get_v1_extranets_b2b_id_producer_response_200_policy_policy_sites_item import (
        GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem,
    )
    from ..models.get_v1_extranets_b2b_id_producer_response_200_policy_policy_sla import (
        GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySla,
    )


T = TypeVar("T", bound="GetV1ExtranetsB2BIdProducerResponse200PolicyPolicy")


@_attrs_define
class GetV1ExtranetsB2BIdProducerResponse200PolicyPolicy:
    """
    Attributes:
        nat_pools (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        profiles (Union[Unset, list['GetV1ExtranetsB2BIdProducerResponse200PolicyPolicyProfilesItem']]):
        service_lan_segment (Union[Unset, str]):  Example: TYPE_INT64.
        service_prefixes (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        sites (Union[Unset, list['GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem']]):
        sla (Union[Unset, GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySla]):
        type_ (Union[Unset, str]):  Example: TYPE_ENUM.
    """

    nat_pools: Union[Unset, list[str]] = UNSET
    profiles: Union[Unset, list["GetV1ExtranetsB2BIdProducerResponse200PolicyPolicyProfilesItem"]] = UNSET
    service_lan_segment: Union[Unset, str] = UNSET
    service_prefixes: Union[Unset, list[str]] = UNSET
    sites: Union[Unset, list["GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem"]] = UNSET
    sla: Union[Unset, "GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySla"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for profiles_item_data in _profiles or []:
            profiles_item = GetV1ExtranetsB2BIdProducerResponse200PolicyPolicyProfilesItem.from_dict(profiles_item_data)
        ...
        for sites_item_data in _sites or []:
            sites_item = GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySitesItem.from_dict(sites_item_data)
        ...
        if isinstance(_sla, Unset):
            ...
            sla = GetV1ExtranetsB2BIdProducerResponse200PolicyPolicySla.from_dict(_sla)

        type_ = d.pop("type", UNSET)

        get_v1_extranets_b2b_id_producer_response_200_policy_policy = cls(
            nat_pools=nat_pools,
            profiles=profiles,
        ...
        get_v1_extranets_b2b_id_producer_response_200_policy_policy.additional_properties = d
        return get_v1_extranets_b2b_id_producer_response_200_policy_policy
