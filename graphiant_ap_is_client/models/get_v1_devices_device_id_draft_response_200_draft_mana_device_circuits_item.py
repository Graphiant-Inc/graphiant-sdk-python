...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_bgp_aggregations_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_bgp_multipath import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpMultipath,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_bgp_neighbors_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_bgp_redistributions import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_core_logical_interfaces_v2_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_profile import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemProfile,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_static_routes_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item_wan_interface_v2 import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpNeighborsItem']]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemProfile]):
        ...
        static_routes (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset, GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpNeighborsItem"]
    ] = UNSET
    bgp_redistributions: Union[
        Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpRedistributions"
    ] = UNSET
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemStaticRoutesItem"]
    ] = UNSET
    wan_interface_v2: Union[Unset, "GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemWanInterfaceV2"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpMultipath.from_dict(
                _bgp_multipath
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceCircuitsItemWanInterfaceV2.from_dict(
                _wan_interface_v2
            )

        get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_circuits_item
