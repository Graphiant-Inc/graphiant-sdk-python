...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemLocation")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_location = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_location.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_location
