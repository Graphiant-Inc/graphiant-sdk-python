...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_routing_policies_item_statements_item import (
        GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItemStatementsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = GetV1DevicesDeviceIdResponse200DeviceRoutingPoliciesItemStatementsItem.from_dict(
        ...
        get_v1_devices_device_id_response_200_device_routing_policies_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_routing_policies_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_routing_policies_item
