...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOverlayFilters")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSegmentsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_overlay_filters.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_segments_item_overlay_filters
