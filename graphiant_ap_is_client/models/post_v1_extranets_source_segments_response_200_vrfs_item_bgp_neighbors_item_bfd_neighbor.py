...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor_last_updated import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborLastUpdated,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor_time_in_state import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborTimeInState,
    )


T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor:
    """
    Attributes:
    ...
    last_updated: Union[
        Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborLastUpdated"
    ] = UNSET
    ...
    time_in_state: Union[
        Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborTimeInState"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_last_updated, Unset):
            ...
            last_updated = (
                PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborLastUpdated.from_dict(
                    _last_updated
                )
            )
        ...
        if isinstance(_time_in_state, Unset):
            ...
            time_in_state = (
                PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighborTimeInState.from_dict(
                    _time_in_state
                )
            )
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor = cls(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor
