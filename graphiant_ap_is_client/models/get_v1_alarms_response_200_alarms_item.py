...
if TYPE_CHECKING:
    from ..models.get_v1_alarms_response_200_alarms_item_created import GetV1AlarmsResponse200AlarmsItemCreated
    from ..models.get_v1_alarms_response_200_alarms_item_last_changed import GetV1AlarmsResponse200AlarmsItemLastChanged
    from ..models.get_v1_alarms_response_200_alarms_item_last_raised import GetV1AlarmsResponse200AlarmsItemLastRaised


T = TypeVar("T", bound="GetV1AlarmsResponse200AlarmsItem")


@_attrs_define
class GetV1AlarmsResponse200AlarmsItem:
    """
    Attributes:
        ...
        created (Union[Unset, GetV1AlarmsResponse200AlarmsItemCreated]):
        ...
        last_changed (Union[Unset, GetV1AlarmsResponse200AlarmsItemLastChanged]):
        last_raised (Union[Unset, GetV1AlarmsResponse200AlarmsItemLastRaised]):
    ...
    created: Union[Unset, "GetV1AlarmsResponse200AlarmsItemCreated"] = UNSET
    description: Union[Unset, str] = UNSET
    is_cleared: Union[Unset, str] = UNSET
    is_resolved: Union[Unset, str] = UNSET
    last_changed: Union[Unset, "GetV1AlarmsResponse200AlarmsItemLastChanged"] = UNSET
    last_raised: Union[Unset, "GetV1AlarmsResponse200AlarmsItemLastRaised"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        from ..models.get_v1_alarms_response_200_alarms_item_created import GetV1AlarmsResponse200AlarmsItemCreated
        from ..models.get_v1_alarms_response_200_alarms_item_last_changed import (
            GetV1AlarmsResponse200AlarmsItemLastChanged,
        )
        from ..models.get_v1_alarms_response_200_alarms_item_last_raised import (
        ...
        if isinstance(_created, Unset):
            ...
            created = GetV1AlarmsResponse200AlarmsItemCreated.from_dict(_created)
        ...
        if isinstance(_last_changed, Unset):
            ...
            last_changed = GetV1AlarmsResponse200AlarmsItemLastChanged.from_dict(_last_changed)
        ...
        if isinstance(_last_raised, Unset):
            ...
            last_raised = GetV1AlarmsResponse200AlarmsItemLastRaised.from_dict(_last_raised)
        ...
        get_v1_alarms_response_200_alarms_item = cls(
        ...
        get_v1_alarms_response_200_alarms_item.additional_properties = d
        return get_v1_alarms_response_200_alarms_item
