...
if TYPE_CHECKING:
    from ..models.get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_asexternal_lsa_tos_metric import (
        GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsaTosMetric,
    )


T = TypeVar("T", bound="GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsa")


@_attrs_define
class GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsa:
    """
    Attributes:
        ...
        tos_metric (Union[Unset, GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsaTosMetric]):
    """
    ...
    tos_metric: Union[Unset, "GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsaTosMetric"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_tos_metric, Unset):
            ...
            tos_metric = GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemAsexternalLsaTosMetric.from_dict(
                _tos_metric
            )

        get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_asexternal_lsa = cls(
        ...
        get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_asexternal_lsa.additional_properties = d
        return get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_asexternal_lsa
