...
if TYPE_CHECKING:
    from ..models.get_v1_device_snapshot_response_200_third_snapshot_author_permissions import (
        GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions,
    )


T = TypeVar("T", bound="GetV1DeviceSnapshotResponse200ThirdSnapshotAuthor")


@_attrs_define
class GetV1DeviceSnapshotResponse200ThirdSnapshotAuthor:
    """
    Attributes:
        ...
        permissions (Union[Unset, GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions]):
    ...
    permissions: Union[Unset, "GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_permissions, Unset):
            ...
            permissions = GetV1DeviceSnapshotResponse200ThirdSnapshotAuthorPermissions.from_dict(_permissions)

        time_zone = d.pop("timeZone", UNSET)

        user_id = d.pop("userId", UNSET)

        get_v1_device_snapshot_response_200_third_snapshot_author = cls(
        ...
        get_v1_device_snapshot_response_200_third_snapshot_author.additional_properties = d
        return get_v1_device_snapshot_response_200_third_snapshot_author
