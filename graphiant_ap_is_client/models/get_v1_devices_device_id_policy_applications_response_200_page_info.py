...
T = TypeVar("T", bound="GetV1DevicesDeviceIdPolicyApplicationsResponse200PageInfo")


@_attrs_define
class GetV1DevicesDeviceIdPolicyApplicationsResponse200PageInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_policy_applications_response_200_page_info = cls(
        ...
        get_v1_devices_device_id_policy_applications_response_200_page_info.additional_properties = d
        return get_v1_devices_device_id_policy_applications_response_200_page_info
