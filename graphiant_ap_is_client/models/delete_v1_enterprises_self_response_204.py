...
T = TypeVar("T", bound="DeleteV1EnterprisesSelfResponse204")


@_attrs_define
class DeleteV1EnterprisesSelfResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        delete_v1_enterprises_self_response_204 = cls(
            affected_users=affected_users,
            all_groups=all_groups,
        )

        delete_v1_enterprises_self_response_204.additional_properties = d
        return delete_v1_enterprises_self_response_204
