...
T = TypeVar("T", bound="PutV1DevicesUpgradeScheduleBodyTs")


@_attrs_define
class PutV1DevicesUpgradeScheduleBodyTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_upgrade_schedule_body_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        put_v1_devices_upgrade_schedule_body_ts.additional_properties = d
        return put_v1_devices_upgrade_schedule_body_ts
