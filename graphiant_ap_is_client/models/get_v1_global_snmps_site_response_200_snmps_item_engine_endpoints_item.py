...
T = TypeVar("T", bound="GetV1GlobalSnmpsSiteResponse200SnmpsItemEngineEndpointsItem")


@_attrs_define
class GetV1GlobalSnmpsSiteResponse200SnmpsItemEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_global_snmps_site_response_200_snmps_item_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        get_v1_global_snmps_site_response_200_snmps_item_engine_endpoints_item.additional_properties = d
        return get_v1_global_snmps_site_response_200_snmps_item_engine_endpoints_item
