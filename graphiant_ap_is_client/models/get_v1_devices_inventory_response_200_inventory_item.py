...
if TYPE_CHECKING:
    from ..models.get_v1_devices_inventory_response_200_inventory_item_assigned_on import (
        GetV1DevicesInventoryResponse200InventoryItemAssignedOn,
    )
    from ..models.get_v1_devices_inventory_response_200_inventory_item_created_on import (
        GetV1DevicesInventoryResponse200InventoryItemCreatedOn,
    )


T = TypeVar("T", bound="GetV1DevicesInventoryResponse200InventoryItem")


@_attrs_define
class GetV1DevicesInventoryResponse200InventoryItem:
    """
    Attributes:
        assigned_on (Union[Unset, GetV1DevicesInventoryResponse200InventoryItemAssignedOn]):
        created_on (Union[Unset, GetV1DevicesInventoryResponse200InventoryItemCreatedOn]):
    ...
    assigned_on: Union[Unset, "GetV1DevicesInventoryResponse200InventoryItemAssignedOn"] = UNSET
    created_on: Union[Unset, "GetV1DevicesInventoryResponse200InventoryItemCreatedOn"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_assigned_on, Unset):
            ...
            assigned_on = GetV1DevicesInventoryResponse200InventoryItemAssignedOn.from_dict(_assigned_on)
        ...
        if isinstance(_created_on, Unset):
            ...
            created_on = GetV1DevicesInventoryResponse200InventoryItemCreatedOn.from_dict(_created_on)
        ...
        get_v1_devices_inventory_response_200_inventory_item = cls(
        ...
        get_v1_devices_inventory_response_200_inventory_item.additional_properties = d
        return get_v1_devices_inventory_response_200_inventory_item
