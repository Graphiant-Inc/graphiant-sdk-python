...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item_leases_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item_nameservers import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item_ranges_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item_static_leases_item import (
        GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item = cls(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item_dhcp_subnets_item
