...
T = TypeVar("T", bound="PutV1DevicesDeviceIdConfigBodyEdgeBgpInstance")


@_attrs_define
class PutV1DevicesDeviceIdConfigBodyEdgeBgpInstance:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_devices_device_id_config_body_edge_bgp_instance = cls(
        ...
        put_v1_devices_device_id_config_body_edge_bgp_instance.additional_properties = d
        return put_v1_devices_device_id_config_body_edge_bgp_instance
