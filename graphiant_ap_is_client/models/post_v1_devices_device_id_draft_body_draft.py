...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_bgp import PostV1DevicesDeviceIdDraftBodyDraftBgp
    from ..models.post_v1_devices_device_id_draft_body_draft_circuits_item import (
        PostV1DevicesDeviceIdDraftBodyDraftCircuitsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_config_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftConfigUpdatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_created_at import (
        PostV1DevicesDeviceIdDraftBodyDraftCreatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_dns import PostV1DevicesDeviceIdDraftBodyDraftDns
    from ..models.post_v1_devices_device_id_draft_body_draft_interfaces_item import (
        PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_ipfix_exporters_item import (
        PostV1DevicesDeviceIdDraftBodyDraftIpfixExportersItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item import (
        PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_last_booted_at import (
        PostV1DevicesDeviceIdDraftBodyDraftLastBootedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_local_route_tag import (
        PostV1DevicesDeviceIdDraftBodyDraftLocalRouteTag,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_location import PostV1DevicesDeviceIdDraftBodyDraftLocation
    from ..models.post_v1_devices_device_id_draft_body_draft_nat_policy import (
        PostV1DevicesDeviceIdDraftBodyDraftNatPolicy,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_oper_staled_at import (
        PostV1DevicesDeviceIdDraftBodyDraftOperStaledAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_oper_updated_at import (
        PostV1DevicesDeviceIdDraftBodyDraftOperUpdatedAt,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_prefix_sets_item import (
        PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_region import PostV1DevicesDeviceIdDraftBodyDraftRegion
    from ..models.post_v1_devices_device_id_draft_body_draft_region_override import (
        PostV1DevicesDeviceIdDraftBodyDraftRegionOverride,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_routing_policies_item import (
        PostV1DevicesDeviceIdDraftBodyDraftRoutingPoliciesItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_segments_item import (
        PostV1DevicesDeviceIdDraftBodyDraftSegmentsItem,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_site import PostV1DevicesDeviceIdDraftBodyDraftSite
    from ..models.post_v1_devices_device_id_draft_body_draft_snmp import PostV1DevicesDeviceIdDraftBodyDraftSnmp
    from ..models.post_v1_devices_device_id_draft_body_draft_traffic_policy import (
        PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicy,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_uptime import PostV1DevicesDeviceIdDraftBodyDraftUptime


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraft")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraft:
    """
    Attributes:
        bgp (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftBgp]):
        bgp_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        circuits (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftCircuitsItem']]):
        config_updated_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftConfigUpdatedAt]):
        created_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftCreatedAt]):
        dhcp_server_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        dns (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftDns]):
        gdi (Union[Unset, str]):  Example: TYPE_UINT32.
        hostname (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        interfaces (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem']]):
        internal_state (Union[Unset, str]):  Example: TYPE_ENUM.
        ipfix_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        ipfix_exporters (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftIpfixExportersItem']]):
        ipsec_tunnels (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem']]):
        last_booted_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftLastBootedAt]):
        lldp_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        local_route_tag (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftLocalRouteTag]):
        local_web_server_password (Union[Unset, str]):  Example: TYPE_STRING.
        location (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftLocation]):
        maintenance_mode (Union[Unset, str]):  Example: TYPE_BOOL.
        nat_policy (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftNatPolicy]):
        notes (Union[Unset, str]):  Example: TYPE_STRING.
        oper_staled (Union[Unset, str]):  Example: TYPE_BOOL.
        oper_staled_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftOperStaledAt]):
        oper_updated_at (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftOperUpdatedAt]):
        ...
        prefix_sets (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItem']]):
        reboot_reason (Union[Unset, str]):  Example: TYPE_STRING.
        region (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftRegion]):
        region_override (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftRegionOverride]):
        role (Union[Unset, str]):  Example: TYPE_ENUM.
        routing_policies (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftRoutingPoliciesItem']]):
        segments (Union[Unset, list['PostV1DevicesDeviceIdDraftBodyDraftSegmentsItem']]):
        serial_number (Union[Unset, str]):  Example: TYPE_STRING.
        site (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftSite]):
        snmp (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftSnmp]):
        ...
        traffic_policy (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicy]):
        uptime (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftUptime]):
        vrrp_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
    """

    bgp: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftBgp"] = UNSET
    bgp_enabled: Union[Unset, str] = UNSET
    circuits: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftCircuitsItem"]] = UNSET
    config_updated_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftConfigUpdatedAt"] = UNSET
    created_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftCreatedAt"] = UNSET
    dhcp_server_enabled: Union[Unset, str] = UNSET
    dns: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftDns"] = UNSET
    gdi: Union[Unset, str] = UNSET
    hostname: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    interfaces: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem"]] = UNSET
    internal_state: Union[Unset, str] = UNSET
    ipfix_enabled: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftIpfixExportersItem"]] = UNSET
    ipsec_tunnels: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem"]] = UNSET
    last_booted_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftLastBootedAt"] = UNSET
    lldp_enabled: Union[Unset, str] = UNSET
    local_route_tag: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftLocalRouteTag"] = UNSET
    local_web_server_password: Union[Unset, str] = UNSET
    location: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftLocation"] = UNSET
    maintenance_mode: Union[Unset, str] = UNSET
    nat_policy: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftNatPolicy"] = UNSET
    notes: Union[Unset, str] = UNSET
    oper_staled: Union[Unset, str] = UNSET
    oper_staled_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftOperStaledAt"] = UNSET
    oper_updated_at: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftOperUpdatedAt"] = UNSET
    ospfv_2_enabled: Union[Unset, str] = UNSET
    ospfv_3_enabled: Union[Unset, str] = UNSET
    platform: Union[Unset, str] = UNSET
    prefix_sets: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItem"]] = UNSET
    reboot_reason: Union[Unset, str] = UNSET
    region: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftRegion"] = UNSET
    region_override: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftRegionOverride"] = UNSET
    role: Union[Unset, str] = UNSET
    routing_policies: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftRoutingPoliciesItem"]] = UNSET
    segments: Union[Unset, list["PostV1DevicesDeviceIdDraftBodyDraftSegmentsItem"]] = UNSET
    serial_number: Union[Unset, str] = UNSET
    site: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftSite"] = UNSET
    snmp: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftSnmp"] = UNSET
    software_version: Union[Unset, str] = UNSET
    static_routes_enabled: Union[Unset, str] = UNSET
    status: Union[Unset, str] = UNSET
    traffic_policy: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicy"] = UNSET
    uptime: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftUptime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        from ..models.post_v1_devices_device_id_draft_body_draft_location import (
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = PostV1DevicesDeviceIdDraftBodyDraftBgp.from_dict(_bgp)
        ...
        for circuits_item_data in _circuits or []:
            circuits_item = PostV1DevicesDeviceIdDraftBodyDraftCircuitsItem.from_dict(circuits_item_data)
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = PostV1DevicesDeviceIdDraftBodyDraftConfigUpdatedAt.from_dict(_config_updated_at)
        ...
        if isinstance(_created_at, Unset):
            ...
            created_at = PostV1DevicesDeviceIdDraftBodyDraftCreatedAt.from_dict(_created_at)
        ...
        if isinstance(_dns, Unset):
            ...
            dns = PostV1DevicesDeviceIdDraftBodyDraftDns.from_dict(_dns)
        ...
        for interfaces_item_data in _interfaces or []:
            interfaces_item = PostV1DevicesDeviceIdDraftBodyDraftInterfacesItem.from_dict(interfaces_item_data)
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = PostV1DevicesDeviceIdDraftBodyDraftIpfixExportersItem.from_dict(
        ...
        for ipsec_tunnels_item_data in _ipsec_tunnels or []:
            ipsec_tunnels_item = PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem.from_dict(ipsec_tunnels_item_data)
        ...
        if isinstance(_last_booted_at, Unset):
            ...
            last_booted_at = PostV1DevicesDeviceIdDraftBodyDraftLastBootedAt.from_dict(_last_booted_at)
        ...
        if isinstance(_local_route_tag, Unset):
            ...
            local_route_tag = PostV1DevicesDeviceIdDraftBodyDraftLocalRouteTag.from_dict(_local_route_tag)
        ...
        if isinstance(_location, Unset):
            ...
            location = PostV1DevicesDeviceIdDraftBodyDraftLocation.from_dict(_location)
        ...
        if isinstance(_nat_policy, Unset):
            ...
            nat_policy = PostV1DevicesDeviceIdDraftBodyDraftNatPolicy.from_dict(_nat_policy)
        ...
        if isinstance(_oper_staled_at, Unset):
            ...
            oper_staled_at = PostV1DevicesDeviceIdDraftBodyDraftOperStaledAt.from_dict(_oper_staled_at)
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = PostV1DevicesDeviceIdDraftBodyDraftOperUpdatedAt.from_dict(_oper_updated_at)
        ...
        for prefix_sets_item_data in _prefix_sets or []:
            prefix_sets_item = PostV1DevicesDeviceIdDraftBodyDraftPrefixSetsItem.from_dict(prefix_sets_item_data)
        ...
        if isinstance(_region, Unset):
            ...
            region = PostV1DevicesDeviceIdDraftBodyDraftRegion.from_dict(_region)
        ...
        if isinstance(_region_override, Unset):
            ...
            region_override = PostV1DevicesDeviceIdDraftBodyDraftRegionOverride.from_dict(_region_override)
        ...
        for routing_policies_item_data in _routing_policies or []:
            routing_policies_item = PostV1DevicesDeviceIdDraftBodyDraftRoutingPoliciesItem.from_dict(
        ...
        for segments_item_data in _segments or []:
            segments_item = PostV1DevicesDeviceIdDraftBodyDraftSegmentsItem.from_dict(segments_item_data)
        ...
        if isinstance(_site, Unset):
            ...
            site = PostV1DevicesDeviceIdDraftBodyDraftSite.from_dict(_site)
        ...
        if isinstance(_snmp, Unset):
            ...
            snmp = PostV1DevicesDeviceIdDraftBodyDraftSnmp.from_dict(_snmp)
        ...
        if isinstance(_traffic_policy, Unset):
            ...
            traffic_policy = PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicy.from_dict(_traffic_policy)
        ...
        if isinstance(_uptime, Unset):
            ...
            uptime = PostV1DevicesDeviceIdDraftBodyDraftUptime.from_dict(_uptime)

        vrrp_enabled = d.pop("vrrpEnabled", UNSET)

        post_v1_devices_device_id_draft_body_draft = cls(
            bgp=bgp,
        ...
        post_v1_devices_device_id_draft_body_draft.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft
