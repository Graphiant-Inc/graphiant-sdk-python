...
T = TypeVar("T", bound="PostV2IntegrationResponse200IntegrationDetails")


@_attrs_define
class PostV2IntegrationResponse200IntegrationDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_integration_response_200_integration_details = cls(
            opsgenie_key=opsgenie_key,
            opsramp_details=opsramp_details,
            webhook_url=webhook_url,
        )

        post_v2_integration_response_200_integration_details.additional_properties = d
        return post_v2_integration_response_200_integration_details
