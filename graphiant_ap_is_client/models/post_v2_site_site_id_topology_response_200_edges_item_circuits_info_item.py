...
if TYPE_CHECKING:
    from ..models.post_v2_site_site_id_topology_response_200_edges_item_circuits_info_item_uptime import (
        PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItemUptime,
    )


T = TypeVar("T", bound="PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItem")


@_attrs_define
class PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItem:
    """
    Attributes:
        ...
        uptime (Union[Unset, PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItemUptime]):
    """
    ...
    uptime: Union[Unset, "PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItemUptime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_uptime, Unset):
            ...
            uptime = PostV2SiteSiteIdTopologyResponse200EdgesItemCircuitsInfoItemUptime.from_dict(_uptime)

        post_v2_site_site_id_topology_response_200_edges_item_circuits_info_item = cls(
        ...
        post_v2_site_site_id_topology_response_200_edges_item_circuits_info_item.additional_properties = d
        return post_v2_site_site_id_topology_response_200_edges_item_circuits_info_item
