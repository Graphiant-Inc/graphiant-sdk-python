...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_engine_endpoints_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_engine_endpoints_item
