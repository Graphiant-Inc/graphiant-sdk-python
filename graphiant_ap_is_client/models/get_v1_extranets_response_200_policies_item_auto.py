...
T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemAuto")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemAuto:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_response_200_policies_item_auto = cls(
            auto_propagate=auto_propagate,
            excluded_prefixes=excluded_prefixes,
        )

        get_v1_extranets_response_200_policies_item_auto.additional_properties = d
        return get_v1_extranets_response_200_policies_item_auto
