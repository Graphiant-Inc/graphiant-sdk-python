...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item_config_updated_at import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item_ipv_4 import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv4,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item_ipv_6 import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item_ipv_6_addresses_item import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item_oper_updated_at import (
        GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemOperUpdatedAt,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItem:
    """
    Attributes:
        ...
        ipv4 (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6AddressesItem']]):
    ...
    config_updated_at: Union[
        Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemConfigUpdatedAt"
    ] = UNSET
    description: Union[Unset, str] = UNSET
    duplex: Union[Unset, str] = UNSET
    enabled: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipv4: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    oper_updated_at: Union[
        Unset, "GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemOperUpdatedAt"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = (
                GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemIpv6AddressesItem.from_dict(
        ...
        oper_updated_at: Union[Unset, GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemOperUpdatedAt]
        if isinstance(_oper_updated_at, Unset):
            oper_updated_at = UNSET
        else:
            oper_updated_at = (
                GetV1DevicesDeviceIdResponse200DeviceInterfacesItemSubinterfacesItemOperUpdatedAt.from_dict(
                    _oper_updated_at
                )
            )
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_interfaces_item_subinterfaces_item
