...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_ip_sec_established_time import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemIpSecEstablishedTime,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemIpSec")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemIpSec:
    """
    Attributes:
    ...
    established_time: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemIpSecEstablishedTime"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_established_time, Unset):
            ...
            established_time = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemInterfacesItemIpSecEstablishedTime.from_dict(
                    _established_time
                )
            )
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_ip_sec = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_ip_sec.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_interfaces_item_ip_sec
