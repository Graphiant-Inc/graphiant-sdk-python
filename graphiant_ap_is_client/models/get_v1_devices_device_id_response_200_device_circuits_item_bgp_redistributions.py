...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceCircuitsItemBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_circuits_item_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        get_v1_devices_device_id_response_200_device_circuits_item_bgp_redistributions.additional_properties = d
        return get_v1_devices_device_id_response_200_device_circuits_item_bgp_redistributions
