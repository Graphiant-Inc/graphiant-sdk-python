...
T = TypeVar("T", bound="PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem")


@_attrs_define
class PostV1GlobalSnmpsResponse200SnmpsItemTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_snmps_response_200_snmps_item_targets_item = cls(
            community=community,
            id=id,
            name=name,
        ...
        post_v1_global_snmps_response_200_snmps_item_targets_item.additional_properties = d
        return post_v1_global_snmps_response_200_snmps_item_targets_item
