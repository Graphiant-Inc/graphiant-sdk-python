...
T = TypeVar("T", bound="PostV1AuditLogsBodyRecentTs")


@_attrs_define
class PostV1AuditLogsBodyRecentTs:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_logs_body_recent_ts = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_logs_body_recent_ts.additional_properties = d
        return post_v1_audit_logs_body_recent_ts
