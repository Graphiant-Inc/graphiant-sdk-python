...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_snmp_usm_local_users_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_snmp_usm_local_users_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_snmp_usm_local_users_item
