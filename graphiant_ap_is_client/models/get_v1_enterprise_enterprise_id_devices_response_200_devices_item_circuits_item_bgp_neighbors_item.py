...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_address_families_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset, list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeig
            hborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd]):
    ...
    address_families: Union[
        Unset,
        list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem"],
    ] = UNSET
    bfd: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd.from_dict(
                _bfd
            )
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_circuits_item_bgp_neighbors_item
