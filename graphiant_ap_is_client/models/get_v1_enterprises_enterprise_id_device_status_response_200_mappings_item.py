...
if TYPE_CHECKING:
    from ..models.get_v1_enterprises_enterprise_id_device_status_response_200_mappings_item_connect_time import (
        GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItemConnectTime,
    )


T = TypeVar("T", bound="GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItem")


@_attrs_define
class GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItem:
    """
    Attributes:
        connect_time (Union[Unset, GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItemConnectTime]):
    ...
    connect_time: Union[Unset, "GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItemConnectTime"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_connect_time, Unset):
            ...
            connect_time = GetV1EnterprisesEnterpriseIdDeviceStatusResponse200MappingsItemConnectTime.from_dict(
                _connect_time
            )
        ...
        get_v1_enterprises_enterprise_id_device_status_response_200_mappings_item = cls(
        ...
        get_v1_enterprises_enterprise_id_device_status_response_200_mappings_item.additional_properties = d
        return get_v1_enterprises_enterprise_id_device_status_response_200_mappings_item
