...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceDnsStaticServersItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceDnsStaticServersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_dns_static_servers_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_dns_static_servers_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_dns_static_servers_item
