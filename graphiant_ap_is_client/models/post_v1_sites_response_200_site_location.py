...
T = TypeVar("T", bound="PostV1SitesResponse200SiteLocation")


@_attrs_define
class PostV1SitesResponse200SiteLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_sites_response_200_site_location = cls(
        ...
        post_v1_sites_response_200_site_location.additional_properties = d
        return post_v1_sites_response_200_site_location
