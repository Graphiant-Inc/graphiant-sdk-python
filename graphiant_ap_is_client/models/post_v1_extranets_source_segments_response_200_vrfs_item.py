...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_aggregations_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpAggregationsItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_multipath import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpMultipath,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_redistributions import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_dhcp_subnets_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemDhcpSubnetsItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_ipfix_exporters_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_2_process import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv2Process,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_overlay_filters import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_static_routes_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_syslog_targets_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItem")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process]):
        overlay_filters (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters.from_dict(_overlay_filters)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemSyslogTargetsItem.from_dict(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item = cls(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item
