...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_communities_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpCommunitiesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_engine_endpoints_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_notify_filter_profiles_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpNotifyFilterProfilesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_targets_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpTargetsItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_usm_local_users_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmLocalUsersItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_usm_remote_users_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmRemoteUsersItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp_vacm_groups_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmp")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmp:
    """
    Attributes:
        communities (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpTargetsItem']]):
        usm_local_users (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset,
            list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpVacmGroupsItem']]):
    """
    ...
    engine_endpoints: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem"]
    ] = UNSET
    ...
    notify_filter_profiles: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpNotifyFilterProfilesItem"]
    ] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmLocalUsersItem"]
    ] = UNSET
    usm_remote_users: Union[
        Unset, list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmRemoteUsersItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpCommunitiesItem.from_dict(
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpTargetsItem.from_dict(
                targets_item_data
            )
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = (
                PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemSnmpVacmGroupsItem.from_dict(
                vacm_groups_item_data
            )

            vacm_groups.append(vacm_groups_item)

        post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_snmp
