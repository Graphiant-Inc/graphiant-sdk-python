...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicyDpiApplicationsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftTrafficPolicyDpiApplicationsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_traffic_policy_dpi_applications_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_traffic_policy_dpi_applications_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_traffic_policy_dpi_applications_item
