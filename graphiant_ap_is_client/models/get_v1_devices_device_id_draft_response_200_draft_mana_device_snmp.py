...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_communities_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpCommunitiesItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_engine_endpoints_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpEngineEndpointsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_notify_filter_profiles_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpNotifyFilterProfilesItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_targets_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpTargetsItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_usm_local_users_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmLocalUsersItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_usm_remote_users_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmRemoteUsersItem,
    )
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp_vacm_groups_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmp")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmp:
    """
    Attributes:
        communities (Union[Unset, list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpTargetsItem']]):
        usm_local_users (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpVacmGroupsItem']]):
    """

    communities: Union[Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpCommunitiesItem"]] = UNSET
    ...
    engine_endpoints: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpEngineEndpointsItem"]
    ] = UNSET
    ...
    notify_filter_profiles: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpNotifyFilterProfilesItem"]
    ] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmLocalUsersItem"]] = (
        UNSET
    )
    usm_remote_users: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmRemoteUsersItem"]
    ] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpCommunitiesItem.from_dict(
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpTargetsItem.from_dict(
                targets_item_data
            )
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceSnmpVacmGroupsItem.from_dict(
                vacm_groups_item_data
            )

            vacm_groups.append(vacm_groups_item)

        get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_snmp
