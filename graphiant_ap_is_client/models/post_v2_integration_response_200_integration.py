...
if TYPE_CHECKING:
    from ..models.post_v2_integration_response_200_integration_details import (
        PostV2IntegrationResponse200IntegrationDetails,
    )


T = TypeVar("T", bound="PostV2IntegrationResponse200Integration")


@_attrs_define
class PostV2IntegrationResponse200Integration:
    """
    Attributes:
        created_by (Union[Unset, str]):  Example: TYPE_STRING.
        created_on (Union[Unset, str]):  Example: TYPE_STRING.
        details (Union[Unset, PostV2IntegrationResponse200IntegrationDetails]):
    ...
    details: Union[Unset, "PostV2IntegrationResponse200IntegrationDetails"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_details, Unset):
            ...
            details = PostV2IntegrationResponse200IntegrationDetails.from_dict(_details)
        ...
        post_v2_integration_response_200_integration = cls(
        ...
        post_v2_integration_response_200_integration.additional_properties = d
        return post_v2_integration_response_200_integration
