...
T = TypeVar("T", bound="GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation")


@_attrs_define
class GetV1EdgesHardwareAssignedResponse200EdgesSummaryItemLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_edges_hardware_assigned_response_200_edges_summary_item_location = cls(
        ...
        get_v1_edges_hardware_assigned_response_200_edges_summary_item_location.additional_properties = d
        return get_v1_edges_hardware_assigned_response_200_edges_summary_item_location
