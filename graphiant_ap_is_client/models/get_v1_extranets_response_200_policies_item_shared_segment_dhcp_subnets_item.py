...
if TYPE_CHECKING:
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item_leases_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemLeasesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item_nameservers import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemNameservers,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item_ranges_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemRangesItem,
    )
    from ..models.get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item_static_leases_item import (
        GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                GetV1ExtranetsResponse200PoliciesItemSharedSegmentDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item = cls(
        ...
        get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_shared_segment_dhcp_subnets_item
