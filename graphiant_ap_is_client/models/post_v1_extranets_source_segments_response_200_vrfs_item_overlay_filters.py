...
T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemOverlayFilters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_overlay_filters = cls(
            inbound_filter=inbound_filter,
            outbound_filter=outbound_filter,
        )

        post_v1_extranets_source_segments_response_200_vrfs_item_overlay_filters.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_overlay_filters
