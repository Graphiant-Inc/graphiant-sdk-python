...
T = TypeVar("T", bound="GetV1DeviceRoutingOspfv2AreaInterfaceNbridResponse200PageInfo")


@_attrs_define
class GetV1DeviceRoutingOspfv2AreaInterfaceNbridResponse200PageInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_routing_ospfv_2_area_interface_nbrid_response_200_page_info = cls(
        ...
        get_v1_device_routing_ospfv_2_area_interface_nbrid_response_200_page_info.additional_properties = d
        return get_v1_device_routing_ospfv_2_area_interface_nbrid_response_200_page_info
