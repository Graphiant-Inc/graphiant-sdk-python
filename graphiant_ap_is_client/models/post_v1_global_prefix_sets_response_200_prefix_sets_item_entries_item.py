...
T = TypeVar("T", bound="PostV1GlobalPrefixSetsResponse200PrefixSetsItemEntriesItem")


@_attrs_define
class PostV1GlobalPrefixSetsResponse200PrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_prefix_sets_response_200_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        post_v1_global_prefix_sets_response_200_prefix_sets_item_entries_item.additional_properties = d
        return post_v1_global_prefix_sets_response_200_prefix_sets_item_entries_item
