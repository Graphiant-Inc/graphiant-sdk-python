...
T = TypeVar("T", bound="PostV1DiagnosticPingResponse200ResultRouteInfo")


@_attrs_define
class PostV1DiagnosticPingResponse200ResultRouteInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_diagnostic_ping_response_200_result_route_info = cls(
            nexthop_address=nexthop_address,
            outgoing_interface=outgoing_interface,
            prefix=prefix,
        )

        post_v1_diagnostic_ping_response_200_result_route_info.additional_properties = d
        return post_v1_diagnostic_ping_response_200_result_route_info
