...
if TYPE_CHECKING:
    from ..models.get_v1_global_traffic_policies_site_response_200_traffic_policy_security_rulesets_item_rules_item_match import (
        GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch,
    )


T = TypeVar("T", bound="GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicySecurityRulesetsItemRulesItem")


@_attrs_define
class GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicySecurityRulesetsItemRulesItem:
    """
    Attributes:
        ...
        match (Union[Unset, GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_match, Unset):
            ...
            match = GetV1GlobalTrafficPoliciesSiteResponse200TrafficPolicySecurityRulesetsItemRulesItemMatch.from_dict(
                _match
            )
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_security_rulesets_item_rules_item = cls(
            action=action,
        ...
        get_v1_global_traffic_policies_site_response_200_traffic_policy_security_rulesets_item_rules_item.additional_properties = d
        return get_v1_global_traffic_policies_site_response_200_traffic_policy_security_rulesets_item_rules_item
