...
T = TypeVar("T", bound="GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemNetworkLsa")


@_attrs_define
class GetV1DeviceRoutingOspfv2AreaLsdbResponse200LsasItemNetworkLsa:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_network_lsa = cls(
            attached_routers=attached_routers,
            network_mask=network_mask,
        )

        get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_network_lsa.additional_properties = d
        return get_v1_device_routing_ospfv_2_area_lsdb_response_200_lsas_item_network_lsa
