...
T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItemNextHop")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemStaticRoutesItemNextHop:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hop = cls(
            circuit=circuit,
            id=id,
            metric=metric,
        ...
        get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hop.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_static_routes_item_next_hop
