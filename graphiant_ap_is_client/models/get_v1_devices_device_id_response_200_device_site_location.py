...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSiteLocation")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSiteLocation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_site_location = cls(
        ...
        get_v1_devices_device_id_response_200_device_site_location.additional_properties = d
        return get_v1_devices_device_id_response_200_device_site_location
