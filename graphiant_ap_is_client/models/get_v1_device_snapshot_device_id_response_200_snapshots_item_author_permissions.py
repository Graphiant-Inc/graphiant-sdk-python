...
T = TypeVar("T", bound="GetV1DeviceSnapshotDeviceIdResponse200SnapshotsItemAuthorPermissions")


@_attrs_define
class GetV1DeviceSnapshotDeviceIdResponse200SnapshotsItemAuthorPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_device_snapshot_device_id_response_200_snapshots_item_author_permissions = cls(
        ...
        get_v1_device_snapshot_device_id_response_200_snapshots_item_author_permissions.additional_properties = d
        return get_v1_device_snapshot_device_id_response_200_snapshots_item_author_permissions
