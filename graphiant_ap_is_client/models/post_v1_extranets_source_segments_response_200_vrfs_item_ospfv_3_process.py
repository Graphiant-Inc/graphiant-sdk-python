...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process_areas_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessAreasItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process_redistributed_protocols_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessRedistributedProtocolsItem,
    )


T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3Process:
    """
    Attributes:
        admin_distance (Union[Unset, str]):  Example: 100.
        areas (Union[Unset, list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessAreasItem']]):
        default_originate (Union[Unset, str]):  Example: TYPE_ENUM.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        redistributed_protocols (Union[Unset,
            list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessRedistributedProtocolsItem']]):
    ...
    areas: Union[Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessAreasItem"]] = UNSET
    default_originate: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    redistributed_protocols: Union[
        Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessRedistributedProtocolsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for areas_item_data in _areas or []:
            areas_item = PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessAreasItem.from_dict(
                areas_item_data
            )
        ...
        for redistributed_protocols_item_data in _redistributed_protocols or []:
            redistributed_protocols_item = (
                PostV1ExtranetsSourceSegmentsResponse200VrfsItemOspfv3ProcessRedistributedProtocolsItem.from_dict(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process = cls(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_ospfv_3_process
