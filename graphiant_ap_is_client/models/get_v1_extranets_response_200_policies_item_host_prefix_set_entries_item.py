...
T = TypeVar("T", bound="GetV1ExtranetsResponse200PoliciesItemHostPrefixSetEntriesItem")


@_attrs_define
class GetV1ExtranetsResponse200PoliciesItemHostPrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_response_200_policies_item_host_prefix_set_entries_item = cls(
            ip_prefix=ip_prefix,
        ...
        get_v1_extranets_response_200_policies_item_host_prefix_set_entries_item.additional_properties = d
        return get_v1_extranets_response_200_policies_item_host_prefix_set_entries_item
