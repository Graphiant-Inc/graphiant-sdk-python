...
T = TypeVar("T", bound="PostV1AuditCompleteBodyEntryStart")


@_attrs_define
class PostV1AuditCompleteBodyEntryStart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_complete_body_entry_start = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_complete_body_entry_start.additional_properties = d
        return post_v1_audit_complete_body_entry_start
