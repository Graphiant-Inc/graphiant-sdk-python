...
T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemWanInterfaceV2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_wan_interface_v2 = cls(
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_wan_interface_v2.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_wan_interface_v2
