...
T = TypeVar("T", bound="PostV2AssuranceApplicationdetailsbynameResponse200AppIdRecord")


@_attrs_define
class PostV2AssuranceApplicationdetailsbynameResponse200AppIdRecord:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_applicationdetailsbyname_response_200_app_id_record = cls(
        ...
        post_v2_assurance_applicationdetailsbyname_response_200_app_id_record.additional_properties = d
        return post_v2_assurance_applicationdetailsbyname_response_200_app_id_record
