...
T = TypeVar("T", bound="PostV2AssuranceTopologySiteSummariesBodyFilter")


@_attrs_define
class PostV2AssuranceTopologySiteSummariesBodyFilter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_assurance_topology_site_summaries_body_filter = cls(
            client_site_ids=client_site_ids,
            region_ids=region_ids,
            server_site_ids=server_site_ids,
        )

        post_v2_assurance_topology_site_summaries_body_filter.additional_properties = d
        return post_v2_assurance_topology_site_summaries_body_filter
