...
T = TypeVar("T", bound="GetV1AlarmsResponse200AlarmsItemCreated")


@_attrs_define
class GetV1AlarmsResponse200AlarmsItemCreated:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_alarms_response_200_alarms_item_created = cls(
            nanos=nanos,
            seconds=seconds,
        )

        get_v1_alarms_response_200_alarms_item_created.additional_properties = d
        return get_v1_alarms_response_200_alarms_item_created
