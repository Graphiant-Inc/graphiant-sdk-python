...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_response_200_device_snmp_communities_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpCommunitiesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_engine_endpoints_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_notify_filter_profiles_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpNotifyFilterProfilesItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_targets_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_usm_local_users_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_usm_remote_users_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem,
    )
    from ..models.get_v1_devices_device_id_response_200_device_snmp_vacm_groups_item import (
        GetV1DevicesDeviceIdResponse200DeviceSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSnmp")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSnmp:
    """
    Attributes:
        communities (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['GetV1DevicesDeviceIdResponse200DeviceSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem']]):
        usm_local_users (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset, list['GetV1DevicesDeviceIdResponse200DeviceSnmpVacmGroupsItem']]):
    """

    communities: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpCommunitiesItem"]] = UNSET
    ...
    engine_endpoints: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem"]] = UNSET
    ...
    notify_filter_profiles: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpNotifyFilterProfilesItem"]] = (
        UNSET
    )
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem"]] = UNSET
    usm_remote_users: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem"]] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[Unset, list["GetV1DevicesDeviceIdResponse200DeviceSnmpVacmGroupsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = GetV1DevicesDeviceIdResponse200DeviceSnmpCommunitiesItem.from_dict(communities_item_data)
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = GetV1DevicesDeviceIdResponse200DeviceSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = GetV1DevicesDeviceIdResponse200DeviceSnmpTargetsItem.from_dict(targets_item_data)
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = GetV1DevicesDeviceIdResponse200DeviceSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = GetV1DevicesDeviceIdResponse200DeviceSnmpVacmGroupsItem.from_dict(vacm_groups_item_data)

            vacm_groups.append(vacm_groups_item)

        get_v1_devices_device_id_response_200_device_snmp = cls(
        ...
        get_v1_devices_device_id_response_200_device_snmp.additional_properties = d
        return get_v1_devices_device_id_response_200_device_snmp
