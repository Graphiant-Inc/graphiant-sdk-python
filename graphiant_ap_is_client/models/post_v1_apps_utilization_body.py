...
if TYPE_CHECKING:
    from ..models.post_v1_apps_utilization_body_time_window import PostV1AppsUtilizationBodyTimeWindow


T = TypeVar("T", bound="PostV1AppsUtilizationBody")


@_attrs_define
class PostV1AppsUtilizationBody:
    """
    Attributes:
        ...
        time_window (Union[Unset, PostV1AppsUtilizationBodyTimeWindow]):
    """
    ...
    time_window: Union[Unset, "PostV1AppsUtilizationBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV1AppsUtilizationBodyTimeWindow.from_dict(_time_window)

        post_v1_apps_utilization_body = cls(
        ...
        post_v1_apps_utilization_body.additional_properties = d
        return post_v1_apps_utilization_body
