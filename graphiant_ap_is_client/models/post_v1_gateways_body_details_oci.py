...
T = TypeVar("T", bound="PostV1GatewaysBodyDetailsOci")


@_attrs_define
class PostV1GatewaysBodyDetailsOci:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_gateways_body_details_oci = cls(
            description=description,
            fast_connect_ocid=fast_connect_ocid,
            routing_policy=routing_policy,
        )

        post_v1_gateways_body_details_oci.additional_properties = d
        return post_v1_gateways_body_details_oci
