...
if TYPE_CHECKING:
    from ..models.post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_bgp import (
        PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp,
    )
    from ..models.post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item_static import (
        PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = PostV1DevicesDeviceIdDraftBodyDraftIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_ipsec_tunnels_item
