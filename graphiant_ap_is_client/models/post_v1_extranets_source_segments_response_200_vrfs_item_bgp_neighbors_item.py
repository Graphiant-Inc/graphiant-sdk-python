...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_address_families_item import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_bfd_neighbor import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem")


@_attrs_define
class PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset,
            list['PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset, PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset, list["PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemAddressFamiliesItem"]
    ] = UNSET
    bfd: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor"] = UNSET
    ...
    time_since_last_oper_change: Union[
        Unset, "PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemTimeSinceLastOperChange"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = (
                PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfd.from_dict(_bfd)
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = (
                PostV1ExtranetsSourceSegmentsResponse200VrfsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item = cls(
        ...
        post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item.additional_properties = d
        return post_v1_extranets_source_segments_response_200_vrfs_item_bgp_neighbors_item
