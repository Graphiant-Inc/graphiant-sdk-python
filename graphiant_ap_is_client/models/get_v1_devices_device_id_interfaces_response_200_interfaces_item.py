...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_config_updated_at import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ip_sec import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_4 import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6 import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_ipv_6_addresses_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_oper_updated_at import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemOperUpdatedAt,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_sfp_optical_strength_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem,
    )
    from ..models.get_v1_devices_device_id_interfaces_response_200_interfaces_item_subinterfaces_item import (
        GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSubinterfacesItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdInterfacesResponse200InterfacesItem")


@_attrs_define
class GetV1DevicesDeviceIdInterfacesResponse200InterfacesItem:
    """
    Attributes:
        ...
        config_updated_at (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemConfigUpdatedAt]):
        ...
        ip_sec (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec]):
        ipv4 (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItem']]):
        ...
        oper_updated_at (Union[Unset, GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemOperUpdatedAt]):
        ...
        sfp_optical_strength (Union[Unset,
            list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem']]):
        speed_mbps (Union[Unset, str]):  Example: TYPE_UINT32.
        subinterfaces (Union[Unset, list['GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSubinterfacesItem']]):
    ...
    config_updated_at: Union[Unset, "GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemConfigUpdatedAt"] = UNSET
    ...
    ip_sec: Union[Unset, "GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec"] = UNSET
    ipv4: Union[Unset, "GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[Unset, list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItem"]] = (
        UNSET
    )
    ...
    oper_updated_at: Union[Unset, "GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemOperUpdatedAt"] = UNSET
    phy_address: Union[Unset, str] = UNSET
    security_zone: Union[Unset, str] = UNSET
    sfp_optical_strength: Union[
        Unset, list["GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemConfigUpdatedAt.from_dict(
                _config_updated_at
            )
        ...
        if isinstance(_ip_sec, Unset):
            ...
            ip_sec = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpSec.from_dict(_ip_sec)
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemOperUpdatedAt.from_dict(
                _oper_updated_at
            )
        ...
        for sfp_optical_strength_item_data in _sfp_optical_strength or []:
            sfp_optical_strength_item = (
                GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSfpOpticalStrengthItem.from_dict(
        ...
        for subinterfaces_item_data in _subinterfaces or []:
            subinterfaces_item = GetV1DevicesDeviceIdInterfacesResponse200InterfacesItemSubinterfacesItem.from_dict(
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_devices_device_id_interfaces_response_200_interfaces_item.additional_properties = d
        return get_v1_devices_device_id_interfaces_response_200_interfaces_item
