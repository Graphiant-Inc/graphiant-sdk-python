...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_config_updated_at import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemConfigUpdatedAt,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ip_sec import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ipv_4 import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv4,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ipv_6 import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_ipv_6_addresses_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6AddressesItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_oper_updated_at import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemOperUpdatedAt,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_sfp_optical_strength_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem,
    )
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item_subinterfaces_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItem:
    """
    Attributes:
        ...
        ip_sec (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec]):
        ipv4 (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv4]):
        ipv6 (Union[Unset, GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6]):
        ipv_6_addresses (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6AddressesItem']]):
        ...
        sfp_optical_strength (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem']]):
        speed_mbps (Union[Unset, str]):  Example: TYPE_UINT32.
        subinterfaces (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem']]):
    ...
    config_updated_at: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemConfigUpdatedAt"
    ] = UNSET
    ...
    ip_sec: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec"] = UNSET
    ipv4: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv4"] = UNSET
    ipv6: Union[Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6"] = UNSET
    ipv_6_addresses: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6AddressesItem"]
    ] = UNSET
    ...
    oper_updated_at: Union[
        Unset, "GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemOperUpdatedAt"
    ] = UNSET
    phy_address: Union[Unset, str] = UNSET
    security_zone: Union[Unset, str] = UNSET
    sfp_optical_strength: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem"]
    ] = UNSET
    speed_mbps: Union[Unset, str] = UNSET
    subinterfaces: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_config_updated_at, Unset):
            ...
            config_updated_at = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemConfigUpdatedAt.from_dict(
                    _config_updated_at
                )
            )
        ...
        if isinstance(_ip_sec, Unset):
            ...
            ip_sec = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpSec.from_dict(_ip_sec)
        ...
        if isinstance(_ipv4, Unset):
            ...
            ipv4 = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv4.from_dict(_ipv4)
        ...
        if isinstance(_ipv6, Unset):
            ...
            ipv6 = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6.from_dict(_ipv6)

        ipv_6_addresses = []
        _ipv_6_addresses = d.pop("ipv6Addresses", UNSET)
        for ipv_6_addresses_item_data in _ipv_6_addresses or []:
            ipv_6_addresses_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemIpv6AddressesItem.from_dict(
        ...
        if isinstance(_oper_updated_at, Unset):
            ...
            oper_updated_at = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemOperUpdatedAt.from_dict(
                    _oper_updated_at
                )
            )
        ...
        for sfp_optical_strength_item_data in _sfp_optical_strength or []:
            sfp_optical_strength_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSfpOpticalStrengthItem.from_dict(
        ...
        for subinterfaces_item_data in _subinterfaces or []:
            subinterfaces_item = (
                GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemInterfacesItemSubinterfacesItem.from_dict(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item = cls(
            alias=alias,
            circuit=circuit,
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_interfaces_item
