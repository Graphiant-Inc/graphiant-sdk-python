...
if TYPE_CHECKING:
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_client_endpoint import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientEndpoint,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_client_links_item import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientLinksItem,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_first_seen_ts import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionFirstSeenTs,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_last_seen_ts import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLastSeenTs,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_local_dia_links_item import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLocalDiaLinksItem,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_pop_links_item import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionPopLinksItem,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_remote_dia_links_item import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionRemoteDiaLinksItem,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_server_endpoint import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerEndpoint,
    )
    from ..models.post_v2_assurance_topology_client_session_details_response_200_session_server_links_item import (
        PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem,
    )


T = TypeVar("T", bound="PostV2AssuranceTopologyClientSessionDetailsResponse200Session")


@_attrs_define
class PostV2AssuranceTopologyClientSessionDetailsResponse200Session:
    """
    Attributes:
        app_name (Union[Unset, str]):  Example: TYPE_STRING.
        bucket (Union[Unset, str]):  Example: TYPE_ENUM.
        client_endpoint (Union[Unset, PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientEndpoint]):
        client_ip (Union[Unset, str]):  Example: TYPE_STRING.
        client_links (Union[Unset,
            list['PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientLinksItem']]):
        first_seen_ts (Union[Unset, PostV2AssuranceTopologyClientSessionDetailsResponse200SessionFirstSeenTs]):
        lan_segment (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        last_seen_ts (Union[Unset, PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLastSeenTs]):
        local_dia_links (Union[Unset,
            list['PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLocalDiaLinksItem']]):
        pop_links (Union[Unset, list['PostV2AssuranceTopologyClientSessionDetailsResponse200SessionPopLinksItem']]):
        remote_dia_links (Union[Unset,
            list['PostV2AssuranceTopologyClientSessionDetailsResponse200SessionRemoteDiaLinksItem']]):
        risk_status (Union[Unset, str]):  Example: TYPE_ENUM.
        server_endpoint (Union[Unset, PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerEndpoint]):
        server_ip (Union[Unset, str]):  Example: TYPE_STRING.
        server_links (Union[Unset,
            list['PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem']]):
    ...
    client_endpoint: Union[Unset, "PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientEndpoint"] = UNSET
    client_ip: Union[Unset, str] = UNSET
    client_links: Union[Unset, list["PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientLinksItem"]] = (
        UNSET
    )
    first_seen_ts: Union[Unset, "PostV2AssuranceTopologyClientSessionDetailsResponse200SessionFirstSeenTs"] = UNSET
    lan_segment: Union[Unset, list[str]] = UNSET
    last_seen_ts: Union[Unset, "PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLastSeenTs"] = UNSET
    local_dia_links: Union[
        Unset, list["PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLocalDiaLinksItem"]
    ] = UNSET
    pop_links: Union[Unset, list["PostV2AssuranceTopologyClientSessionDetailsResponse200SessionPopLinksItem"]] = UNSET
    remote_dia_links: Union[
        Unset, list["PostV2AssuranceTopologyClientSessionDetailsResponse200SessionRemoteDiaLinksItem"]
    ] = UNSET
    risk_status: Union[Unset, str] = UNSET
    server_endpoint: Union[Unset, "PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerEndpoint"] = UNSET
    server_ip: Union[Unset, str] = UNSET
    server_links: Union[Unset, list["PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_client_endpoint, Unset):
            ...
            client_endpoint = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientEndpoint.from_dict(
                _client_endpoint
            )
        ...
        for client_links_item_data in _client_links or []:
            client_links_item = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionClientLinksItem.from_dict(
        ...
        if isinstance(_first_seen_ts, Unset):
            ...
            first_seen_ts = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionFirstSeenTs.from_dict(
                _first_seen_ts
            )
        ...
        if isinstance(_last_seen_ts, Unset):
            ...
            last_seen_ts = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLastSeenTs.from_dict(
                _last_seen_ts
            )
        ...
        for local_dia_links_item_data in _local_dia_links or []:
            local_dia_links_item = (
                PostV2AssuranceTopologyClientSessionDetailsResponse200SessionLocalDiaLinksItem.from_dict(
        ...
        for pop_links_item_data in _pop_links or []:
            pop_links_item = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionPopLinksItem.from_dict(
                pop_links_item_data
            )
        ...
        for remote_dia_links_item_data in _remote_dia_links or []:
            remote_dia_links_item = (
                PostV2AssuranceTopologyClientSessionDetailsResponse200SessionRemoteDiaLinksItem.from_dict(
        ...
        if isinstance(_server_endpoint, Unset):
            ...
            server_endpoint = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerEndpoint.from_dict(
                _server_endpoint
            )
        ...
        for server_links_item_data in _server_links or []:
            server_links_item = PostV2AssuranceTopologyClientSessionDetailsResponse200SessionServerLinksItem.from_dict(
        ...
        post_v2_assurance_topology_client_session_details_response_200_session = cls(
            app_name=app_name,
            bucket=bucket,
        ...
        post_v2_assurance_topology_client_session_details_response_200_session.additional_properties = d
        return post_v2_assurance_topology_client_session_details_response_200_session
