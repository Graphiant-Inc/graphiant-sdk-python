...
if TYPE_CHECKING:
    from ..models.post_v1_devices_response_200_devices_item_ipsec_tunnels_item_bgp import (
        PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp,
    )
    from ..models.post_v1_devices_response_200_devices_item_ipsec_tunnels_item_static import (
        PostV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic,
    )


T = TypeVar("T", bound="PostV1DevicesResponse200DevicesItemIpsecTunnelsItem")


@_attrs_define
class PostV1DevicesResponse200DevicesItemIpsecTunnelsItem:
    """
    Attributes:
        bgp (Union[Unset, PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp]):
        ...
        static (Union[Unset, PostV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        vpn_profile (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp: Union[Unset, "PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp"] = UNSET
    ...
    static: Union[Unset, "PostV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_bgp, Unset):
            ...
            bgp = PostV1DevicesResponse200DevicesItemIpsecTunnelsItemBgp.from_dict(_bgp)
        ...
        if isinstance(_static, Unset):
            ...
            static = PostV1DevicesResponse200DevicesItemIpsecTunnelsItemStatic.from_dict(_static)

        tcp_mss = d.pop("tcpMss", UNSET)

        vpn_profile = d.pop("vpnProfile", UNSET)

        post_v1_devices_response_200_devices_item_ipsec_tunnels_item = cls(
            bgp=bgp,
        ...
        post_v1_devices_response_200_devices_item_ipsec_tunnels_item.additional_properties = d
        return post_v1_devices_response_200_devices_item_ipsec_tunnels_item
