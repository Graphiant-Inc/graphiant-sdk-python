...
if TYPE_CHECKING:
    from ..models.post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_matches_item_route_tag import (
        PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag,
    )


T = TypeVar("T", bound="PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemMatchesItem")


@_attrs_define
class PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemMatchesItem:
    """
    Attributes:
    ...
    route_tag: Union[
        Unset, "PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_route_tag, Unset):
            ...
            route_tag = (
                PostV1GlobalRoutingPoliciesResponse200RoutingPoliciesItemStatementsItemMatchesItemRouteTag.from_dict(
                    _route_tag
                )
            )
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_matches_item = cls(
            community=community,
            id=id,
        ...
        post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_matches_item.additional_properties = d
        return post_v1_global_routing_policies_response_200_routing_policies_item_statements_item_matches_item
