...
if TYPE_CHECKING:
    from ..models.post_v1_gateways_body_details_ipsec_gateway_routing import (
        PostV1GatewaysBodyDetailsIpsecGatewayRouting,
    )
    from ..models.post_v1_gateways_body_details_ipsec_gateway_tunnel_1 import (
        PostV1GatewaysBodyDetailsIpsecGatewayTunnel1,
    )
    from ..models.post_v1_gateways_body_details_ipsec_gateway_tunnel_2 import (
        PostV1GatewaysBodyDetailsIpsecGatewayTunnel2,
    )


T = TypeVar("T", bound="PostV1GatewaysBodyDetailsIpsecGateway")


@_attrs_define
class PostV1GatewaysBodyDetailsIpsecGateway:
    """
    Attributes:
        ...
        routing (Union[Unset, PostV1GatewaysBodyDetailsIpsecGatewayRouting]):
        tcp_mss (Union[Unset, str]):  Example: TYPE_UINT32.
        tunnel1 (Union[Unset, PostV1GatewaysBodyDetailsIpsecGatewayTunnel1]):
        tunnel2 (Union[Unset, PostV1GatewaysBodyDetailsIpsecGatewayTunnel2]):
    ...
    routing: Union[Unset, "PostV1GatewaysBodyDetailsIpsecGatewayRouting"] = UNSET
    tcp_mss: Union[Unset, str] = UNSET
    tunnel1: Union[Unset, "PostV1GatewaysBodyDetailsIpsecGatewayTunnel1"] = UNSET
    tunnel2: Union[Unset, "PostV1GatewaysBodyDetailsIpsecGatewayTunnel2"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_routing, Unset):
            ...
            routing = PostV1GatewaysBodyDetailsIpsecGatewayRouting.from_dict(_routing)
        ...
        if isinstance(_tunnel1, Unset):
            ...
            tunnel1 = PostV1GatewaysBodyDetailsIpsecGatewayTunnel1.from_dict(_tunnel1)
        ...
        if isinstance(_tunnel2, Unset):
            ...
            tunnel2 = PostV1GatewaysBodyDetailsIpsecGatewayTunnel2.from_dict(_tunnel2)

        vpn_profile = d.pop("vpnProfile", UNSET)

        post_v1_gateways_body_details_ipsec_gateway = cls(
        ...
        post_v1_gateways_body_details_ipsec_gateway.additional_properties = d
        return post_v1_gateways_body_details_ipsec_gateway
