...
T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemLocalRouteTag")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemLocalRouteTag:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_local_route_tag = cls(
            level_one=level_one,
            level_two=level_two,
            level_zero=level_zero,
        )

        post_v1_extranets_resolve_policy_target_response_200_devices_item_local_route_tag.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_local_route_tag
