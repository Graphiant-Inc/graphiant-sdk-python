...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DevicePrefixSetsItemEntriesItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DevicePrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        get_v1_devices_device_id_response_200_device_prefix_sets_item_entries_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_prefix_sets_item_entries_item
