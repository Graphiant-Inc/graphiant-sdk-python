...
if TYPE_CHECKING:
    from ..models.put_v1_alarm_custom_body_alarm_filter_item import PutV1AlarmCustomBodyAlarmFilterItem


T = TypeVar("T", bound="PutV1AlarmCustomBodyAlarm")


@_attrs_define
class PutV1AlarmCustomBodyAlarm:
    """
    Attributes:
        ...
        filter_ (Union[Unset, list['PutV1AlarmCustomBodyAlarmFilterItem']]):
    ...
    filter_: Union[Unset, list["PutV1AlarmCustomBodyAlarmFilterItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for filter_item_data in _filter_ or []:
            filter_item = PutV1AlarmCustomBodyAlarmFilterItem.from_dict(filter_item_data)
        ...
        put_v1_alarm_custom_body_alarm = cls(
            component=component,
        ...
        put_v1_alarm_custom_body_alarm.additional_properties = d
        return put_v1_alarm_custom_body_alarm
