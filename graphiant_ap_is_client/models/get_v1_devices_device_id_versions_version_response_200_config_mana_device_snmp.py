...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_communities_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpCommunitiesItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_engine_endpoints_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpEngineEndpointsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_notify_filter_profiles_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpNotifyFilterProfilesItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_targets_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpTargetsItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_usm_local_users_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmLocalUsersItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_usm_remote_users_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmRemoteUsersItem,
    )
    from ..models.get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp_vacm_groups_item import (
        GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpVacmGroupsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmp")


@_attrs_define
class GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmp:
    """
    Attributes:
        communities (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpCommunitiesItem']]):
        ...
        engine_endpoints (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpEngineEndpointsItem']]):
        ...
        notify_filter_profiles (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpNotifyFilterProfilesItem']]):
        status (Union[Unset, str]):  Example: TYPE_ENUM.
        targets (Union[Unset, list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpTargetsItem']]):
        usm_local_users (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmLocalUsersItem']]):
        usm_remote_users (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmRemoteUsersItem']]):
        v_2_c_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        v_3_enabled (Union[Unset, str]):  Example: TYPE_BOOL.
        vacm_groups (Union[Unset,
            list['GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpVacmGroupsItem']]):
    """

    communities: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpCommunitiesItem"]
    ] = UNSET
    ...
    engine_endpoints: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpEngineEndpointsItem"]
    ] = UNSET
    ...
    notify_filter_profiles: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpNotifyFilterProfilesItem"]
    ] = UNSET
    status: Union[Unset, str] = UNSET
    targets: Union[Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpTargetsItem"]] = UNSET
    usm_local_users: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmLocalUsersItem"]
    ] = UNSET
    usm_remote_users: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmRemoteUsersItem"]
    ] = UNSET
    v_2_c_enabled: Union[Unset, str] = UNSET
    v_3_enabled: Union[Unset, str] = UNSET
    vacm_groups: Union[
        Unset, list["GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpVacmGroupsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for communities_item_data in _communities or []:
            communities_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpCommunitiesItem.from_dict(
        ...
        for engine_endpoints_item_data in _engine_endpoints or []:
            engine_endpoints_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpEngineEndpointsItem.from_dict(
        ...
        for notify_filter_profiles_item_data in _notify_filter_profiles or []:
            notify_filter_profiles_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpNotifyFilterProfilesItem.from_dict(
        ...
        for targets_item_data in _targets or []:
            targets_item = GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpTargetsItem.from_dict(
                targets_item_data
            )
        ...
        for usm_local_users_item_data in _usm_local_users or []:
            usm_local_users_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmLocalUsersItem.from_dict(
        ...
        for usm_remote_users_item_data in _usm_remote_users or []:
            usm_remote_users_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpUsmRemoteUsersItem.from_dict(
        ...
        for vacm_groups_item_data in _vacm_groups or []:
            vacm_groups_item = (
                GetV1DevicesDeviceIdVersionsVersionResponse200ConfigManaDeviceSnmpVacmGroupsItem.from_dict(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp = cls(
        ...
        get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp.additional_properties = d
        return get_v1_devices_device_id_versions_version_response_200_config_mana_device_snmp
