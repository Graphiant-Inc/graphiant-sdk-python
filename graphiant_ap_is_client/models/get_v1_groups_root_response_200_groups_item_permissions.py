...
T = TypeVar("T", bound="GetV1GroupsRootResponse200GroupsItemPermissions")


@_attrs_define
class GetV1GroupsRootResponse200GroupsItemPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_groups_root_response_200_groups_item_permissions = cls(
        ...
        get_v1_groups_root_response_200_groups_item_permissions.additional_properties = d
        return get_v1_groups_root_response_200_groups_item_permissions
