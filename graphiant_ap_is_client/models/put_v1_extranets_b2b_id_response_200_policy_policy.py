...
if TYPE_CHECKING:
    from ..models.put_v1_extranets_b2b_id_response_200_policy_policy_profiles_item import (
        PutV1ExtranetsB2BIdResponse200PolicyPolicyProfilesItem,
    )
    from ..models.put_v1_extranets_b2b_id_response_200_policy_policy_sites_item import (
        PutV1ExtranetsB2BIdResponse200PolicyPolicySitesItem,
    )
    from ..models.put_v1_extranets_b2b_id_response_200_policy_policy_sla import (
        PutV1ExtranetsB2BIdResponse200PolicyPolicySla,
    )


T = TypeVar("T", bound="PutV1ExtranetsB2BIdResponse200PolicyPolicy")


@_attrs_define
class PutV1ExtranetsB2BIdResponse200PolicyPolicy:
    """
    Attributes:
        nat_pools (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        profiles (Union[Unset, list['PutV1ExtranetsB2BIdResponse200PolicyPolicyProfilesItem']]):
        service_lan_segment (Union[Unset, str]):  Example: TYPE_INT64.
        service_prefixes (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        sites (Union[Unset, list['PutV1ExtranetsB2BIdResponse200PolicyPolicySitesItem']]):
        sla (Union[Unset, PutV1ExtranetsB2BIdResponse200PolicyPolicySla]):
        type_ (Union[Unset, str]):  Example: TYPE_ENUM.
    """

    nat_pools: Union[Unset, list[str]] = UNSET
    profiles: Union[Unset, list["PutV1ExtranetsB2BIdResponse200PolicyPolicyProfilesItem"]] = UNSET
    service_lan_segment: Union[Unset, str] = UNSET
    service_prefixes: Union[Unset, list[str]] = UNSET
    sites: Union[Unset, list["PutV1ExtranetsB2BIdResponse200PolicyPolicySitesItem"]] = UNSET
    sla: Union[Unset, "PutV1ExtranetsB2BIdResponse200PolicyPolicySla"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for profiles_item_data in _profiles or []:
            profiles_item = PutV1ExtranetsB2BIdResponse200PolicyPolicyProfilesItem.from_dict(profiles_item_data)
        ...
        for sites_item_data in _sites or []:
            sites_item = PutV1ExtranetsB2BIdResponse200PolicyPolicySitesItem.from_dict(sites_item_data)
        ...
        if isinstance(_sla, Unset):
            ...
            sla = PutV1ExtranetsB2BIdResponse200PolicyPolicySla.from_dict(_sla)

        type_ = d.pop("type", UNSET)

        put_v1_extranets_b2b_id_response_200_policy_policy = cls(
            nat_pools=nat_pools,
            profiles=profiles,
        ...
        put_v1_extranets_b2b_id_response_200_policy_policy.additional_properties = d
        return put_v1_extranets_b2b_id_response_200_policy_policy
