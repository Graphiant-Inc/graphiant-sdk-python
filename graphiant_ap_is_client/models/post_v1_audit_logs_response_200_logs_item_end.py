...
T = TypeVar("T", bound="PostV1AuditLogsResponse200LogsItemEnd")


@_attrs_define
class PostV1AuditLogsResponse200LogsItemEnd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_logs_response_200_logs_item_end = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_logs_response_200_logs_item_end.additional_properties = d
        return post_v1_audit_logs_response_200_logs_item_end
