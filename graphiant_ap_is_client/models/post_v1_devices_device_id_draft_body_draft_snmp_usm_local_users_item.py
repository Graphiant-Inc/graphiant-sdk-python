...
T = TypeVar("T", bound="PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem")


@_attrs_define
class PostV1DevicesDeviceIdDraftBodyDraftSnmpUsmLocalUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_usm_local_users_item = cls(
        ...
        post_v1_devices_device_id_draft_body_draft_snmp_usm_local_users_item.additional_properties = d
        return post_v1_devices_device_id_draft_body_draft_snmp_usm_local_users_item
