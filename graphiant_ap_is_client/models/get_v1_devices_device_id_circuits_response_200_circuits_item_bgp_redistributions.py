...
T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_redistributions.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_bgp_redistributions
