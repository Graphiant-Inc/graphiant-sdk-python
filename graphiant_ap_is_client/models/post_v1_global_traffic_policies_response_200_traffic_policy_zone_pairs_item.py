...
T = TypeVar("T", bound="PostV1GlobalTrafficPoliciesResponse200TrafficPolicyZonePairsItem")


@_attrs_define
class PostV1GlobalTrafficPoliciesResponse200TrafficPolicyZonePairsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_global_traffic_policies_response_200_traffic_policy_zone_pairs_item = cls(
            inside=inside,
            outside=outside,
            ruleset=ruleset,
        ...
        post_v1_global_traffic_policies_response_200_traffic_policy_zone_pairs_item.additional_properties = d
        return post_v1_global_traffic_policies_response_200_traffic_policy_zone_pairs_item
