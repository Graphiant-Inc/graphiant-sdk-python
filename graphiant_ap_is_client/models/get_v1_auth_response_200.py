...
T = TypeVar("T", bound="GetV1AuthResponse200")


@_attrs_define
class GetV1AuthResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_auth_response_200.additional_properties = d
        return get_v1_auth_response_200
