...
if TYPE_CHECKING:
    from ..models.get_v1_lan_segments_response_200_segments_item_ospfv_2_process_areas_item import (
        GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessAreasItem,
    )
    from ..models.get_v1_lan_segments_response_200_segments_item_ospfv_2_process_redistributed_protocols_item import (
        GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem,
    )


T = TypeVar("T", bound="GetV1LanSegmentsResponse200SegmentsItemOspfv2Process")


@_attrs_define
class GetV1LanSegmentsResponse200SegmentsItemOspfv2Process:
    """
    Attributes:
        admin_distance (Union[Unset, str]):  Example: 100.
        areas (Union[Unset, list['GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessAreasItem']]):
        ...
        redistributed_protocols (Union[Unset,
            list['GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem']]):
        router_id (Union[Unset, str]):  Example: TYPE_STRING.
    """

    admin_distance: Union[Unset, str] = UNSET
    areas: Union[Unset, list["GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessAreasItem"]] = UNSET
    auto_router_id: Union[Unset, str] = UNSET
    default_originate: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    redistributed_protocols: Union[
        Unset, list["GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for areas_item_data in _areas or []:
            areas_item = GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessAreasItem.from_dict(areas_item_data)
        ...
        for redistributed_protocols_item_data in _redistributed_protocols or []:
            redistributed_protocols_item = (
                GetV1LanSegmentsResponse200SegmentsItemOspfv2ProcessRedistributedProtocolsItem.from_dict(
        ...
        get_v1_lan_segments_response_200_segments_item_ospfv_2_process = cls(
        ...
        get_v1_lan_segments_response_200_segments_item_ospfv_2_process.additional_properties = d
        return get_v1_lan_segments_response_200_segments_item_ospfv_2_process
