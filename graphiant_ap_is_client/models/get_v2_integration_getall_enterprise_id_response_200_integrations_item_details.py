...
T = TypeVar("T", bound="GetV2IntegrationGetallEnterpriseIdResponse200IntegrationsItemDetails")


@_attrs_define
class GetV2IntegrationGetallEnterpriseIdResponse200IntegrationsItemDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v2_integration_getall_enterprise_id_response_200_integrations_item_details = cls(
            opsgenie_key=opsgenie_key,
            opsramp_details=opsramp_details,
            webhook_url=webhook_url,
        )

        get_v2_integration_getall_enterprise_id_response_200_integrations_item_details.additional_properties = d
        return get_v2_integration_getall_enterprise_id_response_200_integrations_item_details
