...
T = TypeVar("T", bound="PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions")


@_attrs_define
class PostV1ExtranetsResponse200PolicySharedSegmentBgpRedistributions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_response_200_policy_shared_segment_bgp_redistributions = cls(
            bgp=bgp,
            connected=connected,
            dia=dia,
            ospfv2=ospfv2,
        ...
        post_v1_extranets_response_200_policy_shared_segment_bgp_redistributions.additional_properties = d
        return post_v1_extranets_response_200_policy_shared_segment_bgp_redistributions
