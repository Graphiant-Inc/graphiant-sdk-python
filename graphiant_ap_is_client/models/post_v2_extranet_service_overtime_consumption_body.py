...
if TYPE_CHECKING:
    from ..models.post_v2_extranet_service_overtime_consumption_body_time_window import (
        PostV2ExtranetServiceOvertimeConsumptionBodyTimeWindow,
    )


T = TypeVar("T", bound="PostV2ExtranetServiceOvertimeConsumptionBody")


@_attrs_define
class PostV2ExtranetServiceOvertimeConsumptionBody:
    """
    Attributes:
        ...
        time_window (Union[Unset, PostV2ExtranetServiceOvertimeConsumptionBodyTimeWindow]):
    ...
    time_window: Union[Unset, "PostV2ExtranetServiceOvertimeConsumptionBodyTimeWindow"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_time_window, Unset):
            ...
            time_window = PostV2ExtranetServiceOvertimeConsumptionBodyTimeWindow.from_dict(_time_window)

        vrf_id = d.pop("vrfId", UNSET)

        post_v2_extranet_service_overtime_consumption_body = cls(
            id=id,
            is_b2b=is_b2b,
        ...
        post_v2_extranet_service_overtime_consumption_body.additional_properties = d
        return post_v2_extranet_service_overtime_consumption_body
