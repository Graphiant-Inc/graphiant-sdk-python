...
T = TypeVar("T", bound="PostV2MonitoringQueueBodySelectorsItem")


@_attrs_define
class PostV2MonitoringQueueBodySelectorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v2_monitoring_queue_body_selectors_item = cls(
        ...
        post_v2_monitoring_queue_body_selectors_item.additional_properties = d
        return post_v2_monitoring_queue_body_selectors_item
