...
T = TypeVar("T", bound="GetV1ExtranetsB2BConsumerIdResponse200PolicyItemTrafficRulesItemMatch")


@_attrs_define
class GetV1ExtranetsB2BConsumerIdResponse200PolicyItemTrafficRulesItemMatch:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_b2b_consumer_id_response_200_policy_item_traffic_rules_item_match = cls(
        ...
        get_v1_extranets_b2b_consumer_id_response_200_policy_item_traffic_rules_item_match.additional_properties = d
        return get_v1_extranets_b2b_consumer_id_response_200_policy_item_traffic_rules_item_match
