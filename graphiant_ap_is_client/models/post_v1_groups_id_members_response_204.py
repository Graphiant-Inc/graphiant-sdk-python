...
T = TypeVar("T", bound="PostV1GroupsIdMembersResponse204")


@_attrs_define
class PostV1GroupsIdMembersResponse204:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_groups_id_members_response_204 = cls(
            affected_users=affected_users,
            enterprise_group=enterprise_group,
        )

        post_v1_groups_id_members_response_204.additional_properties = d
        return post_v1_groups_id_members_response_204
