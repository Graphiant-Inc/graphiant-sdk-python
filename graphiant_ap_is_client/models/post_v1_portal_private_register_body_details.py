...
T = TypeVar("T", bound="PostV1PortalPrivateRegisterBodyDetails")


@_attrs_define
class PostV1PortalPrivateRegisterBodyDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_portal_private_register_body_details = cls(
            api_key=api_key,
        ...
        post_v1_portal_private_register_body_details.additional_properties = d
        return post_v1_portal_private_register_body_details
