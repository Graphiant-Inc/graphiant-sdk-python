...
T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemSyslogTargetsItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_syslog_targets_item = cls(
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_segments_item_syslog_targets_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_segments_item_syslog_targets_item
