...
if TYPE_CHECKING:
    from ..models.get_v1_devices_device_id_draft_response_200_draft_mana_device_routing_policies_item_statements_item import (
        GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItemStatementsItem,
    )


T = TypeVar("T", bound="GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItem")


@_attrs_define
class GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItem:
    """
    Attributes:
        ...
        statements (Union[Unset,
            list['GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItemStatementsItem']]):
    ...
    statements: Union[
        Unset, list["GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItemStatementsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for statements_item_data in _statements or []:
            statements_item = (
                GetV1DevicesDeviceIdDraftResponse200DraftManaDeviceRoutingPoliciesItemStatementsItem.from_dict(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_routing_policies_item = cls(
        ...
        get_v1_devices_device_id_draft_response_200_draft_mana_device_routing_policies_item.additional_properties = d
        return get_v1_devices_device_id_draft_response_200_draft_mana_device_routing_policies_item
