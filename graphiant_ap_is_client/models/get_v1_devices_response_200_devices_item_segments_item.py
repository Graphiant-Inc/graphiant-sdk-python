...
if TYPE_CHECKING:
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_aggregations_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpAggregationsItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_multipath import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpMultipath,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_neighbors_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_bgp_redistributions import (
        GetV1DevicesResponse200DevicesItemSegmentsItemBgpRedistributions,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_dhcp_subnets_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_ipfix_exporters_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemIpfixExportersItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_ospfv_2_process import (
        GetV1DevicesResponse200DevicesItemSegmentsItemOspfv2Process,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_ospfv_3_process import (
        GetV1DevicesResponse200DevicesItemSegmentsItemOspfv3Process,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_overlay_filters import (
        GetV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_static_routes_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemStaticRoutesItem,
    )
    from ..models.get_v1_devices_response_200_devices_item_segments_item_syslog_targets_item import (
        GetV1DevicesResponse200DevicesItemSegmentsItemSyslogTargetsItem,
    )


T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemSegmentsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemSegmentsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemBgpRedistributions]):
        description (Union[Unset, str]):  Example: TYPE_STRING.
        dhcp_subnets (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem']]):
        enterprise_id (Union[Unset, str]):  Example: TYPE_INT64.
        function (Union[Unset, str]):  Example: TYPE_STRING.
        id (Union[Unset, str]):  Example: TYPE_INT64.
        ipfix_exporters (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemIpfixExportersItem']]):
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nat_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
        networks (Union[Unset, list[str]]):  Example: ['TYPE_STRING'].
        ospfv_2_process (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemOspfv2Process]):
        ospfv_3_process (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemOspfv3Process]):
        overlay_filters (Union[Unset, GetV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters]):
        routable (Union[Unset, str]):  Example: TYPE_BOOL.
        route_distinguisher (Union[Unset, str]):  Example: TYPE_STRING.
        static_routes (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemStaticRoutesItem']]):
        syslog_targets (Union[Unset, list['GetV1DevicesResponse200DevicesItemSegmentsItemSyslogTargetsItem']]):
        traffic_ruleset (Union[Unset, str]):  Example: TYPE_STRING.
    """

    bgp_aggregations: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemBgpAggregationsItem"]] = UNSET
    bgp_multipath: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemBgpRedistributions"] = UNSET
    description: Union[Unset, str] = UNSET
    dhcp_subnets: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem"]] = UNSET
    enterprise_id: Union[Unset, str] = UNSET
    function: Union[Unset, str] = UNSET
    id: Union[Unset, str] = UNSET
    ipfix_exporters: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemIpfixExportersItem"]] = UNSET
    name: Union[Unset, str] = UNSET
    nat_ruleset: Union[Unset, str] = UNSET
    networks: Union[Unset, list[str]] = UNSET
    ospfv_2_process: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemOspfv2Process"] = UNSET
    ospfv_3_process: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemOspfv3Process"] = UNSET
    overlay_filters: Union[Unset, "GetV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters"] = UNSET
    routable: Union[Unset, str] = UNSET
    route_distinguisher: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemStaticRoutesItem"]] = UNSET
    syslog_targets: Union[Unset, list["GetV1DevicesResponse200DevicesItemSegmentsItemSyslogTargetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = GetV1DevicesResponse200DevicesItemSegmentsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1DevicesResponse200DevicesItemSegmentsItemBgpMultipath.from_dict(_bgp_multipath)

        bgp_neighbors = []
        _bgp_neighbors = d.pop("bgpNeighbors", UNSET)
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1DevicesResponse200DevicesItemSegmentsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1DevicesResponse200DevicesItemSegmentsItemBgpRedistributions.from_dict(
        ...
        for dhcp_subnets_item_data in _dhcp_subnets or []:
            dhcp_subnets_item = GetV1DevicesResponse200DevicesItemSegmentsItemDhcpSubnetsItem.from_dict(
        ...
        for ipfix_exporters_item_data in _ipfix_exporters or []:
            ipfix_exporters_item = GetV1DevicesResponse200DevicesItemSegmentsItemIpfixExportersItem.from_dict(
        ...
        if isinstance(_ospfv_2_process, Unset):
            ...
            ospfv_2_process = GetV1DevicesResponse200DevicesItemSegmentsItemOspfv2Process.from_dict(_ospfv_2_process)
        ...
        if isinstance(_ospfv_3_process, Unset):
            ...
            ospfv_3_process = GetV1DevicesResponse200DevicesItemSegmentsItemOspfv3Process.from_dict(_ospfv_3_process)
        ...
        if isinstance(_overlay_filters, Unset):
            ...
            overlay_filters = GetV1DevicesResponse200DevicesItemSegmentsItemOverlayFilters.from_dict(_overlay_filters)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1DevicesResponse200DevicesItemSegmentsItemStaticRoutesItem.from_dict(
        ...
        for syslog_targets_item_data in _syslog_targets or []:
            syslog_targets_item = GetV1DevicesResponse200DevicesItemSegmentsItemSyslogTargetsItem.from_dict(
        ...
        get_v1_devices_response_200_devices_item_segments_item = cls(
        ...
        get_v1_devices_response_200_devices_item_segments_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_segments_item
