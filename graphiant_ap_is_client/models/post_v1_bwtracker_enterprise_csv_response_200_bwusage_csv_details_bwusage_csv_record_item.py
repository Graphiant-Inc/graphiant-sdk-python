...
T = TypeVar("T", bound="PostV1BwtrackerEnterpriseCsvResponse200BwusageCsvDetailsBwusageCsvRecordItem")


@_attrs_define
class PostV1BwtrackerEnterpriseCsvResponse200BwusageCsvDetailsBwusageCsvRecordItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_bwtracker_enterprise_csv_response_200_bwusage_csv_details_bwusage_csv_record_item = cls(
        ...
        post_v1_bwtracker_enterprise_csv_response_200_bwusage_csv_details_bwusage_csv_record_item.additional_properties = d
        return post_v1_bwtracker_enterprise_csv_response_200_bwusage_csv_details_bwusage_csv_record_item
