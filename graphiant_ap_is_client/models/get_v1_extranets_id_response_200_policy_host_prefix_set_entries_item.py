...
T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyHostPrefixSetEntriesItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyHostPrefixSetEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_response_200_policy_host_prefix_set_entries_item = cls(
            ip_prefix=ip_prefix,
        ...
        get_v1_extranets_id_response_200_policy_host_prefix_set_entries_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_host_prefix_set_entries_item
