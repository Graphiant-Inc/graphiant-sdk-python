...
if TYPE_CHECKING:
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_aggregations_item import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpAggregationsItem,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_multipath import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpMultipath,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_neighbors_item import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_bgp_redistributions import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpRedistributions,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_core_logical_interfaces_v2_item import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemCoreLogicalInterfacesV2Item,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_profile import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemProfile,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_static_routes_item import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemStaticRoutesItem,
    )
    from ..models.get_v1_sites_site_id_circuits_response_200_data_item_circuits_item_wan_interface_v2 import (
        GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2,
    )


T = TypeVar("T", bound="GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItem")


@_attrs_define
class GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItem:
    """
    Attributes:
        bgp_aggregations (Union[Unset,
            list['GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpAggregationsItem']]):
        bgp_multipath (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpMultipath]):
        bgp_neighbors (Union[Unset, list['GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem']]):
        bgp_redistributions (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpRedistributions]):
        ...
        core_logical_interfaces_v2 (Union[Unset,
            list['GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemCoreLogicalInterfacesV2Item']]):
        ...
        profile (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemProfile]):
        ...
        static_routes (Union[Unset, list['GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemStaticRoutesItem']]):
        wan_interface_v2 (Union[Unset, GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2]):
    """

    bgp_aggregations: Union[
        Unset, list["GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpAggregationsItem"]
    ] = UNSET
    bgp_multipath: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpMultipath"] = UNSET
    bgp_neighbors: Union[Unset, list["GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem"]] = UNSET
    bgp_redistributions: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpRedistributions"] = (
        UNSET
    )
    ...
    core_logical_interfaces_v2: Union[
        Unset, list["GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemCoreLogicalInterfacesV2Item"]
    ] = UNSET
    ...
    profile: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemProfile"] = UNSET
    qos_profile: Union[Unset, str] = UNSET
    qos_profile_type: Union[Unset, str] = UNSET
    snmp_index: Union[Unset, str] = UNSET
    static_routes: Union[Unset, list["GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemStaticRoutesItem"]] = UNSET
    wan_interface_v2: Union[Unset, "GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for bgp_aggregations_item_data in _bgp_aggregations or []:
            bgp_aggregations_item = (
                GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpAggregationsItem.from_dict(
        ...
        if isinstance(_bgp_multipath, Unset):
            ...
            bgp_multipath = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpMultipath.from_dict(
                _bgp_multipath
            )
        ...
        for bgp_neighbors_item_data in _bgp_neighbors or []:
            bgp_neighbors_item = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpNeighborsItem.from_dict(
        ...
        if isinstance(_bgp_redistributions, Unset):
            ...
            bgp_redistributions = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemBgpRedistributions.from_dict(
        ...
        for core_logical_interfaces_v2_item_data in _core_logical_interfaces_v2 or []:
            core_logical_interfaces_v2_item = (
                GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemCoreLogicalInterfacesV2Item.from_dict(
        ...
        if isinstance(_profile, Unset):
            ...
            profile = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemProfile.from_dict(_profile)
        ...
        for static_routes_item_data in _static_routes or []:
            static_routes_item = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemStaticRoutesItem.from_dict(
        ...
        if isinstance(_wan_interface_v2, Unset):
            ...
            wan_interface_v2 = GetV1SitesSiteIdCircuitsResponse200DataItemCircuitsItemWanInterfaceV2.from_dict(
                _wan_interface_v2
            )

        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item = cls(
        ...
        get_v1_sites_site_id_circuits_response_200_data_item_circuits_item.additional_properties = d
        return get_v1_sites_site_id_circuits_response_200_data_item_circuits_item
