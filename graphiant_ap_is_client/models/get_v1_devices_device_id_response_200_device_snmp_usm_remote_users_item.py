...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSnmpUsmRemoteUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_snmp_usm_remote_users_item = cls(
        ...
        get_v1_devices_device_id_response_200_device_snmp_usm_remote_users_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_snmp_usm_remote_users_item
