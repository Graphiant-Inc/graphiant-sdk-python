...
T = TypeVar("T", bound="PostV1ExtranetsB2BConsumerBodySiteInformationItem")


@_attrs_define
class PostV1ExtranetsB2BConsumerBodySiteInformationItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_extranets_b2b_consumer_body_site_information_item = cls(
        ...
        post_v1_extranets_b2b_consumer_body_site_information_item.additional_properties = d
        return post_v1_extranets_b2b_consumer_body_site_information_item
