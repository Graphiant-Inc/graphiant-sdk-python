...
if TYPE_CHECKING:
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item_address_families_item import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item_bfd_neighbor import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor,
    )
    from ..models.post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item_time_since_last_oper_change import (
        PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange,
    )


T = TypeVar("T", bound="PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem")


@_attrs_define
class PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItem:
    """
    Attributes:
        address_families (Union[Unset, list['PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeig
            hborsItemAddressFamiliesItem']]):
        bfd (Union[Unset, PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd]):
        bfd_neighbor (Union[Unset,
            PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor]):
    ...
    address_families: Union[
        Unset,
        list["PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem"],
    ] = UNSET
    bfd: Union[Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd"] = UNSET
    bfd_neighbor: Union[
        Unset, "PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemAddressFamiliesItem.from_dict(
        ...
        if isinstance(_bfd, Unset):
            ...
            bfd = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfd.from_dict(
                _bfd
            )
        ...
        if isinstance(_bfd_neighbor, Unset):
            ...
            bfd_neighbor = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemBfdNeighbor.from_dict(
                _bfd_neighbor
            )
        ...
        if isinstance(_time_since_last_oper_change, Unset):
            ...
            time_since_last_oper_change = PostV1ExtranetsResolvePolicyTargetResponse200DevicesItemCircuitsItemBgpNeighborsItemTimeSinceLastOperChange.from_dict(
                _time_since_last_oper_change
            )

        up = d.pop("up", UNSET)

        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item = cls(
        ...
        post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item.additional_properties = d
        return post_v1_extranets_resolve_policy_target_response_200_devices_item_circuits_item_bgp_neighbors_item
