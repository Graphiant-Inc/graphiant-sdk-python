...
T = TypeVar("T", bound="PutV1PolicyPrefixSetsIdBodyPrefixSetEntriesItemValueEntry")


@_attrs_define
class PutV1PolicyPrefixSetsIdBodyPrefixSetEntriesItemValueEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_policy_prefix_sets_id_body_prefix_set_entries_item_value_entry = cls(
            ip_prefix=ip_prefix,
        ...
        put_v1_policy_prefix_sets_id_body_prefix_set_entries_item_value_entry.additional_properties = d
        return put_v1_policy_prefix_sets_id_body_prefix_set_entries_item_value_entry
