...
T = TypeVar("T", bound="GetV1GroupsIdResponse200GroupPermissions")


@_attrs_define
class GetV1GroupsIdResponse200GroupPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_groups_id_response_200_group_permissions = cls(
        ...
        get_v1_groups_id_response_200_group_permissions.additional_properties = d
        return get_v1_groups_id_response_200_group_permissions
