...
T = TypeVar("T", bound="GetV1DevicesResponse200DevicesItemTrafficPolicyZonePairsItem")


@_attrs_define
class GetV1DevicesResponse200DevicesItemTrafficPolicyZonePairsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_response_200_devices_item_traffic_policy_zone_pairs_item = cls(
            inside=inside,
            outside=outside,
            ruleset=ruleset,
        ...
        get_v1_devices_response_200_devices_item_traffic_policy_zone_pairs_item.additional_properties = d
        return get_v1_devices_response_200_devices_item_traffic_policy_zone_pairs_item
