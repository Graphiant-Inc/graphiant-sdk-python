...
if TYPE_CHECKING:
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item_leases_item import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item_nameservers import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemNameservers,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item_ranges_item import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem,
    )
    from ..models.put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item_static_leases_item import (
        PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem,
    )


T = TypeVar("T", bound="PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem")


@_attrs_define
class PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItem:
    """
    Attributes:
        ...
        leases (Union[Unset, list['PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem']]):
        max_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        min_lease_time_secs (Union[Unset, str]):  Example: TYPE_UINT32.
        name (Union[Unset, str]):  Example: TYPE_STRING.
        nameservers (Union[Unset, PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemNameservers]):
        ranges (Union[Unset, list['PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem']]):
        static_leases (Union[Unset,
            list['PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem']]):
    ...
    leases: Union[Unset, list["PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem"]] = UNSET
    max_lease_time_secs: Union[Unset, str] = UNSET
    min_lease_time_secs: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    nameservers: Union[Unset, "PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemNameservers"] = UNSET
    ranges: Union[Unset, list["PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem"]] = UNSET
    static_leases: Union[
        Unset, list["PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for leases_item_data in _leases or []:
            leases_item = PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemLeasesItem.from_dict(
                leases_item_data
            )
        ...
        if isinstance(_nameservers, Unset):
            ...
            nameservers = PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemNameservers.from_dict(
                _nameservers
            )
        ...
        for ranges_item_data in _ranges or []:
            ranges_item = PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemRangesItem.from_dict(
                ranges_item_data
            )
        ...
        for static_leases_item_data in _static_leases or []:
            static_leases_item = (
                PutV1ExtranetsIdResponse200PolicySharedSegmentDhcpSubnetsItemStaticLeasesItem.from_dict(
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item = cls(
        ...
        put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item.additional_properties = d
        return put_v1_extranets_id_response_200_policy_shared_segment_dhcp_subnets_item
