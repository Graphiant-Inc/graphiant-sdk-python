...
if TYPE_CHECKING:
    from ..models.get_v1_enterprise_enterprise_id_devices_response_200_devices_item_ipsec_tunnels_item_bgp_address_families_item import (
        GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem,
    )


T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgp")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgp:
    """
    Attributes:
        address_families (Union[Unset,
            list['GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem']]):
    ...
    address_families: Union[
        Unset, list["GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for address_families_item_data in _address_families or []:
            address_families_item = GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemIpsecTunnelsItemBgpAddressFamiliesItem.from_dict(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_ipsec_tunnels_item_bgp = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_ipsec_tunnels_item_bgp.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_ipsec_tunnels_item_bgp
