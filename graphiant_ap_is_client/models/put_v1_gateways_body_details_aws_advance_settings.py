...
T = TypeVar("T", bound="PutV1GatewaysBodyDetailsAwsAdvanceSettings")


@_attrs_define
class PutV1GatewaysBodyDetailsAwsAdvanceSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        put_v1_gateways_body_details_aws_advance_settings = cls(
        ...
        put_v1_gateways_body_details_aws_advance_settings.additional_properties = d
        return put_v1_gateways_body_details_aws_advance_settings
