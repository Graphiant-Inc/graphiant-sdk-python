...
T = TypeVar("T", bound="PostV1AuditInitBodyEntryStart")


@_attrs_define
class PostV1AuditInitBodyEntryStart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_audit_init_body_entry_start = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_audit_init_body_entry_start.additional_properties = d
        return post_v1_audit_init_body_entry_start
