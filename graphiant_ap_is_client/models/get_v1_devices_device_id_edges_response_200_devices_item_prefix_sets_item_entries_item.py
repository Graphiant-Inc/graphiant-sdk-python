...
T = TypeVar("T", bound="GetV1DevicesDeviceIdEdgesResponse200DevicesItemPrefixSetsItemEntriesItem")


@_attrs_define
class GetV1DevicesDeviceIdEdgesResponse200DevicesItemPrefixSetsItemEntriesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_prefix_sets_item_entries_item = cls(
            id=id,
            ip_prefix=ip_prefix,
        ...
        get_v1_devices_device_id_edges_response_200_devices_item_prefix_sets_item_entries_item.additional_properties = d
        return get_v1_devices_device_id_edges_response_200_devices_item_prefix_sets_item_entries_item
