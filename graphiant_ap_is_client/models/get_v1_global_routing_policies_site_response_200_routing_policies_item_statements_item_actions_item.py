...
if TYPE_CHECKING:
    from ..models.get_v1_global_routing_policies_site_response_200_routing_policies_item_statements_item_actions_item_community import (
        GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity,
    )


T = TypeVar("T", bound="GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItemActionsItem")


@_attrs_define
class GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItemActionsItem:
    """
    Attributes:
    ...
    community: Union[
        Unset, "GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_community, Unset):
            ...
            community = GetV1GlobalRoutingPoliciesSiteResponse200RoutingPoliciesItemStatementsItemActionsItemCommunity.from_dict(
                _community
            )
        ...
        get_v1_global_routing_policies_site_response_200_routing_policies_item_statements_item_actions_item = cls(
        ...
        get_v1_global_routing_policies_site_response_200_routing_policies_item_statements_item_actions_item.additional_properties = d
        return get_v1_global_routing_policies_site_response_200_routing_policies_item_statements_item_actions_item
