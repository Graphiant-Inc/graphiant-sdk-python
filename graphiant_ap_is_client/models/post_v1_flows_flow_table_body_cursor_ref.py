...
T = TypeVar("T", bound="PostV1FlowsFlowTableBodyCursorRef")


@_attrs_define
class PostV1FlowsFlowTableBodyCursorRef:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        post_v1_flows_flow_table_body_cursor_ref = cls(
            nanos=nanos,
            seconds=seconds,
        )

        post_v1_flows_flow_table_body_cursor_ref.additional_properties = d
        return post_v1_flows_flow_table_body_cursor_ref
