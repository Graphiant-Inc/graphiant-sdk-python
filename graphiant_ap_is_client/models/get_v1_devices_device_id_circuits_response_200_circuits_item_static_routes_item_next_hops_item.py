...
T = TypeVar("T", bound="GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItemNextHopsItem")


@_attrs_define
class GetV1DevicesDeviceIdCircuitsResponse200CircuitsItemStaticRoutesItemNextHopsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_static_routes_item_next_hops_item = cls(
            circuit=circuit,
            id=id,
            metric=metric,
        ...
        get_v1_devices_device_id_circuits_response_200_circuits_item_static_routes_item_next_hops_item.additional_properties = d
        return get_v1_devices_device_id_circuits_response_200_circuits_item_static_routes_item_next_hops_item
