...
T = TypeVar("T", bound="GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem")


@_attrs_define
class GetV1ExtranetsIdResponse200PolicyTargetSegmentsItemSyslogTargetsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item = cls(
        ...
        get_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item.additional_properties = d
        return get_v1_extranets_id_response_200_policy_target_segments_item_syslog_targets_item
