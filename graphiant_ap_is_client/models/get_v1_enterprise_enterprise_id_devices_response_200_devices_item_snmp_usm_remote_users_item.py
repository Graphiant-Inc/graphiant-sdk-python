...
T = TypeVar("T", bound="GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSnmpUsmRemoteUsersItem")


@_attrs_define
class GetV1EnterpriseEnterpriseIdDevicesResponse200DevicesItemSnmpUsmRemoteUsersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_usm_remote_users_item = cls(
        ...
        get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_usm_remote_users_item.additional_properties = d
        return get_v1_enterprise_enterprise_id_devices_response_200_devices_item_snmp_usm_remote_users_item
