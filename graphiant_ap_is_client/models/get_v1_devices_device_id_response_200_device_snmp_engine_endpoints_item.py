...
T = TypeVar("T", bound="GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem")


@_attrs_define
class GetV1DevicesDeviceIdResponse200DeviceSnmpEngineEndpointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        get_v1_devices_device_id_response_200_device_snmp_engine_endpoints_item = cls(
            addresses=addresses,
        ...
        get_v1_devices_device_id_response_200_device_snmp_engine_endpoints_item.additional_properties = d
        return get_v1_devices_device_id_response_200_device_snmp_engine_endpoints_item
