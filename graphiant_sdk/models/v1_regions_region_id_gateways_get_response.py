...
class V1RegionsRegionIdGatewaysGetResponse(BaseModel):
    """
    V1RegionsRegionIdGatewaysGetResponse
    """ # noqa: E501
    gateways: Optional[List[V1RegionsRegionIdGatewaysGetResponseGateway]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gateways": [V1RegionsRegionIdGatewaysGetResponseGateway.from_dict(_item) for _item in obj["gateways"]] if obj.get("gateways") is not None else None
        })
        return _obj
