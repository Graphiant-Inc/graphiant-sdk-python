...
class ManaV2ExtranetServiceCustomerMatchSummary(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "lanSegment", "matchedCustomers", "name", "serviceType", "status", "updatedAt"]
