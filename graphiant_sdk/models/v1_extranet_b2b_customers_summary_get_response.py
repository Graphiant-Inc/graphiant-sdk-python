...
class V1ExtranetB2bCustomersSummaryGetResponse(BaseModel):
    """
    V1ExtranetB2bCustomersSummaryGetResponse
    """ # noqa: E501
    customers: Optional[List[ManaV2ExtranetServiceCustomerSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [ManaV2ExtranetServiceCustomerSummary.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
