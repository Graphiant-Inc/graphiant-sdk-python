...
class V1ZtagentAgentsGetResponse(BaseModel):
    """
    V1ZtagentAgentsGetResponse
    """ # noqa: E501
    agents: Optional[List[ConcealAgent]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["agents", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [ConcealAgent.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None,
            "count": obj.get("count")
        })
        return _obj
