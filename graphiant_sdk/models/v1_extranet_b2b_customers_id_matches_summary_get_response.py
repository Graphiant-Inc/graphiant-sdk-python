...
class V1ExtranetB2bCustomersIdMatchesSummaryGetResponse(BaseModel):
    """
    V1ExtranetB2bCustomersIdMatchesSummaryGetResponse
    """ # noqa: E501
    matches: Optional[List[ManaV2ExtranetServiceCustomerMatchSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "matches": [ManaV2ExtranetServiceCustomerMatchSummary.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
