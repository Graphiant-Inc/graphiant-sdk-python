...
class ManaV2ExtranetConsumerLanPrefixes(BaseModel):
    """
    ManaV2ExtranetConsumerLanPrefixes
    """ # noqa: E501
    consumer_prefixes: Optional[List[StrictStr]] = Field(default=None, alias="consumerPrefixes")
    service_prefix_dnat: Optional[Dict[str, StrictStr]] = Field(default=None, alias="servicePrefixDnat")
    __properties: ClassVar[List[str]] = ["consumerPrefixes", "servicePrefixDnat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "servicePrefixDnat": obj.get("servicePrefixDnat")
        })
        return _obj
