...
class V2AssuranceAiAdoptionSummaryPostRequest(BaseModel):
    """
    V2AssuranceAiAdoptionSummaryPostRequest
    """ # noqa: E501
    time_window: AssuranceTimeWindow = Field(alias="timeWindow")
    user_list_size: StrictInt = Field(description="list size of user list in where widget (required)", alias="userListSize")
    __properties: ClassVar[List[str]] = ["timeWindow", "userListSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userListSize": obj.get("userListSize")
        })
        return _obj
