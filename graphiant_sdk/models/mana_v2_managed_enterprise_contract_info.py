...
class ManaV2ManagedEnterpriseContractInfo(BaseModel):
    """
    ManaV2ManagedEnterpriseContractInfo
    """ # noqa: E501
    consumed_credits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="All credits consumed over the entirety the enterprise's contracts", alias="consumedCredits")
    ...
    __properties: ClassVar[List[str]] = ["consumedCredits", "enterpriseContract", "enterpriseId", "enterpriseName"]
