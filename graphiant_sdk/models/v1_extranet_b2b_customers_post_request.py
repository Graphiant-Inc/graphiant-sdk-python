...
class V1ExtranetB2bCustomersPostRequest(BaseModel):
    """
    V1ExtranetB2bCustomersPostRequest
    """ # noqa: E501
    invite: ManaV2ExtranetServiceCustomerInvite
    name: StrictStr = Field(description="Partner display name (required)", json_schema_extra={"examples": ["example string"]})
    type: StrictStr = Field(description="Graphiant peer vs guest (non-Graphiant) partner (required)", json_schema_extra={"examples": ["ENUM_VALUE"]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invite": ManaV2ExtranetServiceCustomerInvite.from_dict(obj["invite"]) if obj.get("invite") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
