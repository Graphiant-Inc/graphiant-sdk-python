...
class V1SoftwareRolloutsIdGetResponse(BaseModel):
    """
    V1SoftwareRolloutsIdGetResponse
    """ # noqa: E501
    rollout: Optional[UpgradeRollout] = None
    __properties: ClassVar[List[str]] = ["rollout"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rollout": UpgradeRollout.from_dict(obj["rollout"]) if obj.get("rollout") is not None else None
        })
        return _obj
