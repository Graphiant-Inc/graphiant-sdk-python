...
class ManaV2B2bExtranetMatch(BaseModel):
    ...
    service_id: Optional[StrictInt] = Field(default=None, description="Producer service id", alias="serviceId", json_schema_extra={"examples": [1234567891011]})
    service_prefixes: Optional[List[ManaV2B2bExtranetPrefixTag]] = Field(default=None, alias="servicePrefixes")
    __properties: ClassVar[List[str]] = ["consumerPrefixes", "lanSegment", "natTranslationMode", "numCustomers", "serviceId", "servicePrefixes"]
