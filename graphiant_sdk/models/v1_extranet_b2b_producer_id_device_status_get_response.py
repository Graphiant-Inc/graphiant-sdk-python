...
class V1ExtranetB2bProducerIdDeviceStatusGetResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": [ManaV2B2bExtranetStatusSummary.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None
        })
        return _obj
