...
class V1ExtranetB2bServicesSummaryGetResponse(BaseModel):
    """
    V1ExtranetB2bServicesSummaryGetResponse
    """ # noqa: E501
    services: Optional[List[ManaV2ExtranetServiceSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": [ManaV2ExtranetServiceSummary.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
