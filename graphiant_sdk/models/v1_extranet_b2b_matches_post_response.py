...
class V1ExtranetB2bMatchesPostResponse(BaseModel):
    """
    ...
    matches: Optional[List[ManaV2B2bExtranetMatch]] = None
    __properties: ClassVar[List[str]] = ["matchId", "matches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [ManaV2B2bExtranetMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
        return _obj
