...
class V1PvifIdPutRequest(BaseModel):
    """
    V1PvifIdPutRequest
    """ # noqa: E501
    configuration: ManaV2PublicVifGatewayWriteRequest
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": ManaV2PublicVifGatewayWriteRequest.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
