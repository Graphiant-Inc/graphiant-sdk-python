...
class ManaV2IPsecGatewayRemotePeer(BaseModel):
    ...
    ike_initiator: Optional[StrictBool] = Field(default=None, description="When true, Graphiant initiates IKE for this peer", alias="ikeInitiator")
    mtu: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    name: Optional[StrictStr] = Field(default=None, description="Optional display name or label for this peer; used when generating tunnel names")
    remote_ike_peer_identity: Optional[StrictStr] = Field(default=None, description="IKE identity of the remote peer", alias="remoteIkePeerIdentity")
    ...
    vpn_profile: Optional[StrictStr] = Field(default=None, description="Enterprise IPsec VPN profile name for this peer", alias="vpnProfile")
