...
class ManaV2ExtranetServiceProducerCustomer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["adminEmails", "customerId", "matchId", "matchedServices", "name", "status", "type", "updatedAt"]
