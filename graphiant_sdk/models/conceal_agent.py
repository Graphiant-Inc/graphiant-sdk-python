...
class ConcealAgent(BaseModel):
    ...
    last_checkin: Optional[StrictStr] = Field(default=None, alias="lastCheckin")
    machine: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["createdAt", "disabled", "id", "identifier", "lastCheckin", "machine"]
