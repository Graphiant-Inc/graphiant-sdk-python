...
class V2AssuranceTopologyClientSessionsPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appName", "appServerKey", "bucketId", "clientIp", "exchangeServiceId", "filter", "flexAlgoId", "siteId", "timeWindow"]
