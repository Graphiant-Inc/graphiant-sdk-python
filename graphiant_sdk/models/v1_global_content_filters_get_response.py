...
class V1GlobalContentFiltersGetResponse(BaseModel):
    """
    V1GlobalContentFiltersGetResponse
    """ # noqa: E501
    rows: Optional[List[V1GlobalContentFiltersGetResponseRow]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [V1GlobalContentFiltersGetResponseRow.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
