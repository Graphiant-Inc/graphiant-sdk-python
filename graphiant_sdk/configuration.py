...
class Configuration:
    ...
    :param assert_hostname: Set this to True/False to enable/disable SSL hostname
      verification.
    :param tls_server_name: SSL/TLS Server Name Indication (SNI). Set this to the
      SNI value expected by the server.
    :param connection_pool_maxsize: Connection pool max size. None in the constructor
      is coerced to 100 for async and cpu_count * 5 for sync.
...
conf = graphiant_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        default_pool = multiprocessing.cpu_count() * 5
        self.connection_pool_maxsize = (
            connection_pool_maxsize if connection_pool_maxsize is not None else default_pool
        )
