...
class TestV1ExtranetB2bProducerIdGetResponse(unittest.TestCase):
    """V1ExtranetB2bProducerIdGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetB2bProducerIdGetResponse:
        """Test V1ExtranetB2bProducerIdGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetB2bProducerIdGetResponse`
        """
        model = V1ExtranetB2bProducerIdGetResponse()
        if include_optional:
            return V1ExtranetB2bProducerIdGetResponse(
                id = 1234567891011,
    ...
    def testV1ExtranetB2bProducerIdGetResponse(self):
        """Test V1ExtranetB2bProducerIdGetResponse"""
