...
class TestV1ExtranetB2bProducerPostRequest(unittest.TestCase):
    """V1ExtranetB2bProducerPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetB2bProducerPostRequest:
        """Test V1ExtranetB2bProducerPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetB2bProducerPostRequest`
        """
        model = V1ExtranetB2bProducerPostRequest()
        if include_optional:
            return V1ExtranetB2bProducerPostRequest(
    ...
    def testV1ExtranetB2bProducerPostRequest(self):
        """Test V1ExtranetB2bProducerPostRequest"""
