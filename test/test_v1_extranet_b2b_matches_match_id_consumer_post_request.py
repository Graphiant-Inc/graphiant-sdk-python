...
class TestV1ExtranetB2bMatchesMatchIdConsumerPostRequest(unittest.TestCase):
    """V1ExtranetB2bMatchesMatchIdConsumerPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetB2bMatchesMatchIdConsumerPostRequest:
        """Test V1ExtranetB2bMatchesMatchIdConsumerPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetB2bMatchesMatchIdConsumerPostRequest`
        """
        model = V1ExtranetB2bMatchesMatchIdConsumerPostRequest()
        if include_optional:
            return V1ExtranetB2bMatchesMatchIdConsumerPostRequest(
    ...
    def testV1ExtranetB2bMatchesMatchIdConsumerPostRequest(self):
        """Test V1ExtranetB2bMatchesMatchIdConsumerPostRequest"""
