...
class TestManaV2ExtranetServiceProducerPolicy(unittest.TestCase):
    """ManaV2ExtranetServiceProducerPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2ExtranetServiceProducerPolicy:
        """Test ManaV2ExtranetServiceProducerPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2ExtranetServiceProducerPolicy`
        """
        model = ManaV2ExtranetServiceProducerPolicy()
        if include_optional:
            return ManaV2ExtranetServiceProducerPolicy(
    ...
    def testManaV2ExtranetServiceProducerPolicy(self):
        """Test ManaV2ExtranetServiceProducerPolicy"""
