...
class TestV1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse(unittest.TestCase):
    """V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse:
        """Test V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse`
        """
        model = V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse()
        if include_optional:
            return V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse(
    ...
    def testV1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse(self):
        """Test V1ExtranetB2bMatchesMatchIdConsumerCheckPostResponse"""
