...
class TestV1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest(unittest.TestCase):
    """V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest:
        """Test V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest`
        """
        model = V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest()
        if include_optional:
            return V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest(
    ...
    def testV1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest(self):
        """Test V1ExtranetB2bMatchesMatchIdConsumerCheckPostRequest"""
